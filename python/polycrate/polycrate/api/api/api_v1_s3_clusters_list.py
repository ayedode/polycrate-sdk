...
from ...models.api_v1s3_clusters_list_created_by_component import (
    ApiV1S3ClustersListCreatedByComponent,
)
from ...models.api_v1s3_clusters_list_kind_item import (
    ApiV1S3ClustersListKindItem,
)
from ...models.api_v1s3_clusters_list_scope import ApiV1S3ClustersListScope
from ...models.api_v1s3_clusters_list_state import ApiV1S3ClustersListState
from ...models.api_v1s3_clusters_list_state_not import (
    ApiV1S3ClustersListStateNot,
)
from ...models.api_v1s3_clusters_list_time_range import (
    ApiV1S3ClustersListTimeRange,
)
from ...models.api_v1s3_clusters_list_validation_error import ApiV1S3ClustersListValidationError
...
from ...models.paginated_s3_cluster_list_list import PaginatedS3ClusterListList
...
def _get_kwargs(
    *,
    ...
    created_by_component: ApiV1S3ClustersListCreatedByComponent | Unset = UNSET,
    ...
    kind: list[ApiV1S3ClustersListKindItem] | Unset = UNSET,
    ...
    scope: ApiV1S3ClustersListScope | Unset = UNSET,
    search: str | Unset = UNSET,
    state: ApiV1S3ClustersListState | Unset = UNSET,
    state_not: ApiV1S3ClustersListStateNot | Unset = UNSET,
    time_range: ApiV1S3ClustersListTimeRange | Unset = UNSET,
    ...
    params["allow_new_buckets"] = allow_new_buckets
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    ApiV1S3ClustersListValidationError
    | ParseErrorResponse
    | ErrorResponse401
    | ErrorResponse403
    | ErrorResponse404
    ...
    | ErrorResponse500
    | ErrorResponse502
    | PaginatedS3ClusterListList
    | None
):
    if response.status_code == 200:
        response_200 = PaginatedS3ClusterListList.from_dict(response.json())

        return response_200

    if response.status_code == 400:

        def _parse_response_400(data: object) -> ApiV1S3ClustersListValidationError | ParseErrorResponse:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_api_v1s3_clusters_list_error_response_400_type_0 = (
                    ApiV1S3ClustersListValidationError.from_dict(data)
                )

                return componentsschemas_api_v1s3_clusters_list_error_response_400_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_api_v1s3_clusters_list_error_response_400_type_1 = ParseErrorResponse.from_dict(data)

            return componentsschemas_api_v1s3_clusters_list_error_response_400_type_1
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        region (UUID | Unset):
        scope (ApiV1S3ClustersListScope | Unset):
        search (str | Unset):
        state (ApiV1S3ClustersListState | Unset):
        state_not (ApiV1S3ClustersListStateNot | Unset):
        time_range (ApiV1S3ClustersListTimeRange | Unset):
    ...
    Returns:
        Response[ApiV1S3ClustersListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedS3ClusterListList]
    """
...
def sync(
    *,
    ...
    Returns:
        ApiV1S3ClustersListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedS3ClusterListList
    """
