...
from ...models.api_v1_projects_list_kind_item import ApiV1ProjectsListKindItem
from ...models.api_v1_projects_list_state import ApiV1ProjectsListState
from ...models.api_v1_projects_list_state_not import ApiV1ProjectsListStateNot
from ...models.api_v1_projects_list_time_range import ApiV1ProjectsListTimeRange
from ...models.api_v1_projects_list_validation_error import ApiV1ProjectsListValidationError
...
from ...models.paginated_project_list_list import PaginatedProjectListList
...
def _get_kwargs(
    *,
    ...
    end_date_from: datetime.date | Unset = UNSET,
    end_date_to: datetime.date | Unset = UNSET,
    has_conditions: bool | Unset = UNSET,
    kind: list[ApiV1ProjectsListKindItem] | Unset = UNSET,
    ...
    state: ApiV1ProjectsListState | Unset = UNSET,
    state_not: ApiV1ProjectsListStateNot | Unset = UNSET,
    time_range: ApiV1ProjectsListTimeRange | Unset = UNSET,
    ...
    json_end_date_from: str | Unset = UNSET
    if not isinstance(end_date_from, Unset):
        json_end_date_from = end_date_from.isoformat()
    params["end_date_from"] = json_end_date_from

    json_end_date_to: str | Unset = UNSET
    if not isinstance(end_date_to, Unset):
        json_end_date_to = end_date_to.isoformat()
    params["end_date_to"] = json_end_date_to
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    ApiV1ProjectsListValidationError
    | ParseErrorResponse
    | ErrorResponse401
    | ErrorResponse403
    | ErrorResponse404
    ...
    if response.status_code == 200:
        response_200 = PaginatedProjectListList.from_dict(response.json())

        return response_200

    if response.status_code == 400:

        def _parse_response_400(data: object) -> ApiV1ProjectsListValidationError | ParseErrorResponse:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_api_v1_projects_list_error_response_400_type_0 = (
                    ApiV1ProjectsListValidationError.from_dict(data)
                )

                return componentsschemas_api_v1_projects_list_error_response_400_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_api_v1_projects_list_error_response_400_type_1 = ParseErrorResponse.from_dict(data)

            return componentsschemas_api_v1_projects_list_error_response_400_type_1
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        end_date_from (datetime.date | Unset):
        end_date_to (datetime.date | Unset):
        has_conditions (bool | Unset):
        kind (list[ApiV1ProjectsListKindItem] | Unset):
        ...
        state (ApiV1ProjectsListState | Unset):
        state_not (ApiV1ProjectsListStateNot | Unset):
        time_range (ApiV1ProjectsListTimeRange | Unset):
    ...
    Returns:
        Response[ApiV1ProjectsListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedProjectListList]
    """
...
def sync(
    *,
    ...
    Returns:
        ApiV1ProjectsListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedProjectListList
    """
