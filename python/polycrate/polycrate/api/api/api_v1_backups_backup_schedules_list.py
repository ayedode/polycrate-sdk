...
from ...models.api_v1_backups_backup_schedules_list_created_by_component import (
    ApiV1BackupsBackupSchedulesListCreatedByComponent,
)
from ...models.api_v1_backups_backup_schedules_list_kind import (
    ApiV1BackupsBackupSchedulesListKind,
)
from ...models.api_v1_backups_backup_schedules_list_provider import (
    ApiV1BackupsBackupSchedulesListProvider,
)
from ...models.api_v1_backups_backup_schedules_list_scope import (
    ApiV1BackupsBackupSchedulesListScope,
)
from ...models.api_v1_backups_backup_schedules_list_state import (
    ApiV1BackupsBackupSchedulesListState,
)
from ...models.api_v1_backups_backup_schedules_list_state_not import (
    ApiV1BackupsBackupSchedulesListStateNot,
)
from ...models.api_v1_backups_backup_schedules_list_status import (
    ApiV1BackupsBackupSchedulesListStatus,
)
from ...models.api_v1_backups_backup_schedules_list_time_range import (
    ApiV1BackupsBackupSchedulesListTimeRange,
)
from ...models.api_v1_backups_backup_schedules_list_validation_error import (
    ApiV1BackupsBackupSchedulesListValidationError,
)
...
from ...models.paginated_backup_schedule_list_list import PaginatedBackupScheduleListList
...
def _get_kwargs(
    *,
    ...
    created_by_component: ApiV1BackupsBackupSchedulesListCreatedByComponent | Unset = UNSET,
    ...
    kind: ApiV1BackupsBackupSchedulesListKind | Unset = UNSET,
    ...
    provider: ApiV1BackupsBackupSchedulesListProvider | Unset = UNSET,
    reconciliation_running: bool | Unset = UNSET,
    scope: ApiV1BackupsBackupSchedulesListScope | Unset = UNSET,
    search: str | Unset = UNSET,
    source_namespace: str | Unset = UNSET,
    state: ApiV1BackupsBackupSchedulesListState | Unset = UNSET,
    state_not: ApiV1BackupsBackupSchedulesListStateNot | Unset = UNSET,
    status: ApiV1BackupsBackupSchedulesListStatus | Unset = UNSET,
    time_range: ApiV1BackupsBackupSchedulesListTimeRange | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/backups/backup-schedules/",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | ErrorResponse500
    | ErrorResponse502
    | PaginatedBackupScheduleListList
    | None
):
    if response.status_code == 200:
        response_200 = PaginatedBackupScheduleListList.from_dict(response.json())

        return response_200

    if response.status_code == 400:

        def _parse_response_400(data: object) -> ApiV1BackupsBackupSchedulesListValidationError | ParseErrorResponse:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_api_v1_backups_backup_schedules_list_error_response_400_type_0 = (
                    ApiV1BackupsBackupSchedulesListValidationError.from_dict(data)
                )

                return componentsschemas_api_v1_backups_backup_schedules_list_error_response_400_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_api_v1_backups_backup_schedules_list_error_response_400_type_1 = (
                ParseErrorResponse.from_dict(data)
            )

            return componentsschemas_api_v1_backups_backup_schedules_list_error_response_400_type_1
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        created_by_component (ApiV1BackupsBackupSchedulesListCreatedByComponent | Unset):
        created_by_users (list[list[int]] | Unset):
        debug_mode (bool | Unset):
        has_conditions (bool | Unset):
        k8s_cluster (UUID | Unset):
        kind (ApiV1BackupsBackupSchedulesListKind | Unset):
        name (str | Unset):
        ...
        provider (ApiV1BackupsBackupSchedulesListProvider | Unset):
        reconciliation_running (bool | Unset):
        scope (ApiV1BackupsBackupSchedulesListScope | Unset):
        search (str | Unset):
        source_namespace (str | Unset):
        state (ApiV1BackupsBackupSchedulesListState | Unset):
        state_not (ApiV1BackupsBackupSchedulesListStateNot | Unset):
        status (ApiV1BackupsBackupSchedulesListStatus | Unset):
        time_range (ApiV1BackupsBackupSchedulesListTimeRange | Unset):
    ...
    Returns:
        Response[ApiV1BackupsBackupSchedulesListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedBackupScheduleListList]
    """
...
def sync(
    *,
    ...
    Returns:
        ApiV1BackupsBackupSchedulesListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedBackupScheduleListList
    """
