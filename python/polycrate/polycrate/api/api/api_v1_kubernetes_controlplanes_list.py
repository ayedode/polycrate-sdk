...
from ...models.api_v1_kubernetes_controlplanes_list_created_by_component import (
    ApiV1KubernetesControlplanesListCreatedByComponent,
)
from ...models.api_v1_kubernetes_controlplanes_list_kind_item import (
    ApiV1KubernetesControlplanesListKindItem,
)
from ...models.api_v1_kubernetes_controlplanes_list_loadbalancer_mode import (
    ApiV1KubernetesControlplanesListLoadbalancerMode,
)
from ...models.api_v1_kubernetes_controlplanes_list_scope import (
    ApiV1KubernetesControlplanesListScope,
)
from ...models.api_v1_kubernetes_controlplanes_list_state import (
    ApiV1KubernetesControlplanesListState,
)
from ...models.api_v1_kubernetes_controlplanes_list_state_not import (
    ApiV1KubernetesControlplanesListStateNot,
)
from ...models.api_v1_kubernetes_controlplanes_list_time_range import (
    ApiV1KubernetesControlplanesListTimeRange,
)
from ...models.api_v1_kubernetes_controlplanes_list_validation_error import (
    ApiV1KubernetesControlplanesListValidationError,
)
...
from ...models.paginated_k8s_controlplane_list_list import PaginatedK8SControlplaneListList
...
def _get_kwargs(
    *,
    ...
    created_by_component: ApiV1KubernetesControlplanesListCreatedByComponent | Unset = UNSET,
    created_by_users: list[list[int]] | Unset = UNSET,
    debug_mode: bool | Unset = UNSET,
    has_conditions: bool | Unset = UNSET,
    kind: list[ApiV1KubernetesControlplanesListKindItem] | Unset = UNSET,
    loadbalancer_mode: ApiV1KubernetesControlplanesListLoadbalancerMode | Unset = UNSET,
    ...
    scope: ApiV1KubernetesControlplanesListScope | Unset = UNSET,
    search: str | Unset = UNSET,
    state: ApiV1KubernetesControlplanesListState | Unset = UNSET,
    state_not: ApiV1KubernetesControlplanesListStateNot | Unset = UNSET,
    storage_class: str | Unset = UNSET,
    time_range: ApiV1KubernetesControlplanesListTimeRange | Unset = UNSET,
    ...
    json_loadbalancer_mode: str | Unset = UNSET
    if not isinstance(loadbalancer_mode, Unset):
        json_loadbalancer_mode = loadbalancer_mode

    params["loadbalancer_mode"] = json_loadbalancer_mode
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/kubernetes/controlplanes/",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | ErrorResponse500
    | ErrorResponse502
    | PaginatedK8SControlplaneListList
    | None
):
    if response.status_code == 200:
        response_200 = PaginatedK8SControlplaneListList.from_dict(response.json())

        return response_200

    if response.status_code == 400:

        def _parse_response_400(data: object) -> ApiV1KubernetesControlplanesListValidationError | ParseErrorResponse:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_api_v1_kubernetes_controlplanes_list_error_response_400_type_0 = (
                    ApiV1KubernetesControlplanesListValidationError.from_dict(data)
                )

                return componentsschemas_api_v1_kubernetes_controlplanes_list_error_response_400_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_api_v1_kubernetes_controlplanes_list_error_response_400_type_1 = (
                ParseErrorResponse.from_dict(data)
            )

            return componentsschemas_api_v1_kubernetes_controlplanes_list_error_response_400_type_1
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        created_by_component (ApiV1KubernetesControlplanesListCreatedByComponent | Unset):
        created_by_users (list[list[int]] | Unset):
        debug_mode (bool | Unset):
        has_conditions (bool | Unset):
        kind (list[ApiV1KubernetesControlplanesListKindItem] | Unset):
        loadbalancer_mode (ApiV1KubernetesControlplanesListLoadbalancerMode | Unset):
        name (str | Unset):
        ...
        region (UUID | Unset):
        scope (ApiV1KubernetesControlplanesListScope | Unset):
        search (str | Unset):
        state (ApiV1KubernetesControlplanesListState | Unset):
        state_not (ApiV1KubernetesControlplanesListStateNot | Unset):
        storage_class (str | Unset):
        time_range (ApiV1KubernetesControlplanesListTimeRange | Unset):
    ...
    Returns:
        Response[ApiV1KubernetesControlplanesListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedK8SControlplaneListList]
    """
...
def sync(
    *,
    ...
    Returns:
        ApiV1KubernetesControlplanesListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedK8SControlplaneListList
    """
