...
from ...models.api_v1_kubernetes_worker_pools_list_created_by_component import (
    ApiV1KubernetesWorkerPoolsListCreatedByComponent,
)
from ...models.api_v1_kubernetes_worker_pools_list_kind_item import (
    ApiV1KubernetesWorkerPoolsListKindItem,
)
from ...models.api_v1_kubernetes_worker_pools_list_scope import (
    ApiV1KubernetesWorkerPoolsListScope,
)
from ...models.api_v1_kubernetes_worker_pools_list_state import (
    ApiV1KubernetesWorkerPoolsListState,
)
from ...models.api_v1_kubernetes_worker_pools_list_state_not import (
    ApiV1KubernetesWorkerPoolsListStateNot,
)
from ...models.api_v1_kubernetes_worker_pools_list_time_range import (
    ApiV1KubernetesWorkerPoolsListTimeRange,
)
from ...models.api_v1_kubernetes_worker_pools_list_validation_error import ApiV1KubernetesWorkerPoolsListValidationError
...
from ...models.paginated_k8s_worker_pool_list_list import PaginatedK8SWorkerPoolListList
...
def _get_kwargs(
    *,
    ...
    controlplane: UUID | Unset = UNSET,
    created_at: datetime.datetime | Unset = UNSET,
    created_by_component: ApiV1KubernetesWorkerPoolsListCreatedByComponent | Unset = UNSET,
    created_by_users: list[list[int]] | Unset = UNSET,
    debug_mode: bool | Unset = UNSET,
    desired_count: int | Unset = UNSET,
    hardening_enabled: bool | Unset = UNSET,
    has_conditions: bool | Unset = UNSET,
    kind: list[ApiV1KubernetesWorkerPoolsListKindItem] | Unset = UNSET,
    ...
    scope: ApiV1KubernetesWorkerPoolsListScope | Unset = UNSET,
    search: str | Unset = UNSET,
    state: ApiV1KubernetesWorkerPoolsListState | Unset = UNSET,
    state_not: ApiV1KubernetesWorkerPoolsListStateNot | Unset = UNSET,
    time_range: ApiV1KubernetesWorkerPoolsListTimeRange | Unset = UNSET,
    ...
    json_controlplane: str | Unset = UNSET
    if not isinstance(controlplane, Unset):
        json_controlplane = str(controlplane)
    params["controlplane"] = json_controlplane
    ...
    params["hardening_enabled"] = hardening_enabled
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/kubernetes/worker-pools/",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    ApiV1KubernetesWorkerPoolsListValidationError
    | ParseErrorResponse
    | ErrorResponse401
    | ErrorResponse403
    | ErrorResponse404
    ...
    | ErrorResponse500
    | ErrorResponse502
    | PaginatedK8SWorkerPoolListList
    | None
):
    if response.status_code == 200:
        response_200 = PaginatedK8SWorkerPoolListList.from_dict(response.json())

        return response_200

    if response.status_code == 400:

        def _parse_response_400(data: object) -> ApiV1KubernetesWorkerPoolsListValidationError | ParseErrorResponse:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_api_v1_kubernetes_worker_pools_list_error_response_400_type_0 = (
                    ApiV1KubernetesWorkerPoolsListValidationError.from_dict(data)
                )

                return componentsschemas_api_v1_kubernetes_worker_pools_list_error_response_400_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_api_v1_kubernetes_worker_pools_list_error_response_400_type_1 = (
                ParseErrorResponse.from_dict(data)
            )

            return componentsschemas_api_v1_kubernetes_worker_pools_list_error_response_400_type_1
...
def sync_detailed(
    *,
    ...
    Args:
        archived (bool | Unset):
        controlplane (UUID | Unset):
        created_at (datetime.datetime | Unset):
        created_by_component (ApiV1KubernetesWorkerPoolsListCreatedByComponent | Unset):
        created_by_users (list[list[int]] | Unset):
        debug_mode (bool | Unset):
        desired_count (int | Unset):
        hardening_enabled (bool | Unset):
        has_conditions (bool | Unset):
        kind (list[ApiV1KubernetesWorkerPoolsListKindItem] | Unset):
        name (str | Unset):
        ...
        scope (ApiV1KubernetesWorkerPoolsListScope | Unset):
        search (str | Unset):
        state (ApiV1KubernetesWorkerPoolsListState | Unset):
        state_not (ApiV1KubernetesWorkerPoolsListStateNot | Unset):
        time_range (ApiV1KubernetesWorkerPoolsListTimeRange | Unset):
    ...
    Returns:
        Response[ApiV1KubernetesWorkerPoolsListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedK8SWorkerPoolListList]
    """
...
def sync(
    *,
    ...
    Returns:
        ApiV1KubernetesWorkerPoolsListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedK8SWorkerPoolListList
    """
