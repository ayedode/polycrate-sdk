...
from ...models.api_v1_block_rollouts_list_kind_item import (
    ApiV1BlockRolloutsListKindItem,
)
from ...models.api_v1_block_rollouts_list_state import (
    ApiV1BlockRolloutsListState,
)
from ...models.api_v1_block_rollouts_list_state_not import (
    ApiV1BlockRolloutsListStateNot,
)
from ...models.api_v1_block_rollouts_list_status import (
    ApiV1BlockRolloutsListStatus,
)
from ...models.api_v1_block_rollouts_list_time_range import (
    ApiV1BlockRolloutsListTimeRange,
)
from ...models.api_v1_block_rollouts_list_validation_error import ApiV1BlockRolloutsListValidationError
...
from ...models.paginated_block_rollout_list_list import PaginatedBlockRolloutListList
...
def _get_kwargs(
    *,
    ...
    kind: list[ApiV1BlockRolloutsListKindItem] | Unset = UNSET,
    ...
    rollout_config: UUID | Unset = UNSET,
    search: str | Unset = UNSET,
    state: ApiV1BlockRolloutsListState | Unset = UNSET,
    state_not: ApiV1BlockRolloutsListStateNot | Unset = UNSET,
    status: ApiV1BlockRolloutsListStatus | Unset = UNSET,
    time_range: ApiV1BlockRolloutsListTimeRange | Unset = UNSET,
    ...
    json_rollout_config: str | Unset = UNSET
    if not isinstance(rollout_config, Unset):
        json_rollout_config = str(rollout_config)
    params["rollout_config"] = json_rollout_config
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    ApiV1BlockRolloutsListValidationError
    | ParseErrorResponse
    | ErrorResponse401
    | ErrorResponse403
    | ErrorResponse404
    ...
    | ErrorResponse500
    | ErrorResponse502
    | PaginatedBlockRolloutListList
    | None
):
    if response.status_code == 200:
        response_200 = PaginatedBlockRolloutListList.from_dict(response.json())

        return response_200

    if response.status_code == 400:

        def _parse_response_400(data: object) -> ApiV1BlockRolloutsListValidationError | ParseErrorResponse:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_api_v1_block_rollouts_list_error_response_400_type_0 = (
                    ApiV1BlockRolloutsListValidationError.from_dict(data)
                )

                return componentsschemas_api_v1_block_rollouts_list_error_response_400_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_api_v1_block_rollouts_list_error_response_400_type_1 = ParseErrorResponse.from_dict(data)

            return componentsschemas_api_v1_block_rollouts_list_error_response_400_type_1
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        kind (list[ApiV1BlockRolloutsListKindItem] | Unset):
        ...
        rollout_config (UUID | Unset):
        search (str | Unset):
        state (ApiV1BlockRolloutsListState | Unset):
        state_not (ApiV1BlockRolloutsListStateNot | Unset):
        status (ApiV1BlockRolloutsListStatus | Unset):
        time_range (ApiV1BlockRolloutsListTimeRange | Unset):
    ...
    Returns:
        Response[ApiV1BlockRolloutsListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedBlockRolloutListList]
    """
...
def sync(
    *,
    ...
    Returns:
        ApiV1BlockRolloutsListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedBlockRolloutListList
    """
