...
from ...models.api_v1_kubernetes_clusters_list_created_by_component import (
    ApiV1KubernetesClustersListCreatedByComponent,
)
from ...models.api_v1_kubernetes_clusters_list_kind_item import (
    ApiV1KubernetesClustersListKindItem,
)
from ...models.api_v1_kubernetes_clusters_list_scope import (
    ApiV1KubernetesClustersListScope,
)
from ...models.api_v1_kubernetes_clusters_list_state import (
    ApiV1KubernetesClustersListState,
)
from ...models.api_v1_kubernetes_clusters_list_state_not import (
    ApiV1KubernetesClustersListStateNot,
)
from ...models.api_v1_kubernetes_clusters_list_time_range import (
    ApiV1KubernetesClustersListTimeRange,
)
from ...models.api_v1_kubernetes_clusters_list_validation_error import ApiV1KubernetesClustersListValidationError
...
from ...models.paginated_k8s_cluster_list_list import PaginatedK8SClusterListList
...
def _get_kwargs(
    *,
    ...
    created_by_component: ApiV1KubernetesClustersListCreatedByComponent | Unset = UNSET,
    ...
    kind: list[ApiV1KubernetesClustersListKindItem] | Unset = UNSET,
    ...
    scope: ApiV1KubernetesClustersListScope | Unset = UNSET,
    search: str | Unset = UNSET,
    state: ApiV1KubernetesClustersListState | Unset = UNSET,
    state_not: ApiV1KubernetesClustersListStateNot | Unset = UNSET,
    time_range: ApiV1KubernetesClustersListTimeRange | Unset = UNSET,
    ...
    params["is_host_cluster"] = is_host_cluster
    ...
    params["kubernetes_version"] = kubernetes_version
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    ApiV1KubernetesClustersListValidationError
    | ParseErrorResponse
    | ErrorResponse401
    | ErrorResponse403
    | ErrorResponse404
    ...
    | ErrorResponse500
    | ErrorResponse502
    | PaginatedK8SClusterListList
    | None
):
    if response.status_code == 200:
        response_200 = PaginatedK8SClusterListList.from_dict(response.json())

        return response_200

    if response.status_code == 400:

        def _parse_response_400(data: object) -> ApiV1KubernetesClustersListValidationError | ParseErrorResponse:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_api_v1_kubernetes_clusters_list_error_response_400_type_0 = (
                    ApiV1KubernetesClustersListValidationError.from_dict(data)
                )

                return componentsschemas_api_v1_kubernetes_clusters_list_error_response_400_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_api_v1_kubernetes_clusters_list_error_response_400_type_1 = ParseErrorResponse.from_dict(
                data
            )

            return componentsschemas_api_v1_kubernetes_clusters_list_error_response_400_type_1
...
def sync_detailed(
    *,
    ...
    """API endpoint that allows K8s clusters to be viewed or edited.
    ...
    Args:
        ...
        created_by_component (ApiV1KubernetesClustersListCreatedByComponent | Unset):
        created_by_users (list[list[int]] | Unset):
        debug_mode (bool | Unset):
        has_conditions (bool | Unset):
        is_host_cluster (bool | Unset):
        kind (list[ApiV1KubernetesClustersListKindItem] | Unset):
        ...
        scope (ApiV1KubernetesClustersListScope | Unset):
        search (str | Unset):
        state (ApiV1KubernetesClustersListState | Unset):
        state_not (ApiV1KubernetesClustersListStateNot | Unset):
        time_range (ApiV1KubernetesClustersListTimeRange | Unset):
    ...
    Returns:
        Response[ApiV1KubernetesClustersListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedK8SClusterListList]
    """
...
def sync(
    *,
    ...
    Returns:
        ApiV1KubernetesClustersListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedK8SClusterListList
    """
