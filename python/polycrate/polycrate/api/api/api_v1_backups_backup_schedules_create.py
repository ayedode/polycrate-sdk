...
from ...models.api_v1_backups_backup_schedules_create_validation_error import (
    ApiV1BackupsBackupSchedulesCreateValidationError,
)
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = BackupSchedule.from_dict(response.json())

        return response_201

    if response.status_code == 400:

        def _parse_response_400(data: object) -> ApiV1BackupsBackupSchedulesCreateValidationError | ParseErrorResponse:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_api_v1_backups_backup_schedules_create_error_response_400_type_0 = (
                    ApiV1BackupsBackupSchedulesCreateValidationError.from_dict(data)
                )

                return componentsschemas_api_v1_backups_backup_schedules_create_error_response_400_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_api_v1_backups_backup_schedules_create_error_response_400_type_1 = (
                ParseErrorResponse.from_dict(data)
            )

            return componentsschemas_api_v1_backups_backup_schedules_create_error_response_400_type_1
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[ApiV1BackupsBackupSchedulesCreateValidationError | ParseErrorResponse | BackupSchedule | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502]
    """
...
def sync(
    *,
    ...
    Returns:
        ApiV1BackupsBackupSchedulesCreateValidationError | ParseErrorResponse | BackupSchedule | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502
    """
