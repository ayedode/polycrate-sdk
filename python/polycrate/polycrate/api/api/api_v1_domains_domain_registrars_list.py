...
from ...models.api_v1_domains_domain_registrars_list_created_by_component import (
    ApiV1DomainsDomainRegistrarsListCreatedByComponent,
)
from ...models.api_v1_domains_domain_registrars_list_kind import (
    ApiV1DomainsDomainRegistrarsListKind,
)
from ...models.api_v1_domains_domain_registrars_list_scope import (
    ApiV1DomainsDomainRegistrarsListScope,
)
from ...models.api_v1_domains_domain_registrars_list_state import (
    ApiV1DomainsDomainRegistrarsListState,
)
from ...models.api_v1_domains_domain_registrars_list_state_not import (
    ApiV1DomainsDomainRegistrarsListStateNot,
)
from ...models.api_v1_domains_domain_registrars_list_time_range import (
    ApiV1DomainsDomainRegistrarsListTimeRange,
)
from ...models.api_v1_domains_domain_registrars_list_validation_error import (
    ApiV1DomainsDomainRegistrarsListValidationError,
)
...
from ...models.paginated_domain_registrar_list_list import PaginatedDomainRegistrarListList
...
def _get_kwargs(
    *,
    ...
    created_by_component: ApiV1DomainsDomainRegistrarsListCreatedByComponent | Unset = UNSET,
    created_by_users: list[list[int]] | Unset = UNSET,
    debug_mode: bool | Unset = UNSET,
    has_conditions: bool | Unset = UNSET,
    kind: ApiV1DomainsDomainRegistrarsListKind | Unset = UNSET,
    ...
    scope: ApiV1DomainsDomainRegistrarsListScope | Unset = UNSET,
    search: str | Unset = UNSET,
    state: ApiV1DomainsDomainRegistrarsListState | Unset = UNSET,
    state_not: ApiV1DomainsDomainRegistrarsListStateNot | Unset = UNSET,
    time_range: ApiV1DomainsDomainRegistrarsListTimeRange | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/domains/domain-registrars/",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    | ErrorResponse500
    | ErrorResponse502
    | PaginatedDomainRegistrarListList
    | None
):
    if response.status_code == 200:
        response_200 = PaginatedDomainRegistrarListList.from_dict(response.json())

        return response_200

    if response.status_code == 400:

        def _parse_response_400(data: object) -> ApiV1DomainsDomainRegistrarsListValidationError | ParseErrorResponse:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_api_v1_domains_domain_registrars_list_error_response_400_type_0 = (
                    ApiV1DomainsDomainRegistrarsListValidationError.from_dict(data)
                )

                return componentsschemas_api_v1_domains_domain_registrars_list_error_response_400_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_api_v1_domains_domain_registrars_list_error_response_400_type_1 = (
                ParseErrorResponse.from_dict(data)
            )

            return componentsschemas_api_v1_domains_domain_registrars_list_error_response_400_type_1
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        created_by_component (ApiV1DomainsDomainRegistrarsListCreatedByComponent | Unset):
        created_by_users (list[list[int]] | Unset):
        debug_mode (bool | Unset):
        has_conditions (bool | Unset):
        kind (ApiV1DomainsDomainRegistrarsListKind | Unset):
        name (str | Unset):
        ...
        scope (ApiV1DomainsDomainRegistrarsListScope | Unset):
        search (str | Unset):
        state (ApiV1DomainsDomainRegistrarsListState | Unset):
        state_not (ApiV1DomainsDomainRegistrarsListStateNot | Unset):
        time_range (ApiV1DomainsDomainRegistrarsListTimeRange | Unset):
    ...
    Returns:
        Response[ApiV1DomainsDomainRegistrarsListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedDomainRegistrarListList]
    """
...
def sync(
    *,
    ...
    Returns:
        ApiV1DomainsDomainRegistrarsListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedDomainRegistrarListList
    """
