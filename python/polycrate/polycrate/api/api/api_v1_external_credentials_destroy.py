...
def sync_detailed(
    ...
    *,
    ...
    """Delete a credential
     ...
     Delete a Credential. Internal kinds (agent_token, system_api_key, org_api_key) cannot be deleted via
    this endpoint. Org API Keys can only delete credentials belonging to their own organization. Spec
    491.
