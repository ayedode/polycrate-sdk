...
from ...models.api_v1_prefixes_list_kind_item import ApiV1PrefixesListKindItem
from ...models.api_v1_prefixes_list_state import ApiV1PrefixesListState
from ...models.api_v1_prefixes_list_state_not import ApiV1PrefixesListStateNot
from ...models.api_v1_prefixes_list_time_range import ApiV1PrefixesListTimeRange
from ...models.api_v1_prefixes_list_validation_error import ApiV1PrefixesListValidationError
...
from ...models.paginated_prefix_list_list import PaginatedPrefixListList
...
def _get_kwargs(
    *,
    ...
    kind: list[ApiV1PrefixesListKindItem] | Unset = UNSET,
    ...
    state: ApiV1PrefixesListState | Unset = UNSET,
    state_not: ApiV1PrefixesListStateNot | Unset = UNSET,
    time_range: ApiV1PrefixesListTimeRange | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    ApiV1PrefixesListValidationError
    | ParseErrorResponse
    | ErrorResponse401
    | ErrorResponse403
    | ErrorResponse404
    ...
    if response.status_code == 200:
        response_200 = PaginatedPrefixListList.from_dict(response.json())

        return response_200

    if response.status_code == 400:

        def _parse_response_400(data: object) -> ApiV1PrefixesListValidationError | ParseErrorResponse:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_api_v1_prefixes_list_error_response_400_type_0 = (
                    ApiV1PrefixesListValidationError.from_dict(data)
                )

                return componentsschemas_api_v1_prefixes_list_error_response_400_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_api_v1_prefixes_list_error_response_400_type_1 = ParseErrorResponse.from_dict(data)

            return componentsschemas_api_v1_prefixes_list_error_response_400_type_1
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        kind (list[ApiV1PrefixesListKindItem] | Unset):
        ...
        region (UUID | Unset):
        search (str | Unset):
        state (ApiV1PrefixesListState | Unset):
        state_not (ApiV1PrefixesListStateNot | Unset):
        time_range (ApiV1PrefixesListTimeRange | Unset):
    ...
    Returns:
        Response[ApiV1PrefixesListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedPrefixListList]
    """
...
def sync(
    *,
    ...
    Returns:
        ApiV1PrefixesListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedPrefixListList
    """
