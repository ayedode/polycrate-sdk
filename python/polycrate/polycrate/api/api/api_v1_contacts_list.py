...
from ...models.api_v1_contacts_list_kind_item import ApiV1ContactsListKindItem
from ...models.api_v1_contacts_list_state import ApiV1ContactsListState
from ...models.api_v1_contacts_list_state_not import ApiV1ContactsListStateNot
from ...models.api_v1_contacts_list_time_range import ApiV1ContactsListTimeRange
from ...models.api_v1_contacts_list_validation_error import ApiV1ContactsListValidationError
...
from ...models.paginated_contact_list_list import PaginatedContactListList
...
def _get_kwargs(
    *,
    ...
    kind: list[ApiV1ContactsListKindItem] | Unset = UNSET,
    ...
    state: ApiV1ContactsListState | Unset = UNSET,
    state_not: ApiV1ContactsListStateNot | Unset = UNSET,
    time_range: ApiV1ContactsListTimeRange | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    ApiV1ContactsListValidationError
    | ParseErrorResponse
    | ErrorResponse401
    | ErrorResponse403
    | ErrorResponse404
    ...
    if response.status_code == 200:
        response_200 = PaginatedContactListList.from_dict(response.json())

        return response_200

    if response.status_code == 400:

        def _parse_response_400(data: object) -> ApiV1ContactsListValidationError | ParseErrorResponse:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_api_v1_contacts_list_error_response_400_type_0 = (
                    ApiV1ContactsListValidationError.from_dict(data)
                )

                return componentsschemas_api_v1_contacts_list_error_response_400_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            componentsschemas_api_v1_contacts_list_error_response_400_type_1 = ParseErrorResponse.from_dict(data)

            return componentsschemas_api_v1_contacts_list_error_response_400_type_1
...
def sync_detailed(
    *,
    ...
    """API ViewSet for Contacts Contacts.
    ...
    Args:
        ...
        kind (list[ApiV1ContactsListKindItem] | Unset):
        ...
        search (str | Unset):
        state (ApiV1ContactsListState | Unset):
        state_not (ApiV1ContactsListStateNot | Unset):
        time_range (ApiV1ContactsListTimeRange | Unset):
    ...
    Returns:
        Response[ApiV1ContactsListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedContactListList]
    """
...
def sync(
    *,
    ...
    Returns:
        ApiV1ContactsListValidationError | ParseErrorResponse | ErrorResponse401 | ErrorResponse403 | ErrorResponse404 | ErrorResponse405 | ErrorResponse406 | ErrorResponse409 | ErrorResponse410 | ErrorResponse415 | ErrorResponse500 | ErrorResponse502 | PaginatedContactListList
    """
