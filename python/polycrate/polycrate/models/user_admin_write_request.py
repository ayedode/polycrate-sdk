...
T = TypeVar("T", bound="UserAdminWriteRequest")


@_attrs_define
class UserAdminWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_admin_write_request.additional_properties = d
        return user_admin_write_request
