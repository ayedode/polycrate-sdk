...
T = TypeVar("T", bound="PaginatedRegionListList")


@_attrs_define
class PaginatedRegionListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[RegionList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RegionList.from_dict(results_item_data)
        ...
        paginated_region_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_region_list_list.additional_properties = d
        return paginated_region_list_list
