...
if TYPE_CHECKING:
    ...
    from ..models.organization_product_detail_deleted_by_user_type_0 import OrganizationProductDetailDeletedByUserType0
    from ..models.organization_product_detail_last_action_run_type_0 import OrganizationProductDetailLastActionRunType0
...
T = TypeVar("T", bound="OrganizationProductDetail")


@_attrs_define
class OrganizationProductDetail:
    ...
    Attributes:
        ...
        deleted_by_user (None | OrganizationProductDetailDeletedByUserType0):
        ...
        organization (None | OrganizationProductDetailOrganizationType0):
        workspace (None | OrganizationProductDetailWorkspaceType0):
        created (OrganizationProductDetailCreated):
        ...
        last_action_run (None | OrganizationProductDetailLastActionRunType0):
        ...
        catalogue_app (None | Unset | UUID):
        content_type (int | None | Unset):
    ...
    content_type: int | None | Unset = UNSET
    ...
    agreed_price_reason: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, OrganizationProductDetailDeletedByUserType0):
        ...
        if isinstance(self.organization, OrganizationProductDetailOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, OrganizationProductDetailWorkspaceType0):
        ...
        if isinstance(self.last_action_run, OrganizationProductDetailLastActionRunType0):
        ...
        agreed_price_reason = self.agreed_price_reason
        ...
        if agreed_price_reason is not UNSET:
            field_dict["agreed_price_reason"] = agreed_price_reason
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> None | OrganizationProductDetailDeletedByUserType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = OrganizationProductDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | OrganizationProductDetailDeletedByUserType0, data)
        ...
        def _parse_organization(data: object) -> None | OrganizationProductDetailOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = OrganizationProductDetailOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | OrganizationProductDetailOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> None | OrganizationProductDetailWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = OrganizationProductDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | OrganizationProductDetailWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = OrganizationProductDetailCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> None | OrganizationProductDetailLastActionRunType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = OrganizationProductDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | OrganizationProductDetailLastActionRunType0, data)
        ...
        def _parse_content_type(data: object) -> int | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        agreed_price_reason = d.pop("agreed_price_reason", UNSET)

        internal_note = d.pop("internal_note", UNSET)

        organization_product_detail = cls(
            id=id,
            created_at=created_at,
            updated_at=updated_at,
            deleted_at=deleted_at,
            ...
            agreed_price_reason=agreed_price_reason,
            internal_note=internal_note,
        )

        organization_product_detail.additional_properties = d
        return organization_product_detail
