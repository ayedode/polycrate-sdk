...
T = TypeVar("T", bound="PaginatedIPAddressListList")


@_attrs_define
class PaginatedIPAddressListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[IPAddressList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = IPAddressList.from_dict(results_item_data)
        ...
        paginated_ip_address_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_ip_address_list_list.additional_properties = d
        return paginated_ip_address_list_list
