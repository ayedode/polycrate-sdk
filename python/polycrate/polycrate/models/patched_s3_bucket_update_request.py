...
T = TypeVar("T", bound="PatchedS3BucketUpdateRequest")


@_attrs_define
class PatchedS3BucketUpdateRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_s3_bucket_update_request = cls(
            workspace=workspace,
            labels=labels,
        ...
        patched_s3_bucket_update_request.additional_properties = d
        return patched_s3_bucket_update_request
