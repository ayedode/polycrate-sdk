...
from ..models.code_repository_kind_enum import CodeRepositoryKindEnum, check_code_repository_kind_enum
...
T = TypeVar("T", bound="CodeRepository")


@_attrs_define
class CodeRepository:
    """Full serializer for CodeRepository detail views.
    ...
    Attributes:
        ...
        deleted_by_user (CodeRepositoryDeletedByUserType0 | None):
        ...
        organization (CodeRepositoryOrganizationType0 | None):
        workspace (CodeRepositoryWorkspaceType0 | None):
        created (CodeRepositoryCreated):
        ...
        last_action_run (CodeRepositoryLastActionRunType0 | None):
        k8s_cluster (UUID): Kubernetes cluster where this repository runs
        ...
        kind (CodeRepositoryKindEnum | Unset): * `generic` - Generic
            * `gitlab` - GitLab
            * `gitea` - Gitea
            * `forgejo` - Forgejo
        ...
        hostname (None | str | Unset): Hostname/URL where this repository is accessible
        projects_count (int | Unset): Number of projects/repositories
        users_count (int | Unset): Number of users
        groups_count (int | Unset): Number of groups
        repository_version (None | str | Unset): Repository application version
        k8s_app (None | Unset | UUID): K8s application that implements this code repository
    ...
    kind: CodeRepositoryKindEnum | Unset = UNSET
    ...
    groups_count: int | Unset = UNSET
    repository_version: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, CodeRepositoryDeletedByUserType0):
        ...
        if isinstance(self.organization, CodeRepositoryOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, CodeRepositoryWorkspaceType0):
        ...
        if isinstance(self.last_action_run, CodeRepositoryLastActionRunType0):
        ...
        repository_version: None | str | Unset
        if isinstance(self.repository_version, Unset):
            repository_version = UNSET
        else:
        ...
        if groups_count is not UNSET:
            field_dict["groups_count"] = groups_count
        if repository_version is not UNSET:
            field_dict["repository_version"] = repository_version
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> CodeRepositoryDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = CodeRepositoryDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CodeRepositoryDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> CodeRepositoryOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = CodeRepositoryOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CodeRepositoryOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> CodeRepositoryWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = CodeRepositoryWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CodeRepositoryWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = CodeRepositoryCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> CodeRepositoryLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = CodeRepositoryLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CodeRepositoryLastActionRunType0 | None, data)
        ...
        kind: CodeRepositoryKindEnum | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_code_repository_kind_enum(_kind)
        ...
        groups_count = d.pop("groups_count", UNSET)

        def _parse_repository_version(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        repository_version = _parse_repository_version(d.pop("repository_version", UNSET))
        ...
        code_repository.additional_properties = d
