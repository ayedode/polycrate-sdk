...
T = TypeVar("T", bound="PatchedProductDetailRequest")


@_attrs_define
class PatchedProductDetailRequest:
    ...
    Attributes:
        ...
        kind (ProductKindEnum | Unset): * `host` - Host
    ...
    kind: ProductKindEnum | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kind: ProductKindEnum | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_product_kind_enum(_kind)
        ...
        patched_product_detail_request = cls(
            name=name,
        ...
        patched_product_detail_request.additional_properties = d
        return patched_product_detail_request
