...
T = TypeVar("T", bound="PaginatedK8SVolumeListList")


@_attrs_define
class PaginatedK8SVolumeListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[K8SVolumeList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = K8SVolumeList.from_dict(results_item_data)
        ...
        paginated_k8s_volume_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_k8s_volume_list_list.additional_properties = d
        return paginated_k8s_volume_list_list
