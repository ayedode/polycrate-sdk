...
T = TypeVar("T", bound="K8SAddonConfigRevision")


@_attrs_define
class K8SAddonConfigRevision:
    ...
    Usage:
        ...
        Attributes:
            ...
            deleted_by_user (K8SAddonConfigRevisionDeletedByUserType0 | None):
            ...
            organization (K8SAddonConfigRevisionOrganizationType0 | None):
            workspace (K8SAddonConfigRevisionWorkspaceType0 | None):
            created (K8SAddonConfigRevisionCreated):
            ...
            last_action_run (K8SAddonConfigRevisionLastActionRunType0 | None):
            addon (UUID):
            version (str): Exact template-block version this config applies to.
            ...
            block_config_template (str | Unset): Jinja2→YAML block config template for this addon version.
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, K8SAddonConfigRevisionDeletedByUserType0):
        ...
        if isinstance(self.organization, K8SAddonConfigRevisionOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, K8SAddonConfigRevisionWorkspaceType0):
        ...
        if isinstance(self.last_action_run, K8SAddonConfigRevisionLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> K8SAddonConfigRevisionDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = K8SAddonConfigRevisionDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SAddonConfigRevisionDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> K8SAddonConfigRevisionOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = K8SAddonConfigRevisionOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SAddonConfigRevisionOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> K8SAddonConfigRevisionWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = K8SAddonConfigRevisionWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SAddonConfigRevisionWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = K8SAddonConfigRevisionCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> K8SAddonConfigRevisionLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = K8SAddonConfigRevisionLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SAddonConfigRevisionLastActionRunType0 | None, data)
        ...
        k8s_addon_config_revision.additional_properties = d
        return k8s_addon_config_revision
