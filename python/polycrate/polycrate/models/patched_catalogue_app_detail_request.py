...
T = TypeVar("T", bound="PatchedCatalogueAppDetailRequest")


@_attrs_define
class PatchedCatalogueAppDetailRequest:
    ...
    Handles Paradigma B (API-based Create/Edit) per .specs/0.12.0/catalogue-app.md
        ...
        Attributes:
            ...
            serial_number (int | Unset): Serial number from app catalogue (S/N)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_catalogue_app_detail_request = cls(
            name=name,
        ...
        patched_catalogue_app_detail_request.additional_properties = d
        return patched_catalogue_app_detail_request
