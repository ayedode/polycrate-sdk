...
if TYPE_CHECKING:
    from ..models.maintenance_window_created import MaintenanceWindowCreated
    from ..models.maintenance_window_deleted_by_user_type_0 import MaintenanceWindowDeletedByUserType0
    from ..models.maintenance_window_last_action_run_type_0 import MaintenanceWindowLastActionRunType0
    from ..models.maintenance_window_organization_type_0 import MaintenanceWindowOrganizationType0
    from ..models.maintenance_window_workspace_type_0 import MaintenanceWindowWorkspaceType0
...
class MaintenanceWindow:
    """Full serializer for MaintenanceWindow detail view.
    organization/workspace automatisch von ManagedObjectDetailSerializer.
        ...
        Attributes:
            ...
            deleted_by_user (MaintenanceWindowDeletedByUserType0 | None):
            ...
            organization (MaintenanceWindowOrganizationType0 | None):
            workspace (MaintenanceWindowWorkspaceType0 | None):
            created (MaintenanceWindowCreated):
            ...
            last_action_run (MaintenanceWindowLastActionRunType0 | None):
            ...
            note (str | Unset): Free-form note for this maintenance window
            time_slots (Any | Unset):
    """
    ...
    time_slots: Any | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.maintenance_window_deleted_by_user_type_0 import (
            MaintenanceWindowDeletedByUserType0,  # noqa: PLC0415
        )
        from ..models.maintenance_window_last_action_run_type_0 import (
            MaintenanceWindowLastActionRunType0,  # noqa: PLC0415
        )
        from ..models.maintenance_window_organization_type_0 import MaintenanceWindowOrganizationType0  # noqa: PLC0415
        from ..models.maintenance_window_workspace_type_0 import MaintenanceWindowWorkspaceType0  # noqa: PLC0415
        ...
        if isinstance(self.deleted_by_user, MaintenanceWindowDeletedByUserType0):
        ...
        if isinstance(self.organization, MaintenanceWindowOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, MaintenanceWindowWorkspaceType0):
        ...
        if isinstance(self.last_action_run, MaintenanceWindowLastActionRunType0):
        ...
        if time_slots is not UNSET:
            field_dict["time_slots"] = time_slots

        return field_dict

    @classmethod
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.maintenance_window_created import MaintenanceWindowCreated  # noqa: PLC0415
        from ..models.maintenance_window_deleted_by_user_type_0 import (
            MaintenanceWindowDeletedByUserType0,  # noqa: PLC0415
        )
        from ..models.maintenance_window_last_action_run_type_0 import (
        ...
        def _parse_deleted_by_user(data: object) -> MaintenanceWindowDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = MaintenanceWindowDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(MaintenanceWindowDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> MaintenanceWindowOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = MaintenanceWindowOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(MaintenanceWindowOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> MaintenanceWindowWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = MaintenanceWindowWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(MaintenanceWindowWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = MaintenanceWindowCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> MaintenanceWindowLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = MaintenanceWindowLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(MaintenanceWindowLastActionRunType0 | None, data)
        ...
        time_slots = d.pop("time_slots", UNSET)
