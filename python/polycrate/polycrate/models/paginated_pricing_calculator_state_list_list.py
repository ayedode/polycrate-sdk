...
T = TypeVar("T", bound="PaginatedPricingCalculatorStateListList")


@_attrs_define
class PaginatedPricingCalculatorStateListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[PricingCalculatorStateList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = PricingCalculatorStateList.from_dict(results_item_data)
        ...
        paginated_pricing_calculator_state_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_pricing_calculator_state_list_list.additional_properties = d
        return paginated_pricing_calculator_state_list_list
