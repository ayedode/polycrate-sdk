...
if TYPE_CHECKING:
    from ..models.cve_list import CVEList


T = TypeVar("T", bound="PaginatedCVEListList")


@_attrs_define
class PaginatedCVEListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[CVEList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.cve_list import CVEList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = CVEList.from_dict(results_item_data)
        ...
        paginated_cve_list_list.additional_properties = d
        return paginated_cve_list_list
