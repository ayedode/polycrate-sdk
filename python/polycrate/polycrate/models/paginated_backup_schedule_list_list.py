...
T = TypeVar("T", bound="PaginatedBackupScheduleListList")


@_attrs_define
class PaginatedBackupScheduleListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[BackupScheduleList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = BackupScheduleList.from_dict(results_item_data)
        ...
        paginated_backup_schedule_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_backup_schedule_list_list.additional_properties = d
        return paginated_backup_schedule_list_list
