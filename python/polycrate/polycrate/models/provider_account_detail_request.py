...
T = TypeVar("T", bound="ProviderAccountDetailRequest")


@_attrs_define
class ProviderAccountDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        provider_account_detail_request = cls(
            api_kind=api_kind,
            name=name,
        ...
        provider_account_detail_request.additional_properties = d
        return provider_account_detail_request
