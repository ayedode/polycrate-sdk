...
T = TypeVar("T", bound="DNSZoneDetailRequest")


@_attrs_define
class DNSZoneDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dns_zone_detail_request.additional_properties = d
        return dns_zone_detail_request
