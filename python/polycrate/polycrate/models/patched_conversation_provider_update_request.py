...
T = TypeVar("T", bound="PatchedConversationProviderUpdateRequest")


@_attrs_define
class PatchedConversationProviderUpdateRequest:
    ...
    Following S3 pattern with restricted update fields.
        ...
        Attributes:
            ...
            secrets (None | PatchedConversationProviderUpdateRequestSecretsType0 | Unset): Provider secrets as JSON object
    ...
    secrets: None | PatchedConversationProviderUpdateRequestSecretsType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.secrets, Unset):
            secrets = UNSET
        elif isinstance(self.secrets, PatchedConversationProviderUpdateRequestSecretsType0):
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.secrets, Unset):
            if isinstance(self.secrets, PatchedConversationProviderUpdateRequestSecretsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_secrets(data: object) -> None | PatchedConversationProviderUpdateRequestSecretsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                secrets_type_0 = PatchedConversationProviderUpdateRequestSecretsType0.from_dict(data)

                return secrets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PatchedConversationProviderUpdateRequestSecretsType0 | Unset, data)

        secrets = _parse_secrets(d.pop("secrets", UNSET))

        patched_conversation_provider_update_request = cls(
        ...
        patched_conversation_provider_update_request.additional_properties = d
        return patched_conversation_provider_update_request
