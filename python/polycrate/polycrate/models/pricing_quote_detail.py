...
if TYPE_CHECKING:
    from ..models.pricing_quote_detail_created import PricingQuoteDetailCreated
    from ..models.pricing_quote_detail_deleted_by_user_type_0 import PricingQuoteDetailDeletedByUserType0
    from ..models.pricing_quote_detail_last_action_run_type_0 import PricingQuoteDetailLastActionRunType0
    from ..models.pricing_quote_detail_organization_type_0 import PricingQuoteDetailOrganizationType0
    from ..models.pricing_quote_detail_workspace_type_0 import PricingQuoteDetailWorkspaceType0
    from ..models.pricing_quote_workspace_simple import PricingQuoteWorkspaceSimple


T = TypeVar("T", bound="PricingQuoteDetail")


@_attrs_define
class PricingQuoteDetail:
    ...
    Usage:
        ...
        Attributes:
            ...
            deleted_by_user (None | PricingQuoteDetailDeletedByUserType0):
            ...
            organization (None | PricingQuoteDetailOrganizationType0):
            workspace (None | PricingQuoteDetailWorkspaceType0):
            created (PricingQuoteDetailCreated):
            ...
            last_action_run (None | PricingQuoteDetailLastActionRunType0):
            workspaces (list[PricingQuoteWorkspaceSimple]):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.pricing_quote_detail_deleted_by_user_type_0 import (
            PricingQuoteDetailDeletedByUserType0,  # noqa: PLC0415
        )
        from ..models.pricing_quote_detail_last_action_run_type_0 import (
            PricingQuoteDetailLastActionRunType0,  # noqa: PLC0415
        )
        from ..models.pricing_quote_detail_organization_type_0 import (
            PricingQuoteDetailOrganizationType0,  # noqa: PLC0415
        )
        from ..models.pricing_quote_detail_workspace_type_0 import PricingQuoteDetailWorkspaceType0  # noqa: PLC0415
        ...
        if isinstance(self.deleted_by_user, PricingQuoteDetailDeletedByUserType0):
        ...
        if isinstance(self.organization, PricingQuoteDetailOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, PricingQuoteDetailWorkspaceType0):
        ...
        if isinstance(self.last_action_run, PricingQuoteDetailLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.pricing_quote_detail_created import PricingQuoteDetailCreated  # noqa: PLC0415
        from ..models.pricing_quote_detail_deleted_by_user_type_0 import (
            PricingQuoteDetailDeletedByUserType0,  # noqa: PLC0415
        )
        from ..models.pricing_quote_detail_last_action_run_type_0 import (
        ...
        from ..models.pricing_quote_detail_workspace_type_0 import PricingQuoteDetailWorkspaceType0  # noqa: PLC0415
        from ..models.pricing_quote_workspace_simple import PricingQuoteWorkspaceSimple  # noqa: PLC0415
        ...
        def _parse_deleted_by_user(data: object) -> None | PricingQuoteDetailDeletedByUserType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = PricingQuoteDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteDetailDeletedByUserType0, data)
        ...
        def _parse_organization(data: object) -> None | PricingQuoteDetailOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = PricingQuoteDetailOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteDetailOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> None | PricingQuoteDetailWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = PricingQuoteDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteDetailWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = PricingQuoteDetailCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> None | PricingQuoteDetailLastActionRunType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = PricingQuoteDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteDetailLastActionRunType0, data)
        ...
        for workspaces_item_data in _workspaces:
            workspaces_item = PricingQuoteWorkspaceSimple.from_dict(workspaces_item_data)
        ...
        pricing_quote_detail.additional_properties = d
        return pricing_quote_detail
