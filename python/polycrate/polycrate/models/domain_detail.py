...
if TYPE_CHECKING:
    from ..models.contact_simple import ContactSimple
    from ..models.credential_simple import CredentialSimple
    from ..models.dns_zone_simple import DNSZoneSimple
    from ..models.domain_detail_created import DomainDetailCreated
    from ..models.domain_detail_deleted_by_user_type_0 import DomainDetailDeletedByUserType0
    from ..models.domain_detail_last_action_run_type_0 import DomainDetailLastActionRunType0
    from ..models.domain_detail_organization_type_0 import DomainDetailOrganizationType0
    from ..models.domain_detail_workspace_type_0 import DomainDetailWorkspaceType0
...
class DomainDetail:
    ...
    Usage:
        ...
        Attributes:
            id (UUID):
            created (DomainDetailCreated):
            organization (DomainDetailOrganizationType0 | None):
            workspace (DomainDetailWorkspaceType0 | None):
            ...
            last_action_run (DomainDetailLastActionRunType0 | None):
            deleted_by_user (DomainDetailDeletedByUserType0 | None):
            registrar (DomainRegistrarSimple):
            dns_zone (DNSZoneSimple):
            owner_contact (ContactSimple): Simple Contact serializer for nested representations.

                Includes `url` field for direct navigation.
            admin_contact (ContactSimple): Simple Contact serializer for nested representations.

                Includes `url` field for direct navigation.
            tech_contact (ContactSimple): Simple Contact serializer for nested representations.

                Includes `url` field for direct navigation.
            auth_code_credential (CredentialSimple): Simple serializer for embedding Credential in other serializers.
    ...
    registrar: DomainRegistrarSimple
    dns_zone: DNSZoneSimple
    owner_contact: ContactSimple
    admin_contact: ContactSimple
    tech_contact: ContactSimple
    auth_code_credential: CredentialSimple
    created_at: datetime.datetime
    updated_at: datetime.datetime
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.domain_detail_deleted_by_user_type_0 import DomainDetailDeletedByUserType0  # noqa: PLC0415
        from ..models.domain_detail_last_action_run_type_0 import DomainDetailLastActionRunType0  # noqa: PLC0415
        from ..models.domain_detail_organization_type_0 import DomainDetailOrganizationType0  # noqa: PLC0415
        from ..models.domain_detail_workspace_type_0 import DomainDetailWorkspaceType0  # noqa: PLC0415
        ...
        if isinstance(self.organization, DomainDetailOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, DomainDetailWorkspaceType0):
        ...
        if isinstance(self.last_action_run, DomainDetailLastActionRunType0):
            last_action_run = self.last_action_run.to_dict()
        else:
            last_action_run = self.last_action_run

        deleted_by_user: dict[str, Any] | None
        if isinstance(self.deleted_by_user, DomainDetailDeletedByUserType0):
        ...
        owner_contact = self.owner_contact.to_dict()

        admin_contact = self.admin_contact.to_dict()

        tech_contact = self.tech_contact.to_dict()

        auth_code_credential = self.auth_code_credential.to_dict()
        ...
        field_dict.update(
            {
                ...
                "auth_code_credential": auth_code_credential,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.contact_simple import ContactSimple  # noqa: PLC0415
        ...
        from ..models.domain_detail_created import DomainDetailCreated  # noqa: PLC0415
        from ..models.domain_detail_deleted_by_user_type_0 import DomainDetailDeletedByUserType0  # noqa: PLC0415
        from ..models.domain_detail_last_action_run_type_0 import DomainDetailLastActionRunType0  # noqa: PLC0415
        from ..models.domain_detail_organization_type_0 import DomainDetailOrganizationType0  # noqa: PLC0415
        from ..models.domain_detail_workspace_type_0 import DomainDetailWorkspaceType0  # noqa: PLC0415
        ...
        created = DomainDetailCreated.from_dict(d.pop("created"))

        def _parse_organization(data: object) -> DomainDetailOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = DomainDetailOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DomainDetailOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> DomainDetailWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = DomainDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DomainDetailWorkspaceType0 | None, data)
        ...
        def _parse_last_action_run(data: object) -> DomainDetailLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = DomainDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DomainDetailLastActionRunType0 | None, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        def _parse_deleted_by_user(data: object) -> DomainDetailDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = DomainDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DomainDetailDeletedByUserType0 | None, data)
        ...
        owner_contact = ContactSimple.from_dict(d.pop("owner_contact"))

        admin_contact = ContactSimple.from_dict(d.pop("admin_contact"))

        tech_contact = ContactSimple.from_dict(d.pop("tech_contact"))

        auth_code_credential = CredentialSimple.from_dict(d.pop("auth_code_credential"))
