...
class Incident:
    ...
    downtimes is exposed read-only via DowntimeSimpleSerializer; write via downtime_ids.
        ...
        Attributes:
            ...
            last_action_run (IncidentLastActionRunType0 | None):
            deleted_by_user (IncidentDeletedByUserType0 | None):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.last_action_run, IncidentLastActionRunType0):
            last_action_run = self.last_action_run.to_dict()
        else:
            last_action_run = self.last_action_run

        deleted_by_user: dict[str, Any] | None
        if isinstance(self.deleted_by_user, IncidentDeletedByUserType0):
        ...
        downtimes = []
        for downtimes_item_data in self.downtimes:
            downtimes_item = downtimes_item_data.to_dict()
            downtimes.append(downtimes_item)
        ...
        for vulnerability_findings_item_data in self.vulnerability_findings:
            vulnerability_findings_item = vulnerability_findings_item_data.to_dict()
            vulnerability_findings.append(vulnerability_findings_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created = IncidentCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> IncidentLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = IncidentLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(IncidentLastActionRunType0 | None, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        def _parse_deleted_by_user(data: object) -> IncidentDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = IncidentDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(IncidentDeletedByUserType0 | None, data)
        ...
        downtimes = []
        _downtimes = d.pop("downtimes")
        for downtimes_item_data in _downtimes:
            downtimes_item = DowntimeSimple.from_dict(downtimes_item_data)
        ...
        vulnerability_findings = []
        _vulnerability_findings = d.pop("vulnerability_findings")
        for vulnerability_findings_item_data in _vulnerability_findings:
            vulnerability_findings_item = VulnerabilityFindingSimple.from_dict(vulnerability_findings_item_data)
