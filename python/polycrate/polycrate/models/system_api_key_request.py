...
T = TypeVar("T", bound="SystemAPIKeyRequest")


@_attrs_define
class SystemAPIKeyRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        system_api_key_request = cls(
            name=name,
            access_mode=access_mode,
        )

        system_api_key_request.additional_properties = d
        return system_api_key_request
