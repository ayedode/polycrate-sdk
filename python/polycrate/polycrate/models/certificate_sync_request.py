...
T = TypeVar("T", bound="CertificateSyncRequest")
...
class CertificateSyncRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        files.append(("cert_data", (None, str(self.cert_data).encode(), "text/plain")))

        files.append(("k8s_cluster_id", (None, str(self.k8s_cluster_id).encode(), "text/plain")))

        files.append(("organization_id", (None, str(self.organization_id).encode(), "text/plain")))

        if not isinstance(self.workspace_id, Unset):
            if isinstance(self.workspace_id, int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        certificate_sync_request.additional_properties = d
        return certificate_sync_request
