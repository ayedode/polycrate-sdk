...
if TYPE_CHECKING:
    from ..models.patched_credential_update_request_secrets_type_0 import PatchedCredentialUpdateRequestSecretsType0


T = TypeVar("T", bound="PatchedCredentialUpdateRequest")


@_attrs_define
class PatchedCredentialUpdateRequest:
    ...
    Only allows updating credential data fields, not metadata.
        ...
        Attributes:
            ...
            secrets (None | PatchedCredentialUpdateRequestSecretsType0 | Unset): Credential secrets as JSON object
    ...
    secrets: None | PatchedCredentialUpdateRequestSecretsType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.patched_credential_update_request_secrets_type_0 import (
            PatchedCredentialUpdateRequestSecretsType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.secrets, Unset):
            secrets = UNSET
        elif isinstance(self.secrets, PatchedCredentialUpdateRequestSecretsType0):
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.secrets, Unset):
            if isinstance(self.secrets, PatchedCredentialUpdateRequestSecretsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_secrets(data: object) -> None | PatchedCredentialUpdateRequestSecretsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                secrets_type_0 = PatchedCredentialUpdateRequestSecretsType0.from_dict(data)

                return secrets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PatchedCredentialUpdateRequestSecretsType0 | Unset, data)
        ...
        patched_credential_update_request = cls(
        ...
        patched_credential_update_request.additional_properties = d
        return patched_credential_update_request
