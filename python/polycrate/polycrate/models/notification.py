...
from ..models.notification_kind_enum import NotificationKindEnum, check_notification_kind_enum
...
class Notification:
    ...
    Attributes:
        ...
        deleted_by_user (None | NotificationDeletedByUserType0):
        ...
        scope (ScopeEnum): * `system` - System
            * `user` - User
        kind (NotificationKindEnum): * `generic` - Generic
            * `alert` - Alert
            * `downtime` - Downtime
            * `recovery` - Recovery
        ...
        last_action_run (None | NotificationLastActionRunType0):
        title (str): Title/Subject of the notification
        body (str): Main content of the notification (rendered from template)
        body_html (None | str): HTML version of body (for email)
        template_name (str): Name of the template used
        template_context (Any): Context data passed to the template
        submitted (bool): Whether the notification was successfully submitted
        submitted_at (datetime.datetime | None): Timestamp of successful submission
        error (None | str): Error message if submission failed
        retry_count (int): Number of submission attempts
        max_retries (int): Maximum number of retries
        metadata (Any): Additional metadata about the notification
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, NotificationDeletedByUserType0):
        ...
        if isinstance(self.last_action_run, NotificationLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> None | NotificationDeletedByUserType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = NotificationDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | NotificationDeletedByUserType0, data)
        ...
        kind = check_notification_kind_enum(d.pop("kind"))
        ...
        created = NotificationCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> None | NotificationLastActionRunType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = NotificationLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | NotificationLastActionRunType0, data)
        ...
        template_context = d.pop("template_context")
