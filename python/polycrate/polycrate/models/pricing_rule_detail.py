...
T = TypeVar("T", bound="PricingRuleDetail")


@_attrs_define
class PricingRuleDetail:
    ...
    Usage:
        ...
        Attributes:
            ...
            deleted_by_user (None | PricingRuleDetailDeletedByUserType0):
            ...
            organization (None | PricingRuleDetailOrganizationType0):
            workspace (None | PricingRuleDetailWorkspaceType0):
            created (PricingRuleDetailCreated):
            ...
            last_action_run (None | PricingRuleDetailLastActionRunType0):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, PricingRuleDetailDeletedByUserType0):
        ...
        if isinstance(self.organization, PricingRuleDetailOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, PricingRuleDetailWorkspaceType0):
        ...
        if isinstance(self.last_action_run, PricingRuleDetailLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> None | PricingRuleDetailDeletedByUserType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = PricingRuleDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingRuleDetailDeletedByUserType0, data)
        ...
        def _parse_organization(data: object) -> None | PricingRuleDetailOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = PricingRuleDetailOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingRuleDetailOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> None | PricingRuleDetailWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = PricingRuleDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingRuleDetailWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = PricingRuleDetailCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> None | PricingRuleDetailLastActionRunType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = PricingRuleDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingRuleDetailLastActionRunType0, data)
        ...
        pricing_rule_detail.additional_properties = d
        return pricing_rule_detail
