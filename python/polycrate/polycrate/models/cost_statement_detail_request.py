...
T = TypeVar("T", bound="CostStatementDetailRequest")


@_attrs_define
class CostStatementDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cost_statement_detail_request = cls(
            period_start=period_start,
            period_end=period_end,
            name=name,
        ...
        cost_statement_detail_request.additional_properties = d
        return cost_statement_detail_request
