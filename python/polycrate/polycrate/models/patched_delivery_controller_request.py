...
T = TypeVar("T", bound="PatchedDeliveryControllerRequest")


@_attrs_define
class PatchedDeliveryControllerRequest:
    ...
    Attributes:
        ...
        k8s_cluster (UUID | Unset): Kubernetes cluster where this controller runs
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.applications_total, Unset):
            files.append(("applications_total", (None, str(self.applications_total).encode(), "text/plain")))

        if not isinstance(self.applications_synced, Unset):
            files.append(("applications_synced", (None, str(self.applications_synced).encode(), "text/plain")))

        if not isinstance(self.applications_out_of_sync, Unset):
            files.append(
                ("applications_out_of_sync", (None, str(self.applications_out_of_sync).encode(), "text/plain"))
            )

        if not isinstance(self.applications_degraded, Unset):
            files.append(("applications_degraded", (None, str(self.applications_degraded).encode(), "text/plain")))

        if not isinstance(self.controller_app_version, Unset):
            if isinstance(self.controller_app_version, str):
                files.append(
                    ("controller_app_version", (None, str(self.controller_app_version).encode(), "text/plain"))
                )
            else:
                files.append(
                    ("controller_app_version", (None, str(self.controller_app_version).encode(), "text/plain"))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_delivery_controller_request = cls(
            name=name,
        ...
        patched_delivery_controller_request.additional_properties = d
        return patched_delivery_controller_request
