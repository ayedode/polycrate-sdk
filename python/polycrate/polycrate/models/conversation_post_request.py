...
T = TypeVar("T", bound="ConversationPostRequest")


@_attrs_define
class ConversationPostRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.conversation_provider, Unset):
            if isinstance(self.conversation_provider, UUID):
                files.append(("conversation_provider", (None, str(self.conversation_provider), "text/plain")))
            else:
                files.append(("conversation_provider", (None, str(self.conversation_provider).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        conversation_post_request.additional_properties = d
        return conversation_post_request
