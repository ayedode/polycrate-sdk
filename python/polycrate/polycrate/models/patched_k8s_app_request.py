...
T = TypeVar("T", bound="PatchedK8SAppRequest")


@_attrs_define
class PatchedK8SAppRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.byoa, Unset):
            files.append(("byoa", (None, str(self.byoa).encode(), "text/plain")))
        ...
        if not isinstance(self.ha_enabled, Unset):
            if isinstance(self.ha_enabled, bool):
                files.append(("ha_enabled", (None, str(self.ha_enabled).encode(), "text/plain")))
            else:
                files.append(("ha_enabled", (None, str(self.ha_enabled).encode(), "text/plain")))

        if not isinstance(self.installed_version, Unset):
            if isinstance(self.installed_version, str):
                files.append(("installed_version", (None, str(self.installed_version).encode(), "text/plain")))
            else:
                files.append(("installed_version", (None, str(self.installed_version).encode(), "text/plain")))
        ...
        if not isinstance(self.uninstalled, Unset):
            files.append(("uninstalled", (None, str(self.uninstalled).encode(), "text/plain")))

        if not isinstance(self.installation_running, Unset):
            files.append(("installation_running", (None, str(self.installation_running).encode(), "text/plain")))

        if not isinstance(self.uninstallation_running, Unset):
            files.append(("uninstallation_running", (None, str(self.uninstallation_running).encode(), "text/plain")))

        if not isinstance(self.installation_failed, Unset):
            files.append(("installation_failed", (None, str(self.installation_failed).encode(), "text/plain")))

        if not isinstance(self.uninstallation_failed, Unset):
            files.append(("uninstallation_failed", (None, str(self.uninstallation_failed).encode(), "text/plain")))

        if not isinstance(self.last_installation, Unset):
            if isinstance(self.last_installation, datetime.datetime):
                files.append(("last_installation", (None, self.last_installation.isoformat().encode(), "text/plain")))
            else:
                files.append(("last_installation", (None, str(self.last_installation).encode(), "text/plain")))

        if not isinstance(self.last_metrics_check, Unset):
            if isinstance(self.last_metrics_check, datetime.datetime):
                files.append(("last_metrics_check", (None, self.last_metrics_check.isoformat().encode(), "text/plain")))
            else:
                files.append(("last_metrics_check", (None, str(self.last_metrics_check).encode(), "text/plain")))

        if not isinstance(self.pods_total, Unset):
            files.append(("pods_total", (None, str(self.pods_total).encode(), "text/plain")))

        if not isinstance(self.pods_ready, Unset):
            files.append(("pods_ready", (None, str(self.pods_ready).encode(), "text/plain")))

        if not isinstance(self.pods_available, Unset):
            files.append(("pods_available", (None, str(self.pods_available).encode(), "text/plain")))

        if not isinstance(self.pods_unavailable, Unset):
            files.append(("pods_unavailable", (None, str(self.pods_unavailable).encode(), "text/plain")))

        if not isinstance(self.pods_restart_count_total, Unset):
            files.append(
                ("pods_restart_count_total", (None, str(self.pods_restart_count_total).encode(), "text/plain"))
            )

        if not isinstance(self.pods_restart_count_last_hour, Unset):
            files.append(
                ("pods_restart_count_last_hour", (None, str(self.pods_restart_count_last_hour).encode(), "text/plain"))
            )

        if not isinstance(self.pods_details, Unset):
            files.append(("pods_details", (None, str(self.pods_details).encode(), "text/plain")))

        if not isinstance(self.pods_status_hash, Unset):
            if isinstance(self.pods_status_hash, str):
                files.append(("pods_status_hash", (None, str(self.pods_status_hash).encode(), "text/plain")))
            else:
                files.append(("pods_status_hash", (None, str(self.pods_status_hash).encode(), "text/plain")))

        if not isinstance(self.pods_status_updated_at, Unset):
            if isinstance(self.pods_status_updated_at, datetime.datetime):
                files.append(
                    ("pods_status_updated_at", (None, self.pods_status_updated_at.isoformat().encode(), "text/plain"))
                )
            else:
                files.append(
                    ("pods_status_updated_at", (None, str(self.pods_status_updated_at).encode(), "text/plain"))
                )

        if not isinstance(self.excluded_from_downtime_until, Unset):
            if isinstance(self.excluded_from_downtime_until, datetime.datetime):
                files.append(
                    (
                        "excluded_from_downtime_until",
                        (None, self.excluded_from_downtime_until.isoformat().encode(), "text/plain"),
                    )
                )
            else:
                files.append(
                    (
                        "excluded_from_downtime_until",
                        (None, str(self.excluded_from_downtime_until).encode(), "text/plain"),
                    )
                )
        ...
        if not isinstance(self.helm_chart, Unset):
            if isinstance(self.helm_chart, UUID):
                files.append(("helm_chart", (None, str(self.helm_chart), "text/plain")))
            else:
                files.append(("helm_chart", (None, str(self.helm_chart).encode(), "text/plain")))
        ...
        if not isinstance(self.artifact, Unset):
            if isinstance(self.artifact, UUID):
                files.append(("artifact", (None, str(self.artifact), "text/plain")))
            else:
                files.append(("artifact", (None, str(self.artifact).encode(), "text/plain")))

        if not isinstance(self.catalogue_app, Unset):
            if isinstance(self.catalogue_app, UUID):
                files.append(("catalogue_app", (None, str(self.catalogue_app), "text/plain")))
            else:
                files.append(("catalogue_app", (None, str(self.catalogue_app).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_k8s_app_request.additional_properties = d
        return patched_k8s_app_request
