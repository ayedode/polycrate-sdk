...
T = TypeVar("T", bound="PaginatedK8SControlplaneListList")


@_attrs_define
class PaginatedK8SControlplaneListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[K8SControlplaneList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = K8SControlplaneList.from_dict(results_item_data)
        ...
        paginated_k8s_controlplane_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_k8s_controlplane_list_list.additional_properties = d
        return paginated_k8s_controlplane_list_list
