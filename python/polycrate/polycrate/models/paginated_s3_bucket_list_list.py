...
T = TypeVar("T", bound="PaginatedS3BucketListList")


@_attrs_define
class PaginatedS3BucketListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[S3BucketList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = S3BucketList.from_dict(results_item_data)
        ...
        paginated_s3_bucket_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_s3_bucket_list_list.additional_properties = d
        return paginated_s3_bucket_list_list
