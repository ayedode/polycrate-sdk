...
T = TypeVar("T", bound="NoteAssigneesItem")


@_attrs_define
class NoteAssigneesItem:
    """
    Attributes:
        id (int | Unset):
        username (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        note_assignees_item.additional_properties = d
        return note_assignees_item
