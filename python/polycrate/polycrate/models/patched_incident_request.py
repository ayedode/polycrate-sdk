...
from ..models.incident_kind_enum import IncidentKindEnum, check_incident_kind_enum
from ..models.incident_status_enum import IncidentStatusEnum, check_incident_status_enum
...
T = TypeVar("T", bound="PatchedIncidentRequest")


@_attrs_define
class PatchedIncidentRequest:
    """Full serializer for Incident detail view.
    ...
    downtimes is exposed read-only via DowntimeSimpleSerializer; write via downtime_ids.
        ...
        Attributes:
            ...
            kind (IncidentKindEnum | Unset): * `security-control` - Security Control Gap
                ...
                * `other` - Other
            status (IncidentStatusEnum | Unset): * `reported` - Reported
                * `investigating` - Investigating
                * `contained` - Contained
                * `resolved` - Resolved
                * `reviewed` - Reviewed
            occurred_at (datetime.datetime | Unset): When the incident actually occurred
            discovered_at (datetime.datetime | Unset): When the incident was discovered/reported
            resolved_at (datetime.datetime | None | Unset): When the incident was resolved (set once status reaches
                resolved/reviewed)
            reporter (str | Unset): Name or contact of the person/system that reported the incident
            reference_url (None | str | Unset): External reference URL (e.g. ticket system, post-mortem document)
            source_item_id (None | str | Unset): Original item ID from the DataSource feed/API (for dedup during sync)
            notification_opened_sent (bool | Unset): Whether the incident_opened notification has been sent
            notification_closed_sent (bool | Unset): Whether the incident_closed notification has been sent
            ...
            provider_entity (None | Unset | UUID): Provider operating the affected PoP or DataSource (auto-derived, read-
                only)
            source_datasource (None | Unset | UUID): DataSource that automatically generated this incident
    """

    name: str | Unset = UNSET
    organization_id: None | Unset | UUID = UNSET
    workspace_id: None | Unset | UUID = UNSET
    downtime_ids: list[UUID] | Unset = UNSET
    affected_host_ids: list[UUID] | Unset = UNSET
    affected_volume_ids: list[UUID] | Unset = UNSET
    affected_pop_ids: list[UUID] | Unset = UNSET
    vulnerability_finding_ids: list[UUID] | Unset = UNSET
    ...
    kind: IncidentKindEnum | Unset = UNSET
    status: IncidentStatusEnum | Unset = UNSET
    ...
    notification_opened_sent: bool | Unset = UNSET
    notification_closed_sent: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        downtime_ids: list[str] | Unset = UNSET
        if not isinstance(self.downtime_ids, Unset):
            downtime_ids = []
            for downtime_ids_item_data in self.downtime_ids:
                downtime_ids_item = str(downtime_ids_item_data)
                downtime_ids.append(downtime_ids_item)
        ...
        vulnerability_finding_ids: list[str] | Unset = UNSET
        if not isinstance(self.vulnerability_finding_ids, Unset):
            vulnerability_finding_ids = []
            for vulnerability_finding_ids_item_data in self.vulnerability_finding_ids:
                vulnerability_finding_ids_item = str(vulnerability_finding_ids_item_data)
                vulnerability_finding_ids.append(vulnerability_finding_ids_item)
        ...
        notification_opened_sent = self.notification_opened_sent

        notification_closed_sent = self.notification_closed_sent
        ...
        if downtime_ids is not UNSET:
            field_dict["downtime_ids"] = downtime_ids
        ...
        if vulnerability_finding_ids is not UNSET:
            field_dict["vulnerability_finding_ids"] = vulnerability_finding_ids
        ...
        if notification_opened_sent is not UNSET:
            field_dict["notification_opened_sent"] = notification_opened_sent
        if notification_closed_sent is not UNSET:
            field_dict["notification_closed_sent"] = notification_closed_sent
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.downtime_ids, Unset):
            for downtime_ids_item_element in self.downtime_ids:
                files.append(("downtime_ids", (None, str(downtime_ids_item_element), "text/plain")))
        ...
        if not isinstance(self.vulnerability_finding_ids, Unset):
            for vulnerability_finding_ids_item_element in self.vulnerability_finding_ids:
                files.append(
                    ("vulnerability_finding_ids", (None, str(vulnerability_finding_ids_item_element), "text/plain"))
                )
        ...
        if not isinstance(self.occurred_at, Unset):
            files.append(("occurred_at", (None, self.occurred_at.isoformat().encode(), "text/plain")))

        if not isinstance(self.discovered_at, Unset):
            files.append(("discovered_at", (None, self.discovered_at.isoformat().encode(), "text/plain")))

        if not isinstance(self.resolved_at, Unset):
            if isinstance(self.resolved_at, datetime.datetime):
                files.append(("resolved_at", (None, self.resolved_at.isoformat().encode(), "text/plain")))
            else:
                files.append(("resolved_at", (None, str(self.resolved_at).encode(), "text/plain")))
        ...
        if not isinstance(self.notification_opened_sent, Unset):
            files.append(
                ("notification_opened_sent", (None, str(self.notification_opened_sent).encode(), "text/plain"))
            )

        if not isinstance(self.notification_closed_sent, Unset):
            files.append(
                ("notification_closed_sent", (None, str(self.notification_closed_sent).encode(), "text/plain"))
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _downtime_ids = d.pop("downtime_ids", UNSET)
        downtime_ids: list[UUID] | Unset = UNSET
        if _downtime_ids is not UNSET:
            downtime_ids = []
            for downtime_ids_item_data in _downtime_ids:
                downtime_ids_item = UUID(downtime_ids_item_data)
        ...
        _vulnerability_finding_ids = d.pop("vulnerability_finding_ids", UNSET)
        vulnerability_finding_ids: list[UUID] | Unset = UNSET
        if _vulnerability_finding_ids is not UNSET:
            vulnerability_finding_ids = []
            for vulnerability_finding_ids_item_data in _vulnerability_finding_ids:
                vulnerability_finding_ids_item = UUID(vulnerability_finding_ids_item_data)
        ...
        kind: IncidentKindEnum | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_incident_kind_enum(_kind)

        _status = d.pop("status", UNSET)
        status: IncidentStatusEnum | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = check_incident_status_enum(_status)
        ...
        if isinstance(_discovered_at, Unset):
            ...
            discovered_at = datetime.datetime.fromisoformat(_discovered_at)
        ...
        notification_opened_sent = d.pop("notification_opened_sent", UNSET)

        notification_closed_sent = d.pop("notification_closed_sent", UNSET)
        ...
        patched_incident_request = cls(
            ...
            vulnerability_finding_ids=vulnerability_finding_ids,
            ...
            notification_opened_sent=notification_opened_sent,
            notification_closed_sent=notification_closed_sent,
        ...
        patched_incident_request.additional_properties = d
        return patched_incident_request
