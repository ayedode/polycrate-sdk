...
T = TypeVar("T", bound="PaginatedUserAdminList")


@_attrs_define
class PaginatedUserAdminList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.user_admin import UserAdmin  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = UserAdmin.from_dict(results_item_data)
        ...
        paginated_user_admin_list.additional_properties = d
        return paginated_user_admin_list
