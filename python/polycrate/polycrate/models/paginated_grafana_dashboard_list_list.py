...
T = TypeVar("T", bound="PaginatedGrafanaDashboardListList")


@_attrs_define
class PaginatedGrafanaDashboardListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[GrafanaDashboardList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = GrafanaDashboardList.from_dict(results_item_data)
        ...
        paginated_grafana_dashboard_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_grafana_dashboard_list_list.additional_properties = d
        return paginated_grafana_dashboard_list_list
