...
T = TypeVar("T", bound="PaginatedProjectListList")


@_attrs_define
class PaginatedProjectListList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.project_list import ProjectList  # noqa: PLC0415
        ...
        paginated_project_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_project_list_list.additional_properties = d
        return paginated_project_list_list
