...
T = TypeVar("T", bound="PaginatedWorkspaceListList")


@_attrs_define
class PaginatedWorkspaceListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[WorkspaceList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = WorkspaceList.from_dict(results_item_data)
        ...
        paginated_workspace_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_workspace_list_list.additional_properties = d
        return paginated_workspace_list_list
