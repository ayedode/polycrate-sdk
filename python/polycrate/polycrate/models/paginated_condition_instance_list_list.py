...
T = TypeVar("T", bound="PaginatedConditionInstanceListList")


@_attrs_define
class PaginatedConditionInstanceListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ConditionInstanceList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ConditionInstanceList.from_dict(results_item_data)
        ...
        paginated_condition_instance_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_condition_instance_list_list.additional_properties = d
        return paginated_condition_instance_list_list
