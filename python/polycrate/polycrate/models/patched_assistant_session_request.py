...
T = TypeVar("T", bound="PatchedAssistantSessionRequest")


@_attrs_define
class PatchedAssistantSessionRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_assistant_session_request = cls(
            name=name,
        ...
        patched_assistant_session_request.additional_properties = d
        return patched_assistant_session_request
