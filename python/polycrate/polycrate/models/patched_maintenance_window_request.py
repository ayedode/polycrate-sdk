...
T = TypeVar("T", bound="PatchedMaintenanceWindowRequest")


@_attrs_define
class PatchedMaintenanceWindowRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.lead_time_days, Unset):
            files.append(("lead_time_days", (None, str(self.lead_time_days).encode(), "text/plain")))

        if not isinstance(self.notice_required, Unset):
            files.append(("notice_required", (None, str(self.notice_required).encode(), "text/plain")))
        ...
        if not isinstance(self.time_slots, Unset):
            files.append(("time_slots", (None, str(self.time_slots).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_maintenance_window_request = cls(
            name=name,
        ...
        patched_maintenance_window_request.additional_properties = d
        return patched_maintenance_window_request
