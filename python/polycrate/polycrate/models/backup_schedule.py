...
from ..models.backup_schedule_status_enum import BackupScheduleStatusEnum, check_backup_schedule_status_enum
...
T = TypeVar("T", bound="BackupSchedule")


@_attrs_define
class BackupSchedule:
    """Full serializer for BackupSchedule - used for all CRUD operations.
    ...
    Siehe: .specs/0.13.0/backupschedule-name-fix.md
        ...
        Attributes:
            id (UUID):
            name (str): BackupSchedule name (required, must match regex ^[a-z0-9]+(?:-[a-z0-9]+)*$)
            ...
            deleted_by_user (BackupScheduleDeletedByUserType0 | None):
            ...
            organization (BackupScheduleOrganizationType0 | None):
            workspace (BackupScheduleWorkspaceType0 | None):
            created (BackupScheduleCreated):
            ...
            last_action_run (BackupScheduleLastActionRunType0 | None):
            k8s_cluster (UUID): K8sCluster UUID
            ...
            source_namespace (None | str | Unset): Kubernetes namespace of the discovered source schedule (for unique
                identity with name+provider)
            status (BackupScheduleStatusEnum | Unset): * `active` - Active
                * `paused` - Paused
                * `failed` - Failed
                * `unknown` - Unknown
            schedule_cron (None | str | Unset): Cron expression for the schedule (e.g., '0 2 * * *')
            paused (bool | Unset): Whether the schedule is paused
            retention_policy (None | str | Unset): Human-readable retention policy (e.g., '96h0m0s', '7 days')
            last_backup_at (datetime.datetime | None | Unset): When the last backup was created
            total_backups (int | Unset): Total number of backups created by this schedule
            metadata (Any | Unset): Provider-specific schedule metadata (spec, status, labels)
    """
    ...
    status: BackupScheduleStatusEnum | Unset = UNSET
    schedule_cron: None | str | Unset = UNSET
    paused: bool | Unset = UNSET
    retention_policy: None | str | Unset = UNSET
    last_backup_at: datetime.datetime | None | Unset = UNSET
    total_backups: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, BackupScheduleDeletedByUserType0):
        ...
        if isinstance(self.organization, BackupScheduleOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, BackupScheduleWorkspaceType0):
        ...
        if isinstance(self.last_action_run, BackupScheduleLastActionRunType0):
        ...
        last_backup_at: None | str | Unset
        if isinstance(self.last_backup_at, Unset):
            last_backup_at = UNSET
        elif isinstance(self.last_backup_at, datetime.datetime):
            last_backup_at = self.last_backup_at.isoformat()
        else:
        ...
        if last_backup_at is not UNSET:
            field_dict["last_backup_at"] = last_backup_at
        if total_backups is not UNSET:
            field_dict["total_backups"] = total_backups
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> BackupScheduleDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = BackupScheduleDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BackupScheduleDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> BackupScheduleOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = BackupScheduleOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BackupScheduleOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> BackupScheduleWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = BackupScheduleWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BackupScheduleWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = BackupScheduleCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> BackupScheduleLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = BackupScheduleLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BackupScheduleLastActionRunType0 | None, data)
        ...
        status: BackupScheduleStatusEnum | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = check_backup_schedule_status_enum(_status)
        ...
        def _parse_last_backup_at(data: object) -> datetime.datetime | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                last_backup_at_type_0 = datetime.datetime.fromisoformat(data)

                return last_backup_at_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(datetime.datetime | None | Unset, data)

        last_backup_at = _parse_last_backup_at(d.pop("last_backup_at", UNSET))

        total_backups = d.pop("total_backups", UNSET)
        ...
        backup_schedule.additional_properties = d
