...
if TYPE_CHECKING:
    ...
    from ..models.k8s_cluster_addon_subscription_detail_block_type_0 import K8SClusterAddonSubscriptionDetailBlockType0
...
T = TypeVar("T", bound="K8SClusterAddonSubscriptionDetail")


@_attrs_define
class K8SClusterAddonSubscriptionDetail:
    """Detail serializer. Writable: version, block_config_template, order.
    Create-only: addon, k8s_cluster. Spec: polycrate spec inspect 695
        ...
        Attributes:
            ...
            deleted_by_user (K8SClusterAddonSubscriptionDetailDeletedByUserType0 | None):
            ...
            organization (K8SClusterAddonSubscriptionDetailOrganizationType0 | None):
            workspace (K8SClusterAddonSubscriptionDetailWorkspaceType0 | None):
            created (K8SClusterAddonSubscriptionDetailCreated):
            ...
            last_action_run (K8SClusterAddonSubscriptionDetailLastActionRunType0 | None):
            k8s_cluster (UUID):
            k8s_cluster_detail (K8SClusterAddonSubscriptionDetailK8SClusterDetailType0 | None):
            addon (UUID):
            addon_detail (K8SClusterAddonSubscriptionDetailAddonDetailType0 | None):
            block (K8SClusterAddonSubscriptionDetailBlockType0 | None):
            ...
            version (str | Unset): Empty = follow addon default / latest.
            block_name (str | Unset): Workspace block name for this subscription. Required when the addon allows multiple
                installations. Empty on single-install addons uses the catalog block_name. Unique per workspace, not across
                addons or workspaces. Default: ''.
            block_config_template (str | Unset): Jinja2→YAML override merged onto addon default (lists replace).
            order (int | Unset):
    """
    ...
    block_config_template: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, K8SClusterAddonSubscriptionDetailDeletedByUserType0):
        ...
        if isinstance(self.organization, K8SClusterAddonSubscriptionDetailOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, K8SClusterAddonSubscriptionDetailWorkspaceType0):
        ...
        if isinstance(self.last_action_run, K8SClusterAddonSubscriptionDetailLastActionRunType0):
        ...
        k8s_cluster_detail: dict[str, Any] | None
        if isinstance(self.k8s_cluster_detail, K8SClusterAddonSubscriptionDetailK8SClusterDetailType0):
            k8s_cluster_detail = self.k8s_cluster_detail.to_dict()
        else:
            k8s_cluster_detail = self.k8s_cluster_detail

        addon = str(self.addon)

        addon_detail: dict[str, Any] | None
        if isinstance(self.addon_detail, K8SClusterAddonSubscriptionDetailAddonDetailType0):
            addon_detail = self.addon_detail.to_dict()
        else:
            addon_detail = self.addon_detail

        block: dict[str, Any] | None
        if isinstance(self.block, K8SClusterAddonSubscriptionDetailBlockType0):
        ...
        field_dict.update(
            {
                ...
                "k8s_cluster_detail": k8s_cluster_detail,
                "addon": addon,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> K8SClusterAddonSubscriptionDetailDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = K8SClusterAddonSubscriptionDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SClusterAddonSubscriptionDetailDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> K8SClusterAddonSubscriptionDetailOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = K8SClusterAddonSubscriptionDetailOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SClusterAddonSubscriptionDetailOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> K8SClusterAddonSubscriptionDetailWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = K8SClusterAddonSubscriptionDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SClusterAddonSubscriptionDetailWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = K8SClusterAddonSubscriptionDetailCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> K8SClusterAddonSubscriptionDetailLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = K8SClusterAddonSubscriptionDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SClusterAddonSubscriptionDetailLastActionRunType0 | None, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        k8s_cluster = UUID(d.pop("k8s_cluster"))

        def _parse_k8s_cluster_detail(data: object) -> K8SClusterAddonSubscriptionDetailK8SClusterDetailType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                k8s_cluster_detail_type_0 = K8SClusterAddonSubscriptionDetailK8SClusterDetailType0.from_dict(data)

                return k8s_cluster_detail_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SClusterAddonSubscriptionDetailK8SClusterDetailType0 | None, data)

        k8s_cluster_detail = _parse_k8s_cluster_detail(d.pop("k8s_cluster_detail"))

        addon = UUID(d.pop("addon"))

        def _parse_addon_detail(data: object) -> K8SClusterAddonSubscriptionDetailAddonDetailType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                addon_detail_type_0 = K8SClusterAddonSubscriptionDetailAddonDetailType0.from_dict(data)

                return addon_detail_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SClusterAddonSubscriptionDetailAddonDetailType0 | None, data)

        addon_detail = _parse_addon_detail(d.pop("addon_detail"))

        def _parse_block(data: object) -> K8SClusterAddonSubscriptionDetailBlockType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                block_type_0 = K8SClusterAddonSubscriptionDetailBlockType0.from_dict(data)

                return block_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SClusterAddonSubscriptionDetailBlockType0 | None, data)
        ...
        block_name = d.pop("block_name", UNSET)

        block_config_template = d.pop("block_config_template", UNSET)

        order = d.pop("order", UNSET)

        k8s_cluster_addon_subscription_detail = cls(
            id=id,
            created_at=created_at,
            updated_at=updated_at,
            deleted_at=deleted_at,
        ...
        k8s_cluster_addon_subscription_detail.additional_properties = d
        return k8s_cluster_addon_subscription_detail
