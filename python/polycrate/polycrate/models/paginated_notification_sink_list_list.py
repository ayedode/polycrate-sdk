...
T = TypeVar("T", bound="PaginatedNotificationSinkListList")


@_attrs_define
class PaginatedNotificationSinkListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[NotificationSinkList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = NotificationSinkList.from_dict(results_item_data)
        ...
        paginated_notification_sink_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_notification_sink_list_list.additional_properties = d
        return paginated_notification_sink_list_list
