...
T = TypeVar("T", bound="PatchedPolicyBindingRequest")


@_attrs_define
class PatchedPolicyBindingRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_policy_binding_request = cls(
            policy_id=policy_id,
            enabled=enabled,
            scope=scope,
            applied=applied,
        ...
        patched_policy_binding_request.additional_properties = d
        return patched_policy_binding_request
