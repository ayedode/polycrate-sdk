...
T = TypeVar("T", bound="PaginatedMessageListList")


@_attrs_define
class PaginatedMessageListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MessageList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = MessageList.from_dict(results_item_data)
        ...
        paginated_message_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_message_list_list.additional_properties = d
        return paginated_message_list_list
