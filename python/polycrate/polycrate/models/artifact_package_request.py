...
T = TypeVar("T", bound="ArtifactPackageRequest")


@_attrs_define
class ArtifactPackageRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        artifact_package_request.additional_properties = d
        return artifact_package_request
