...
if TYPE_CHECKING:
    from ..models.workspace_created_created_by_type_0 import WorkspaceCreatedCreatedByType0


T = TypeVar("T", bound="WorkspaceCreated")
...
class WorkspaceCreated:
    ...
    Attributes:
        ...
        created_by (None | Unset | WorkspaceCreatedCreatedByType0):
    """

    created_at: datetime.datetime | None | Unset = UNSET
    created_at_humanized: None | str | Unset = UNSET
    created_at_display: None | str | Unset = UNSET
    created_by: None | Unset | WorkspaceCreatedCreatedByType0 = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.workspace_created_created_by_type_0 import WorkspaceCreatedCreatedByType0  # noqa: PLC0415
        ...
        if isinstance(self.created_by, Unset):
            created_by = UNSET
        elif isinstance(self.created_by, WorkspaceCreatedCreatedByType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_created_by(data: object) -> None | Unset | WorkspaceCreatedCreatedByType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                created_by_type_0 = WorkspaceCreatedCreatedByType0.from_dict(data)

                return created_by_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | WorkspaceCreatedCreatedByType0, data)

        created_by = _parse_created_by(d.pop("created_by", UNSET))

        workspace_created = cls(
        ...
        workspace_created.additional_properties = d
