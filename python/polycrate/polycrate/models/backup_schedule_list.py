...
T = TypeVar("T", bound="BackupScheduleList")


@_attrs_define
class BackupScheduleList:
    """List serializer for BackupSchedule - V2 Dynamic Tables.
    ...
    Attributes:
        ...
        active_condition_instances (list[BackupScheduleListActiveConditionInstancesItem]):
        organization (BackupScheduleListOrganizationType0 | None):
        organization_priority (bool): True when the object's organization has priority=True.
        workspace (BackupScheduleListWorkspaceType0 | None):
        created (BackupScheduleListCreated):
        ...
        kind (str):
        provider (str):
        source_namespace (None | str):
        status (str):
        schedule_cron (str):
        paused (bool):
        k8s_cluster (BackupScheduleListK8SCluster):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, BackupScheduleListOrganizationType0):
        ...
        if isinstance(self.workspace, BackupScheduleListWorkspaceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = BackupScheduleListActiveConditionInstancesItem.from_dict(
                active_condition_instances_item_data
            )

            active_condition_instances.append(active_condition_instances_item)

        def _parse_organization(data: object) -> BackupScheduleListOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = BackupScheduleListOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BackupScheduleListOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        organization_priority = d.pop("organization_priority")

        def _parse_workspace(data: object) -> BackupScheduleListWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = BackupScheduleListWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BackupScheduleListWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = BackupScheduleListCreated.from_dict(d.pop("created"))
        ...
        def _parse_source_namespace(data: object) -> None | str:
            if data is None:
                return data
            return cast(None | str, data)

        source_namespace = _parse_source_namespace(d.pop("source_namespace"))
        ...
        k8s_cluster = BackupScheduleListK8SCluster.from_dict(d.pop("k8s_cluster"))

        backup_schedule_list = cls(
            id=id,
            name=name,
            state=state,
            labels=labels,
        ...
        backup_schedule_list.additional_properties = d
        return backup_schedule_list
