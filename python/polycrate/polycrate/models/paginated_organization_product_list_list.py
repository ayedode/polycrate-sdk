...
T = TypeVar("T", bound="PaginatedOrganizationProductListList")


@_attrs_define
class PaginatedOrganizationProductListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[OrganizationProductList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = OrganizationProductList.from_dict(results_item_data)
        ...
        paginated_organization_product_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_organization_product_list_list.additional_properties = d
        return paginated_organization_product_list_list
