...
T = TypeVar("T", bound="ArtifactRepositoryRequest")


@_attrs_define
class ArtifactRepositoryRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        files.append(("repository_url", (None, str(self.repository_url).encode(), "text/plain")))
        ...
        if not isinstance(self.alternative_repository_url, Unset):
            if isinstance(self.alternative_repository_url, str):
                files.append(
                    ("alternative_repository_url", (None, str(self.alternative_repository_url).encode(), "text/plain"))
                )
            else:
                files.append(
                    ("alternative_repository_url", (None, str(self.alternative_repository_url).encode(), "text/plain"))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        artifact_repository_request = cls(
            kind=kind,
            repository_url=repository_url,
            name=name,
        ...
        artifact_repository_request.additional_properties = d
        return artifact_repository_request
