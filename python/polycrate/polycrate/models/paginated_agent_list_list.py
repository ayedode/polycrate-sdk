...
T = TypeVar("T", bound="PaginatedAgentListList")


@_attrs_define
class PaginatedAgentListList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.agent_list import AgentList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = AgentList.from_dict(results_item_data)
        ...
        paginated_agent_list_list.additional_properties = d
        return paginated_agent_list_list
