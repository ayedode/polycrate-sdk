...
T = TypeVar("T", bound="PatchedProviderAccountDetailRequest")


@_attrs_define
class PatchedProviderAccountDetailRequest:
    ...
    Usage:
        ...
        Attributes:
            ...
            api_kind (ApiKindEnum | Unset): * `hetzner_cloud` - Hetzner Cloud
                * `openstack` - OpenStack
                * `ovhcloud` - OVHcloud
                * `ionos` - IONOS Cloud
                * `proxmox` - Proxmox VE
    ...
    api_kind: ApiKindEnum | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.api_kind, Unset):
        ...
        if api_kind is not UNSET:
            field_dict["api_kind"] = api_kind
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.api_kind, Unset):
            files.append(("api_kind", (None, str(self.api_kind).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _api_kind = d.pop("api_kind", UNSET)
        api_kind: ApiKindEnum | Unset
        if isinstance(_api_kind, Unset):
            api_kind = UNSET
        else:
            api_kind = check_api_kind_enum(_api_kind)
        ...
        patched_provider_account_detail_request = cls(
            name=name,
        ...
        patched_provider_account_detail_request.additional_properties = d
        return patched_provider_account_detail_request
