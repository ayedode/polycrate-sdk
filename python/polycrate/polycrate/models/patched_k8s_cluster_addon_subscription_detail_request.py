...
T = TypeVar("T", bound="PatchedK8SClusterAddonSubscriptionDetailRequest")


@_attrs_define
class PatchedK8SClusterAddonSubscriptionDetailRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.addon, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _addon = d.pop("addon", UNSET)
        addon: UUID | Unset
        if isinstance(_addon, Unset):
            addon = UNSET
        else:
            addon = UUID(_addon)
        ...
        patched_k8s_cluster_addon_subscription_detail_request = cls(
            name=name,
        ...
        patched_k8s_cluster_addon_subscription_detail_request.additional_properties = d
        return patched_k8s_cluster_addon_subscription_detail_request
