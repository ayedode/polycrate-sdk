...
T = TypeVar("T", bound="PricingQuoteAppDetailRequest")


@_attrs_define
class PricingQuoteAppDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pricing_quote_app_detail_request = cls(
            quote_workspace=quote_workspace,
            name=name,
        ...
        pricing_quote_app_detail_request.additional_properties = d
        return pricing_quote_app_detail_request
