...
T = TypeVar("T", bound="PatchedBlockRequest")


@_attrs_define
class PatchedBlockRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_block_request.additional_properties = d
        return patched_block_request
