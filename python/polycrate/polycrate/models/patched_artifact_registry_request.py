...
T = TypeVar("T", bound="PatchedArtifactRegistryRequest")


@_attrs_define
class PatchedArtifactRegistryRequest:
    ...
    Attributes:
        ...
        k8s_cluster (UUID | Unset): Kubernetes cluster where this registry runs
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.projects_count, Unset):
            files.append(("projects_count", (None, str(self.projects_count).encode(), "text/plain")))

        if not isinstance(self.repositories_count, Unset):
            files.append(("repositories_count", (None, str(self.repositories_count).encode(), "text/plain")))

        if not isinstance(self.storage_used_bytes, Unset):
            files.append(("storage_used_bytes", (None, str(self.storage_used_bytes).encode(), "text/plain")))

        if not isinstance(self.registry_version, Unset):
            if isinstance(self.registry_version, str):
                files.append(("registry_version", (None, str(self.registry_version).encode(), "text/plain")))
            else:
                files.append(("registry_version", (None, str(self.registry_version).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_artifact_registry_request = cls(
            name=name,
        ...
        patched_artifact_registry_request.additional_properties = d
        return patched_artifact_registry_request
