...
T = TypeVar("T", bound="PatchedDomainRegistrarDetailRequest")


@_attrs_define
class PatchedDomainRegistrarDetailRequest:
    ...
    Usage:
        ...
        Attributes:
            ...
            api_credential_id (None | Unset | UUID):
            ...
            default_renewal_mode (RenewalModeEnum | Unset): * `AUTORENEW` - Auto Renew — domain renews automatically
            ...
            provider_info (Any | Unset): Account-level metadata returned by the registrar API (populated during
                reconciliation).
            last_rate_limited_at (datetime.datetime | None | Unset): Timestamp of the last registrar API rate-limit /
                account-lock event. Used for backoff logic.
            api_backoff_minutes (int | None | Unset): Override the global registrar API backoff duration (in minutes) for
                this registrar. Leave blank to use the system default.
    ...
    api_credential_id: None | Unset | UUID = UNSET
    ...
    default_renewal_mode: RenewalModeEnum | Unset = UNSET
    import_domains: bool | Unset = UNSET
    import_contacts: bool | Unset = UNSET
    provider_info: Any | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        api_credential_id: None | str | Unset
        if isinstance(self.api_credential_id, Unset):
            api_credential_id = UNSET
        elif isinstance(self.api_credential_id, UUID):
            api_credential_id = str(self.api_credential_id)
        else:
        ...
        default_renewal_mode: str | Unset = UNSET
        if not isinstance(self.default_renewal_mode, Unset):
            default_renewal_mode = self.default_renewal_mode
        ...
        if api_credential_id is not UNSET:
            field_dict["api_credential_id"] = api_credential_id
        ...
        if ote is not UNSET:
            field_dict["ote"] = ote
        if default_renewal_mode is not UNSET:
            field_dict["default_renewal_mode"] = default_renewal_mode
        ...
        if provider_info is not UNSET:
            field_dict["provider_info"] = provider_info
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.api_credential_id, Unset):
            if isinstance(self.api_credential_id, UUID):
                files.append(("api_credential_id", (None, str(self.api_credential_id), "text/plain")))
            else:
                files.append(("api_credential_id", (None, str(self.api_credential_id).encode(), "text/plain")))
        ...
        if not isinstance(self.ote, Unset):
            files.append(("ote", (None, str(self.ote).encode(), "text/plain")))

        if not isinstance(self.default_renewal_mode, Unset):
            files.append(("default_renewal_mode", (None, str(self.default_renewal_mode).encode(), "text/plain")))

        if not isinstance(self.import_domains, Unset):
            files.append(("import_domains", (None, str(self.import_domains).encode(), "text/plain")))

        if not isinstance(self.import_contacts, Unset):
            files.append(("import_contacts", (None, str(self.import_contacts).encode(), "text/plain")))

        if not isinstance(self.provider_info, Unset):
            files.append(("provider_info", (None, str(self.provider_info).encode(), "text/plain")))

        if not isinstance(self.last_rate_limited_at, Unset):
            if isinstance(self.last_rate_limited_at, datetime.datetime):
                files.append(
                    ("last_rate_limited_at", (None, self.last_rate_limited_at.isoformat().encode(), "text/plain"))
                )
            else:
                files.append(("last_rate_limited_at", (None, str(self.last_rate_limited_at).encode(), "text/plain")))

        if not isinstance(self.api_backoff_minutes, Unset):
            if isinstance(self.api_backoff_minutes, int):
                files.append(("api_backoff_minutes", (None, str(self.api_backoff_minutes).encode(), "text/plain")))
            else:
                files.append(("api_backoff_minutes", (None, str(self.api_backoff_minutes).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_api_credential_id(data: object) -> None | Unset | UUID:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                api_credential_id_type_0 = UUID(data)

                return api_credential_id_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UUID, data)

        api_credential_id = _parse_api_credential_id(d.pop("api_credential_id", UNSET))
        ...
        _default_renewal_mode = d.pop("default_renewal_mode", UNSET)
        default_renewal_mode: RenewalModeEnum | Unset
        if isinstance(_default_renewal_mode, Unset):
            default_renewal_mode = UNSET
        else:
            default_renewal_mode = check_renewal_mode_enum(_default_renewal_mode)

        import_domains = d.pop("import_domains", UNSET)

        import_contacts = d.pop("import_contacts", UNSET)

        provider_info = d.pop("provider_info", UNSET)
        ...
        patched_domain_registrar_detail_request = cls(
            name=name,
            ...
            kind=kind,
            ote=ote,
            default_renewal_mode=default_renewal_mode,
        ...
        patched_domain_registrar_detail_request.additional_properties = d
        return patched_domain_registrar_detail_request
