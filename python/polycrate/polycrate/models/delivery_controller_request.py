...
T = TypeVar("T", bound="DeliveryControllerRequest")


@_attrs_define
class DeliveryControllerRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delivery_controller_request = cls(
            k8s_cluster=k8s_cluster,
            name=name,
        ...
        delivery_controller_request.additional_properties = d
        return delivery_controller_request
