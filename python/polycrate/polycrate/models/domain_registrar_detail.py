...
T = TypeVar("T", bound="DomainRegistrarDetail")


@_attrs_define
class DomainRegistrarDetail:
    ...
    Usage:
        ...
        Attributes:
            id (UUID):
            created (DomainRegistrarDetailCreated):
            organization (DomainRegistrarDetailOrganizationType0 | None):
            workspace (DomainRegistrarDetailWorkspaceType0 | None):
            ...
            last_action_run (DomainRegistrarDetailLastActionRunType0 | None):
            deleted_by_user (DomainRegistrarDetailDeletedByUserType0 | None):
            api_credential (CredentialSimple): Simple serializer for embedding Credential in other serializers.
    ...
    last_action_run: DomainRegistrarDetailLastActionRunType0 | None
    deleted_by_user: DomainRegistrarDetailDeletedByUserType0 | None
    api_credential: CredentialSimple
    created_at: datetime.datetime
    updated_at: datetime.datetime
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, DomainRegistrarDetailOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, DomainRegistrarDetailWorkspaceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created = DomainRegistrarDetailCreated.from_dict(d.pop("created"))

        def _parse_organization(data: object) -> DomainRegistrarDetailOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = DomainRegistrarDetailOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DomainRegistrarDetailOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> DomainRegistrarDetailWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = DomainRegistrarDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DomainRegistrarDetailWorkspaceType0 | None, data)
        ...
        def _parse_last_action_run(data: object) -> DomainRegistrarDetailLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = DomainRegistrarDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DomainRegistrarDetailLastActionRunType0 | None, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        def _parse_deleted_by_user(data: object) -> DomainRegistrarDetailDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = DomainRegistrarDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DomainRegistrarDetailDeletedByUserType0 | None, data)

        deleted_by_user = _parse_deleted_by_user(d.pop("deleted_by_user"))

        api_credential = CredentialSimple.from_dict(d.pop("api_credential"))
        ...
        domain_registrar_detail.additional_properties = d
        return domain_registrar_detail
