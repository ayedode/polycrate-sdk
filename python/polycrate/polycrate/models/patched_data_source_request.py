...
T = TypeVar("T", bound="PatchedDataSourceRequest")


@_attrs_define
class PatchedDataSourceRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_data_source_request = cls(
            name=name,
        ...
        patched_data_source_request.additional_properties = d
        return patched_data_source_request
