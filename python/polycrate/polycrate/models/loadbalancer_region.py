...
T = TypeVar("T", bound="LoadbalancerRegion")


@_attrs_define
class LoadbalancerRegion:
    """Detail serializer for LoadbalancerRegion — erbt von ManagedObjectDetailSerializer.
    Liefert icon_url für Managed Object Dashboard Header.
        ...
        Attributes:
            ...
            deleted_by_user (LoadbalancerRegionDeletedByUserType0 | None):
            ...
            organization (LoadbalancerRegionOrganizationType0 | None):
            workspace (LoadbalancerRegionWorkspaceType0 | None):
            created (LoadbalancerRegionCreated):
            ...
            last_action_run (LoadbalancerRegionLastActionRunType0 | None):
            region_name (str):
            haproxy (LoadbalancerRegionHaproxy):
            k8s_cluster (K8SClusterSimple):
            deployed_instances (list[LoadbalancerRegionDeployedInstancesItem]):
            instance_deployments (list[LoadbalancerRegionInstanceDeploymentsItem]):
            ...
            platform_service (bool | Unset): Makes this region available for the whole platform
            kind (LoadbalancerRegionKindEnum | Unset): * `cilium` - Cilium
                * `metallb` - MetalLB
            ...
            region_config (Any | Unset): Region JSON. HAProxy instances: optional `haproxy` object with workload_kind
                (deployment|daemonset), deployment.replica, daemonset.use_host_network, daemonset.use_host_port, daemonset.ports
                (name to port number).
    ...
    kind: LoadbalancerRegionKindEnum | Unset = UNSET
    ...
    region_config: Any | Unset = UNSET
    external_traffic_policy: ExternalTrafficPolicyEnum | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, LoadbalancerRegionDeletedByUserType0):
        ...
        if isinstance(self.organization, LoadbalancerRegionOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, LoadbalancerRegionWorkspaceType0):
        ...
        if isinstance(self.last_action_run, LoadbalancerRegionLastActionRunType0):
        ...
        haproxy = self.haproxy.to_dict()

        k8s_cluster = self.k8s_cluster.to_dict()

        deployed_instances = []
        for deployed_instances_item_data in self.deployed_instances:
            deployed_instances_item = deployed_instances_item_data.to_dict()
            deployed_instances.append(deployed_instances_item)

        instance_deployments = []
        for instance_deployments_item_data in self.instance_deployments:
            instance_deployments_item = instance_deployments_item_data.to_dict()
            instance_deployments.append(instance_deployments_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> LoadbalancerRegionDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = LoadbalancerRegionDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(LoadbalancerRegionDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> LoadbalancerRegionOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = LoadbalancerRegionOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(LoadbalancerRegionOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> LoadbalancerRegionWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = LoadbalancerRegionWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(LoadbalancerRegionWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = LoadbalancerRegionCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> LoadbalancerRegionLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = LoadbalancerRegionLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(LoadbalancerRegionLastActionRunType0 | None, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        region_name = d.pop("region_name")

        haproxy = LoadbalancerRegionHaproxy.from_dict(d.pop("haproxy"))

        k8s_cluster = K8SClusterSimple.from_dict(d.pop("k8s_cluster"))

        deployed_instances = []
        _deployed_instances = d.pop("deployed_instances")
        for deployed_instances_item_data in _deployed_instances:
            deployed_instances_item = LoadbalancerRegionDeployedInstancesItem.from_dict(deployed_instances_item_data)

            deployed_instances.append(deployed_instances_item)

        instance_deployments = []
        _instance_deployments = d.pop("instance_deployments")
        for instance_deployments_item_data in _instance_deployments:
            instance_deployments_item = LoadbalancerRegionInstanceDeploymentsItem.from_dict(
                instance_deployments_item_data
            )
        ...
        kind: LoadbalancerRegionKindEnum | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_loadbalancer_region_kind_enum(_kind)
        ...
        region_config = d.pop("region_config", UNSET)
        ...
        loadbalancer_region.additional_properties = d
        return loadbalancer_region
