...
T = TypeVar("T", bound="PatchedNotificationSinkRequest")


@_attrs_define
class PatchedNotificationSinkRequest:
    ...
    Attributes:
        ...
        kind (NotificationSinkKindEnum | Unset): * `mattermost` - Mattermost
            * `slack` - Slack
    ...
    kind: NotificationSinkKindEnum | Unset = UNSET
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.is_system_default, Unset):
            files.append(("is_system_default", (None, str(self.is_system_default).encode(), "text/plain")))

        if not isinstance(self.enabled_model_types, Unset):
            files.append(("enabled_model_types", (None, str(self.enabled_model_types).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kind: NotificationSinkKindEnum | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_notification_sink_kind_enum(_kind)
        ...
        patched_notification_sink_request = cls(
            name=name,
        ...
        patched_notification_sink_request.additional_properties = d
        return patched_notification_sink_request
