...
from ..models.delivery_controller_kind_enum import DeliveryControllerKindEnum, check_delivery_controller_kind_enum
...
T = TypeVar("T", bound="DeliveryController")


@_attrs_define
class DeliveryController:
    """Full serializer for DeliveryController detail views.
    ...
    Attributes:
        ...
        deleted_by_user (DeliveryControllerDeletedByUserType0 | None):
        ...
        organization (DeliveryControllerOrganizationType0 | None):
        workspace (DeliveryControllerWorkspaceType0 | None):
        created (DeliveryControllerCreated):
        ...
        last_action_run (DeliveryControllerLastActionRunType0 | None):
        k8s_cluster (UUID): Kubernetes cluster where this controller runs
        ...
        kind (DeliveryControllerKindEnum | Unset): * `generic` - Generic
            * `argocd` - ArgoCD
            * `flux` - Flux
        ...
        hostname (None | str | Unset): Hostname/URL where this controller is accessible
        applications_total (int | Unset): Total managed applications
        applications_synced (int | Unset): Applications in sync
        applications_out_of_sync (int | Unset): Applications out of sync
        applications_degraded (int | Unset): Degraded applications
        controller_app_version (None | str | Unset): Controller application version
        k8s_app (None | Unset | UUID): K8s application that implements this delivery controller
        credential (None | Unset | UUID): Credential for admin access
    ...
    kind: DeliveryControllerKindEnum | Unset = UNSET
    ...
    applications_total: int | Unset = UNSET
    applications_synced: int | Unset = UNSET
    applications_out_of_sync: int | Unset = UNSET
    applications_degraded: int | Unset = UNSET
    controller_app_version: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, DeliveryControllerDeletedByUserType0):
        ...
        if isinstance(self.organization, DeliveryControllerOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, DeliveryControllerWorkspaceType0):
        ...
        if isinstance(self.last_action_run, DeliveryControllerLastActionRunType0):
        ...
        applications_out_of_sync = self.applications_out_of_sync

        applications_degraded = self.applications_degraded

        controller_app_version: None | str | Unset
        if isinstance(self.controller_app_version, Unset):
            controller_app_version = UNSET
        else:
            controller_app_version = self.controller_app_version
        ...
        if applications_total is not UNSET:
            field_dict["applications_total"] = applications_total
        if applications_synced is not UNSET:
            field_dict["applications_synced"] = applications_synced
        if applications_out_of_sync is not UNSET:
            field_dict["applications_out_of_sync"] = applications_out_of_sync
        if applications_degraded is not UNSET:
            field_dict["applications_degraded"] = applications_degraded
        if controller_app_version is not UNSET:
            field_dict["controller_app_version"] = controller_app_version
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> DeliveryControllerDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = DeliveryControllerDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DeliveryControllerDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> DeliveryControllerOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = DeliveryControllerOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DeliveryControllerOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> DeliveryControllerWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = DeliveryControllerWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DeliveryControllerWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = DeliveryControllerCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> DeliveryControllerLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = DeliveryControllerLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DeliveryControllerLastActionRunType0 | None, data)
        ...
        kind: DeliveryControllerKindEnum | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_delivery_controller_kind_enum(_kind)
        ...
        applications_total = d.pop("applications_total", UNSET)

        applications_synced = d.pop("applications_synced", UNSET)

        applications_out_of_sync = d.pop("applications_out_of_sync", UNSET)

        applications_degraded = d.pop("applications_degraded", UNSET)

        def _parse_controller_app_version(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        controller_app_version = _parse_controller_app_version(d.pop("controller_app_version", UNSET))
        ...
        delivery_controller = cls(
            ...
            applications_synced=applications_synced,
            applications_out_of_sync=applications_out_of_sync,
            applications_degraded=applications_degraded,
        ...
        delivery_controller.additional_properties = d
