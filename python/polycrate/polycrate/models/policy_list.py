...
if TYPE_CHECKING:
    from ..models.policy_list_active_condition_instances_item import PolicyListActiveConditionInstancesItem
    from ..models.policy_list_created import PolicyListCreated
    from ..models.policy_list_organization_type_0 import PolicyListOrganizationType0
    from ..models.policy_list_workspace_type_0 import PolicyListWorkspaceType0
...
class PolicyList:
    ...
    organization/workspace werden automatisch von ManagedObjectListSerializer bereitgestellt.
        ...
        Attributes:
            ...
            active_condition_instances (list[PolicyListActiveConditionInstancesItem]):
            organization (None | PolicyListOrganizationType0):
            organization_priority (bool): True when the object's organization has priority=True.
            workspace (None | PolicyListWorkspaceType0):
            created (PolicyListCreated):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.policy_list_organization_type_0 import PolicyListOrganizationType0  # noqa: PLC0415
        from ..models.policy_list_workspace_type_0 import PolicyListWorkspaceType0  # noqa: PLC0415
        ...
        if isinstance(self.organization, PolicyListOrganizationType0):
        ...
        if isinstance(self.workspace, PolicyListWorkspaceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.policy_list_active_condition_instances_item import (
            PolicyListActiveConditionInstancesItem,  # noqa: PLC0415
        )
        from ..models.policy_list_created import PolicyListCreated  # noqa: PLC0415
        from ..models.policy_list_organization_type_0 import PolicyListOrganizationType0  # noqa: PLC0415
        from ..models.policy_list_workspace_type_0 import PolicyListWorkspaceType0  # noqa: PLC0415
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = PolicyListActiveConditionInstancesItem.from_dict(
                active_condition_instances_item_data
            )

            active_condition_instances.append(active_condition_instances_item)

        def _parse_organization(data: object) -> None | PolicyListOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = PolicyListOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PolicyListOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        organization_priority = d.pop("organization_priority")

        def _parse_workspace(data: object) -> None | PolicyListWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = PolicyListWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PolicyListWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = PolicyListCreated.from_dict(d.pop("created"))
