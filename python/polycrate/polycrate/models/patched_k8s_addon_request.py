...
T = TypeVar("T", bound="PatchedK8SAddonRequest")


@_attrs_define
class PatchedK8SAddonRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.default_version, Unset):
            files.append(("default_version", (None, str(self.default_version).encode(), "text/plain")))

        if not isinstance(self.default_block_config_template, Unset):
            files.append(
                (
                    "default_block_config_template",
                    (None, str(self.default_block_config_template).encode(), "text/plain"),
                )
            )
        ...
        if not isinstance(self.allow_multiple, Unset):
            files.append(("allow_multiple", (None, str(self.allow_multiple).encode(), "text/plain")))

        if not isinstance(self.order, Unset):
            files.append(("order", (None, str(self.order).encode(), "text/plain")))

        if not isinstance(self.enforcement, Unset):
            files.append(("enforcement", (None, str(self.enforcement).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _catalogue_app = d.pop("catalogue_app", UNSET)
        catalogue_app: UUID | Unset
        if isinstance(_catalogue_app, Unset):
            catalogue_app = UNSET
        else:
            catalogue_app = UUID(_catalogue_app)
        ...
        patched_k8s_addon_request.additional_properties = d
        return patched_k8s_addon_request
