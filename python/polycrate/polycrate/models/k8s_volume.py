...
class K8SVolume:
    ...
    organization and workspace are handled by ManagedObjectBaseViewset.perform_create.
        ...
        Attributes:
            ...
            deleted_by_user (K8SVolumeDeletedByUserType0 | None):
            ...
            organization (K8SVolumeOrganizationType0 | None):
            workspace (K8SVolumeWorkspaceType0 | None):
            created (K8SVolumeCreated):
            ...
            last_action_run (K8SVolumeLastActionRunType0 | None):
            k8s_cluster (UUID):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, K8SVolumeDeletedByUserType0):
        ...
        if isinstance(self.organization, K8SVolumeOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, K8SVolumeWorkspaceType0):
        ...
        if isinstance(self.last_action_run, K8SVolumeLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> K8SVolumeDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = K8SVolumeDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SVolumeDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> K8SVolumeOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = K8SVolumeOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SVolumeOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> K8SVolumeWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = K8SVolumeWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SVolumeWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = K8SVolumeCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> K8SVolumeLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = K8SVolumeLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SVolumeLastActionRunType0 | None, data)
        ...
        k8s_volume.additional_properties = d
        return k8s_volume
