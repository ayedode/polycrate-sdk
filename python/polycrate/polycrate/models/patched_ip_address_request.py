...
T = TypeVar("T", bound="PatchedIPAddressRequest")


@_attrs_define
class PatchedIPAddressRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        prefix_id: str | Unset = UNSET
        if not isinstance(self.prefix_id, Unset):
            prefix_id = str(self.prefix_id)
        ...
        if prefix_id is not UNSET:
            field_dict["prefix_id"] = prefix_id
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.prefix_id, Unset):
            files.append(("prefix_id", (None, str(self.prefix_id), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _prefix_id = d.pop("prefix_id", UNSET)
        prefix_id: UUID | Unset
        if isinstance(_prefix_id, Unset):
            prefix_id = UNSET
        else:
            prefix_id = UUID(_prefix_id)

        ip_address = d.pop("ip_address", UNSET)

        patched_ip_address_request = cls(
            name=name,
        ...
        patched_ip_address_request.additional_properties = d
        return patched_ip_address_request
