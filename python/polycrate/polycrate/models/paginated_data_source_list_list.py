...
T = TypeVar("T", bound="PaginatedDataSourceListList")


@_attrs_define
class PaginatedDataSourceListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[DataSourceList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.data_source_list import DataSourceList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = DataSourceList.from_dict(results_item_data)
        ...
        paginated_data_source_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_data_source_list_list.additional_properties = d
        return paginated_data_source_list_list
