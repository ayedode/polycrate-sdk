...
T = TypeVar("T", bound="PatchedSecretManagerRequest")


@_attrs_define
class PatchedSecretManagerRequest:
    ...
    Attributes:
        ...
        k8s_cluster (UUID | Unset): Kubernetes cluster where this secret manager runs
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.vault_mode, Unset):
            if isinstance(self.vault_mode, str):
                files.append(("vault_mode", (None, str(self.vault_mode).encode(), "text/plain")))
            elif isinstance(self.vault_mode, str):
                files.append(("vault_mode", (None, str(self.vault_mode).encode(), "text/plain")))
            else:
                files.append(("vault_mode", (None, str(self.vault_mode).encode(), "text/plain")))

        if not isinstance(self.is_sealed, Unset):
            files.append(("is_sealed", (None, str(self.is_sealed).encode(), "text/plain")))

        if not isinstance(self.is_initialized, Unset):
            files.append(("is_initialized", (None, str(self.is_initialized).encode(), "text/plain")))

        if not isinstance(self.secrets_engines_count, Unset):
            files.append(("secrets_engines_count", (None, str(self.secrets_engines_count).encode(), "text/plain")))

        if not isinstance(self.auth_methods_count, Unset):
            files.append(("auth_methods_count", (None, str(self.auth_methods_count).encode(), "text/plain")))

        if not isinstance(self.policies_count, Unset):
            files.append(("policies_count", (None, str(self.policies_count).encode(), "text/plain")))

        if not isinstance(self.vault_version, Unset):
            if isinstance(self.vault_version, str):
                files.append(("vault_version", (None, str(self.vault_version).encode(), "text/plain")))
            else:
                files.append(("vault_version", (None, str(self.vault_version).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_secret_manager_request = cls(
            name=name,
        ...
        patched_secret_manager_request.additional_properties = d
        return patched_secret_manager_request
