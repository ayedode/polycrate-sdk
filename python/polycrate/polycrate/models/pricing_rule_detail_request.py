...
T = TypeVar("T", bound="PricingRuleDetailRequest")


@_attrs_define
class PricingRuleDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pricing_rule_detail_request = cls(
            discount_type=discount_type,
            discount_value=discount_value,
            name=name,
        ...
        pricing_rule_detail_request.additional_properties = d
        return pricing_rule_detail_request
