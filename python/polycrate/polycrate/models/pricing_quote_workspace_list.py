...
T = TypeVar("T", bound="PricingQuoteWorkspaceList")


@_attrs_define
class PricingQuoteWorkspaceList:
    ...
    Usage:
        ...
        Attributes:
            ...
            active_condition_instances (list[PricingQuoteWorkspaceListActiveConditionInstancesItem]):
            organization (None | PricingQuoteWorkspaceListOrganizationType0):
            organization_priority (bool): True when the object's organization has priority=True.
            workspace (None | PricingQuoteWorkspaceListWorkspaceType0):
            created (PricingQuoteWorkspaceListCreated):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, PricingQuoteWorkspaceListOrganizationType0):
        ...
        if isinstance(self.workspace, PricingQuoteWorkspaceListWorkspaceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = PricingQuoteWorkspaceListActiveConditionInstancesItem.from_dict(
                active_condition_instances_item_data
            )

            active_condition_instances.append(active_condition_instances_item)

        def _parse_organization(data: object) -> None | PricingQuoteWorkspaceListOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = PricingQuoteWorkspaceListOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteWorkspaceListOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        organization_priority = d.pop("organization_priority")

        def _parse_workspace(data: object) -> None | PricingQuoteWorkspaceListWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = PricingQuoteWorkspaceListWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteWorkspaceListWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = PricingQuoteWorkspaceListCreated.from_dict(d.pop("created"))
        ...
        pricing_quote_workspace_list = cls(
            id=id,
            name=name,
            state=state,
            labels=labels,
        ...
        pricing_quote_workspace_list.additional_properties = d
        return pricing_quote_workspace_list
