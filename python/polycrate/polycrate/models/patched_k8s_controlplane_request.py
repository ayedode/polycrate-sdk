...
T = TypeVar("T", bound="PatchedK8SControlplaneRequest")


@_attrs_define
class PatchedK8SControlplaneRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.cluster_domain, Unset):
            files.append(("cluster_domain", (None, str(self.cluster_domain).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_k8s_controlplane_request = cls(
            name=name,
        ...
        patched_k8s_controlplane_request.additional_properties = d
        return patched_k8s_controlplane_request
