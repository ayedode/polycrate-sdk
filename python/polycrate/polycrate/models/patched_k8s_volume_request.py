...
T = TypeVar("T", bound="PatchedK8SVolumeRequest")


@_attrs_define
class PatchedK8SVolumeRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_k8s_volume_request = cls(
            name=name,
        ...
        patched_k8s_volume_request.additional_properties = d
        return patched_k8s_volume_request
