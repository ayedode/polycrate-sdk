...
if TYPE_CHECKING:
    from ..models.conversation_provider_post_request_secrets_type_0 import ConversationProviderPostRequestSecretsType0


T = TypeVar("T", bound="ConversationProviderPostRequest")


@_attrs_define
class ConversationProviderPostRequest:
    ...
    Following S3 pattern with validation and create logic.
        ...
        Attributes:
            ...
            secrets (ConversationProviderPostRequestSecretsType0 | None | Unset): Provider secrets as JSON object (encrypted
                in database)
    """
    ...
    secrets: ConversationProviderPostRequestSecretsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.secrets, Unset):
            secrets = UNSET
        elif isinstance(self.secrets, ConversationProviderPostRequestSecretsType0):
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.secrets, Unset):
            if isinstance(self.secrets, ConversationProviderPostRequestSecretsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_secrets(data: object) -> ConversationProviderPostRequestSecretsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                secrets_type_0 = ConversationProviderPostRequestSecretsType0.from_dict(data)

                return secrets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ConversationProviderPostRequestSecretsType0 | None | Unset, data)

        secrets = _parse_secrets(d.pop("secrets", UNSET))

        conversation_provider_post_request = cls(
            name=name,
            kind=kind,
        ...
        conversation_provider_post_request.additional_properties = d
        return conversation_provider_post_request
