...
if TYPE_CHECKING:
    from ..models.condition_catalog_list_created_created_by_type_0 import ConditionCatalogListCreatedCreatedByType0


T = TypeVar("T", bound="ConditionCatalogListCreated")


@_attrs_define
class ConditionCatalogListCreated:
    """
    Attributes:
        created_at (datetime.datetime | None | Unset):
        created_at_humanized (None | str | Unset):
        created_at_display (None | str | Unset):
        created_by (ConditionCatalogListCreatedCreatedByType0 | None | Unset):
    """

    created_at: datetime.datetime | None | Unset = UNSET
    created_at_humanized: None | str | Unset = UNSET
    created_at_display: None | str | Unset = UNSET
    created_by: ConditionCatalogListCreatedCreatedByType0 | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.condition_catalog_list_created_created_by_type_0 import (
            ConditionCatalogListCreatedCreatedByType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.created_by, Unset):
            created_by = UNSET
        elif isinstance(self.created_by, ConditionCatalogListCreatedCreatedByType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_created_by(data: object) -> ConditionCatalogListCreatedCreatedByType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                created_by_type_0 = ConditionCatalogListCreatedCreatedByType0.from_dict(data)

                return created_by_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ConditionCatalogListCreatedCreatedByType0 | None | Unset, data)

        created_by = _parse_created_by(d.pop("created_by", UNSET))

        condition_catalog_list_created = cls(
        ...
        condition_catalog_list_created.additional_properties = d
        return condition_catalog_list_created
