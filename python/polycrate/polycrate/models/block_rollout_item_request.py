...
T = TypeVar("T", bound="BlockRolloutItemRequest")


@_attrs_define
class BlockRolloutItemRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        block_rollout_item_request = cls(
            block=block,
            action_name=action_name,
            name=name,
        ...
        block_rollout_item_request.additional_properties = d
        return block_rollout_item_request
