...
T = TypeVar("T", bound="PatchedPolicyRequest")


@_attrs_define
class PatchedPolicyRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.expression, Unset):
            files.append(("expression", (None, str(self.expression).encode(), "text/plain")))
        ...
        if not isinstance(self.models_selector, Unset):
            files.append(("models_selector", (None, str(self.models_selector).encode(), "text/plain")))

        if not isinstance(self.organizations_selector, Unset):
            files.append(("organizations_selector", (None, str(self.organizations_selector).encode(), "text/plain")))

        if not isinstance(self.workspaces_selector, Unset):
            files.append(("workspaces_selector", (None, str(self.workspaces_selector).encode(), "text/plain")))

        if not isinstance(self.kinds_selector, Unset):
            files.append(("kinds_selector", (None, str(self.kinds_selector).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_policy_request.additional_properties = d
        return patched_policy_request
