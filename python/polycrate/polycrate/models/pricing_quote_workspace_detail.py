...
if TYPE_CHECKING:
    ...
    from ..models.pricing_quote_workspace_detail_organization_type_0 import PricingQuoteWorkspaceDetailOrganizationType0
    from ..models.pricing_quote_workspace_detail_workspace_type_0 import PricingQuoteWorkspaceDetailWorkspaceType0


T = TypeVar("T", bound="PricingQuoteWorkspaceDetail")


@_attrs_define
class PricingQuoteWorkspaceDetail:
    ...
    Usage:
        ...
        Attributes:
            ...
            deleted_by_user (None | PricingQuoteWorkspaceDetailDeletedByUserType0):
            ...
            organization (None | PricingQuoteWorkspaceDetailOrganizationType0):
            workspace (None | PricingQuoteWorkspaceDetailWorkspaceType0):
            created (PricingQuoteWorkspaceDetailCreated):
            ...
            last_action_run (None | PricingQuoteWorkspaceDetailLastActionRunType0):
            quote (UUID):
            label (str):
            apps (list[PricingQuoteAppSimple]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, PricingQuoteWorkspaceDetailDeletedByUserType0):
        ...
        if isinstance(self.organization, PricingQuoteWorkspaceDetailOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, PricingQuoteWorkspaceDetailWorkspaceType0):
        ...
        if isinstance(self.last_action_run, PricingQuoteWorkspaceDetailLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> None | PricingQuoteWorkspaceDetailDeletedByUserType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = PricingQuoteWorkspaceDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteWorkspaceDetailDeletedByUserType0, data)
        ...
        def _parse_organization(data: object) -> None | PricingQuoteWorkspaceDetailOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = PricingQuoteWorkspaceDetailOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteWorkspaceDetailOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> None | PricingQuoteWorkspaceDetailWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = PricingQuoteWorkspaceDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteWorkspaceDetailWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = PricingQuoteWorkspaceDetailCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> None | PricingQuoteWorkspaceDetailLastActionRunType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = PricingQuoteWorkspaceDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteWorkspaceDetailLastActionRunType0, data)
        ...
        for apps_item_data in _apps:
            apps_item = PricingQuoteAppSimple.from_dict(apps_item_data)
        ...
        pricing_quote_workspace_detail = cls(
            id=id,
            created_at=created_at,
            updated_at=updated_at,
            deleted_at=deleted_at,
        ...
        pricing_quote_workspace_detail.additional_properties = d
        return pricing_quote_workspace_detail
