...
if TYPE_CHECKING:
    from ..models.pricing_rule_list import PricingRuleList


T = TypeVar("T", bound="PaginatedPricingRuleListList")


@_attrs_define
class PaginatedPricingRuleListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[PricingRuleList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.pricing_rule_list import PricingRuleList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = PricingRuleList.from_dict(results_item_data)
        ...
        paginated_pricing_rule_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_pricing_rule_list_list.additional_properties = d
        return paginated_pricing_rule_list_list
