...
T = TypeVar("T", bound="PatchedK8SClusterRequest")


@_attrs_define
class PatchedK8SClusterRequest:
    ...
    Per .specs/0.11.4/dynamic-table-v2.md
        ...
        Attributes:
            ...
            scope (ScopeEnum | Unset): * `system` - System
                * `user` - User
            kind (K8SClusterKindEnum | Unset): * `polycrate` - Polycrate
                * `generic` - Generic
                * `loopback` - Loopback
    ...
    kind: K8SClusterKindEnum | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kind: K8SClusterKindEnum | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_k8s_cluster_kind_enum(_kind)
        ...
        patched_k8s_cluster_request = cls(
            name=name,
        ...
        patched_k8s_cluster_request.additional_properties = d
        return patched_k8s_cluster_request
