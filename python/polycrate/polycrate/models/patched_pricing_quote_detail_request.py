...
T = TypeVar("T", bound="PatchedPricingQuoteDetailRequest")


@_attrs_define
class PatchedPricingQuoteDetailRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.customer_name, Unset):
            files.append(("customer_name", (None, str(self.customer_name).encode(), "text/plain")))

        if not isinstance(self.customer_email, Unset):
            if isinstance(self.customer_email, str):
                files.append(("customer_email", (None, str(self.customer_email).encode(), "text/plain")))
        ...
        if not isinstance(self.valid_until, Unset):
            if isinstance(self.valid_until, datetime.date):
                ...
                files.append(("valid_until", (None, str(self.valid_until).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_pricing_quote_detail_request = cls(
            name=name,
        ...
        patched_pricing_quote_detail_request.additional_properties = d
        return patched_pricing_quote_detail_request
