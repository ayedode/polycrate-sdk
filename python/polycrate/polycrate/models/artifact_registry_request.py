...
T = TypeVar("T", bound="ArtifactRegistryRequest")
...
class ArtifactRegistryRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        artifact_registry_request.additional_properties = d
        return artifact_registry_request
