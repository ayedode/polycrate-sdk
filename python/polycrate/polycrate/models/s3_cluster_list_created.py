...
T = TypeVar("T", bound="S3ClusterListCreated")


@_attrs_define
class S3ClusterListCreated:
    """
    Attributes:
        created_at (datetime.datetime | None | Unset):
        created_at_humanized (None | str | Unset):
        created_at_display (None | str | Unset):
        created_by (None | S3ClusterListCreatedCreatedByType0 | Unset):
    """

    created_at: datetime.datetime | None | Unset = UNSET
    created_at_humanized: None | str | Unset = UNSET
    created_at_display: None | str | Unset = UNSET
    created_by: None | S3ClusterListCreatedCreatedByType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.created_by, Unset):
            created_by = UNSET
        elif isinstance(self.created_by, S3ClusterListCreatedCreatedByType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_created_by(data: object) -> None | S3ClusterListCreatedCreatedByType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                created_by_type_0 = S3ClusterListCreatedCreatedByType0.from_dict(data)

                return created_by_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | S3ClusterListCreatedCreatedByType0 | Unset, data)

        created_by = _parse_created_by(d.pop("created_by", UNSET))

        s3_cluster_list_created = cls(
        ...
        s3_cluster_list_created.additional_properties = d
        return s3_cluster_list_created
