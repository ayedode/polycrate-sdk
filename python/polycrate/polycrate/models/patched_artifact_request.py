...
T = TypeVar("T", bound="PatchedArtifactRequest")


@_attrs_define
class PatchedArtifactRequest:
    ...
    Attributes:
        ...
        kind (ArtifactKindEnum | Unset): * `helm` - Helm
            * `docker` - Docker
            * `polycrate` - Polycrate
            * `oci` - OCI
            * `source` - Source Code
    ...
    kind: ArtifactKindEnum | Unset = UNSET
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.content_url, Unset):
            files.append(("content_url", (None, str(self.content_url).encode(), "text/plain")))
        ...
        if not isinstance(self.source_urls, Unset):
            files.append(("source_urls", (None, str(self.source_urls).encode(), "text/plain")))
        ...
        if not isinstance(self.changelog, Unset):
            if isinstance(self.changelog, str):
                files.append(("changelog", (None, str(self.changelog).encode(), "text/plain")))
            else:
                files.append(("changelog", (None, str(self.changelog).encode(), "text/plain")))
        ...
        if not isinstance(self.default_config, Unset):
            if isinstance(self.default_config, str):
                files.append(("default_config", (None, str(self.default_config).encode(), "text/plain")))
            else:
                files.append(("default_config", (None, str(self.default_config).encode(), "text/plain")))

        if not isinstance(self.mirrored, Unset):
            files.append(("mirrored", (None, str(self.mirrored).encode(), "text/plain")))

        if not isinstance(self.mirrored_content_url, Unset):
            if isinstance(self.mirrored_content_url, str):
                files.append(("mirrored_content_url", (None, str(self.mirrored_content_url).encode(), "text/plain")))
            else:
                files.append(("mirrored_content_url", (None, str(self.mirrored_content_url).encode(), "text/plain")))

        if not isinstance(self.mirrored_at, Unset):
            if isinstance(self.mirrored_at, datetime.datetime):
                files.append(("mirrored_at", (None, self.mirrored_at.isoformat().encode(), "text/plain")))
            else:
                files.append(("mirrored_at", (None, str(self.mirrored_at).encode(), "text/plain")))
        ...
        if not isinstance(self.deprecated, Unset):
            files.append(("deprecated", (None, str(self.deprecated).encode(), "text/plain")))

        if not isinstance(self.prerelease, Unset):
            files.append(("prerelease", (None, str(self.prerelease).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        kind: ArtifactKindEnum | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_artifact_kind_enum(_kind)
        ...
        patched_artifact_request.additional_properties = d
        return patched_artifact_request
