...
T = TypeVar("T", bound="PricingCalculatorStateDetailRequest")


@_attrs_define
class PricingCalculatorStateDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pricing_calculator_state_detail_request = cls(
            name=name,
        ...
        pricing_calculator_state_detail_request.additional_properties = d
        return pricing_calculator_state_detail_request
