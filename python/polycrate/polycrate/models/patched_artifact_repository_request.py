...
T = TypeVar("T", bound="PatchedArtifactRepositoryRequest")


@_attrs_define
class PatchedArtifactRepositoryRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.repository_url, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_artifact_repository_request = cls(
            name=name,
        ...
        patched_artifact_repository_request.additional_properties = d
        return patched_artifact_repository_request
