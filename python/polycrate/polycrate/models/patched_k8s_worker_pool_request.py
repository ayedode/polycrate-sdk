...
T = TypeVar("T", bound="PatchedK8SWorkerPoolRequest")


@_attrs_define
class PatchedK8SWorkerPoolRequest:
    ...
    Usage:
        ...
        Attributes:
            ...
            controlplane_id (UUID | Unset):
            provider_account_id (UUID | Unset):
    ...
    controlplane_id: UUID | Unset = UNSET
    provider_account_id: UUID | Unset = UNSET
    product_id: UUID | Unset = UNSET
    desired_count: int | Unset = UNSET
    image: str | Unset = UNSET
    location: str | Unset = UNSET
    ssh_key_credential_id: UUID | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        controlplane_id: str | Unset = UNSET
        if not isinstance(self.controlplane_id, Unset):
            controlplane_id = str(self.controlplane_id)
        ...
        ssh_key_credential_id: str | Unset = UNSET
        if not isinstance(self.ssh_key_credential_id, Unset):
            ssh_key_credential_id = str(self.ssh_key_credential_id)
        ...
        if controlplane_id is not UNSET:
            field_dict["controlplane_id"] = controlplane_id
        ...
        if ssh_key_credential_id is not UNSET:
            field_dict["ssh_key_credential_id"] = ssh_key_credential_id
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.controlplane_id, Unset):
            files.append(("controlplane_id", (None, str(self.controlplane_id), "text/plain")))
        ...
        if not isinstance(self.desired_count, Unset):
            files.append(("desired_count", (None, str(self.desired_count).encode(), "text/plain")))
        ...
        if not isinstance(self.ssh_key_credential_id, Unset):
            files.append(("ssh_key_credential_id", (None, str(self.ssh_key_credential_id), "text/plain")))

        if not isinstance(self.hardening_enabled, Unset):
            files.append(("hardening_enabled", (None, str(self.hardening_enabled).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _controlplane_id = d.pop("controlplane_id", UNSET)
        controlplane_id: UUID | Unset
        if isinstance(_controlplane_id, Unset):
            controlplane_id = UNSET
        else:
            controlplane_id = UUID(_controlplane_id)

        _provider_account_id = d.pop("provider_account_id", UNSET)
        provider_account_id: UUID | Unset
        if isinstance(_provider_account_id, Unset):
            provider_account_id = UNSET
        else:
            provider_account_id = UUID(_provider_account_id)
        ...
        _ssh_key_credential_id = d.pop("ssh_key_credential_id", UNSET)
        ssh_key_credential_id: UUID | Unset
        if isinstance(_ssh_key_credential_id, Unset):
            ssh_key_credential_id = UNSET
        else:
            ssh_key_credential_id = UUID(_ssh_key_credential_id)

        hardening_enabled = d.pop("hardening_enabled", UNSET)

        patched_k8s_worker_pool_request = cls(
            name=name,
        ...
        patched_k8s_worker_pool_request.additional_properties = d
        return patched_k8s_worker_pool_request
