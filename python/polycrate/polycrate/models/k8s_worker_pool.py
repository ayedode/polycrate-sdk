...
T = TypeVar("T", bound="K8SWorkerPool")
...
class K8SWorkerPool:
    ...
    Usage:
        ...
        Attributes:
            ...
            deleted_by_user (K8SWorkerPoolDeletedByUserType0 | None):
            ...
            organization (K8SWorkerPoolOrganizationType0 | None):
            workspace (K8SWorkerPoolWorkspaceType0 | None):
            created (K8SWorkerPoolCreated):
            ...
            last_action_run (K8SWorkerPoolLastActionRunType0 | None):
            controlplane (K8SControlplaneSimple):
            provider_account (K8SWorkerPoolProviderAccountType0 | None):
            ...
            ssh_key_credential (K8SWorkerPoolSshKeyCredentialType0 | None):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, K8SWorkerPoolDeletedByUserType0):
        ...
        if isinstance(self.organization, K8SWorkerPoolOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, K8SWorkerPoolWorkspaceType0):
        ...
        if isinstance(self.last_action_run, K8SWorkerPoolLastActionRunType0):
        ...
        if isinstance(self.provider_account, K8SWorkerPoolProviderAccountType0):
        ...
        ssh_key_credential: dict[str, Any] | None
        if isinstance(self.ssh_key_credential, K8SWorkerPoolSshKeyCredentialType0):
            ssh_key_credential = self.ssh_key_credential.to_dict()
        else:
            ssh_key_credential = self.ssh_key_credential
        ...
        field_dict.update(
            {
                ...
                "product": product,
                "image": image,
                "ssh_key_credential": ssh_key_credential,
        ...
        if desired_count is not UNSET:
            field_dict["desired_count"] = desired_count
        if location is not UNSET:
            field_dict["location"] = location
        if hardening_enabled is not UNSET:
            field_dict["hardening_enabled"] = hardening_enabled
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> K8SWorkerPoolDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = K8SWorkerPoolDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SWorkerPoolDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> K8SWorkerPoolOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = K8SWorkerPoolOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SWorkerPoolOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> K8SWorkerPoolWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = K8SWorkerPoolWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SWorkerPoolWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = K8SWorkerPoolCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> K8SWorkerPoolLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = K8SWorkerPoolLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SWorkerPoolLastActionRunType0 | None, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        controlplane = K8SControlplaneSimple.from_dict(d.pop("controlplane"))

        def _parse_provider_account(data: object) -> K8SWorkerPoolProviderAccountType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                provider_account_type_0 = K8SWorkerPoolProviderAccountType0.from_dict(data)

                return provider_account_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SWorkerPoolProviderAccountType0 | None, data)
        ...
        def _parse_ssh_key_credential(data: object) -> K8SWorkerPoolSshKeyCredentialType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                ssh_key_credential_type_0 = K8SWorkerPoolSshKeyCredentialType0.from_dict(data)

                return ssh_key_credential_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SWorkerPoolSshKeyCredentialType0 | None, data)

        ssh_key_credential = _parse_ssh_key_credential(d.pop("ssh_key_credential"))
        ...
        desired_count = d.pop("desired_count", UNSET)

        location = d.pop("location", UNSET)

        hardening_enabled = d.pop("hardening_enabled", UNSET)
        ...
        k8s_worker_pool.additional_properties = d
