...
T = TypeVar("T", bound="IncidentRequest")
...
class IncidentRequest:
    ...
    downtimes is exposed read-only via DowntimeSimpleSerializer; write via downtime_ids.
        ...
        Attributes:
            occurred_at (datetime.datetime): When the incident actually occurred
            discovered_at (datetime.datetime): When the incident was discovered/reported
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        discovered_at = datetime.datetime.fromisoformat(d.pop("discovered_at"))
        ...
        incident_request.additional_properties = d
