...
T = TypeVar("T", bound="PaginatedOrganizationListList")


@_attrs_define
class PaginatedOrganizationListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[OrganizationList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.organization_list import OrganizationList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = OrganizationList.from_dict(results_item_data)
        ...
        paginated_organization_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_organization_list_list.additional_properties = d
        return paginated_organization_list_list
