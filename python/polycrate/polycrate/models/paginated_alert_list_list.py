...
T = TypeVar("T", bound="PaginatedAlertListList")


@_attrs_define
class PaginatedAlertListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[AlertList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.alert_list import AlertList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = AlertList.from_dict(results_item_data)
        ...
        paginated_alert_list_list.additional_properties = d
        return paginated_alert_list_list
