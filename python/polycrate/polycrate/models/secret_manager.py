...
from ..models.secret_manager_kind_enum import SecretManagerKindEnum, check_secret_manager_kind_enum
from ..models.vault_mode_enum import VaultModeEnum, check_vault_mode_enum
...
@_attrs_define
class SecretManager:
    """Full serializer for SecretManager detail views.
    ...
    Attributes:
        ...
        deleted_by_user (None | SecretManagerDeletedByUserType0):
        ...
        organization (None | SecretManagerOrganizationType0):
        workspace (None | SecretManagerWorkspaceType0):
        created (SecretManagerCreated):
        ...
        last_action_run (None | SecretManagerLastActionRunType0):
        k8s_cluster (UUID): Kubernetes cluster where this secret manager runs
        ...
        kind (SecretManagerKindEnum | Unset): * `vault` - Vault
        ...
        hostname (None | str | Unset): Hostname/URL where this secret manager is accessible
        vault_mode (BlankEnum | None | Unset | VaultModeEnum): Vault deployment mode

            * `standalone` - Standalone
            * `ha` - High Availability
            * `dev` - Development
        is_sealed (bool | Unset): Whether Vault is currently sealed
        is_initialized (bool | Unset): Whether Vault has been initialized
        secrets_engines_count (int | Unset): Number of secrets engines
        auth_methods_count (int | Unset): Number of auth methods
        policies_count (int | Unset): Number of policies
        vault_version (None | str | Unset): Vault version
        k8s_app (None | Unset | UUID): K8s application that implements this secret manager
        credential (None | Unset | UUID): Credential for admin/root access
        metadata (Any | Unset): Provider-specific metadata
    """
    ...
    kind: SecretManagerKindEnum | Unset = UNSET
    ...
    vault_mode: BlankEnum | None | Unset | VaultModeEnum = UNSET
    is_sealed: bool | Unset = UNSET
    is_initialized: bool | Unset = UNSET
    secrets_engines_count: int | Unset = UNSET
    auth_methods_count: int | Unset = UNSET
    policies_count: int | Unset = UNSET
    vault_version: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, SecretManagerDeletedByUserType0):
        ...
        if isinstance(self.organization, SecretManagerOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, SecretManagerWorkspaceType0):
        ...
        if isinstance(self.last_action_run, SecretManagerLastActionRunType0):
        ...
        vault_mode: None | str | Unset
        if isinstance(self.vault_mode, Unset):
            vault_mode = UNSET
        elif isinstance(self.vault_mode, str):
        ...
        secrets_engines_count = self.secrets_engines_count

        auth_methods_count = self.auth_methods_count

        policies_count = self.policies_count

        vault_version: None | str | Unset
        if isinstance(self.vault_version, Unset):
            vault_version = UNSET
        else:
        ...
        if vault_mode is not UNSET:
            field_dict["vault_mode"] = vault_mode
        if is_sealed is not UNSET:
            field_dict["is_sealed"] = is_sealed
        if is_initialized is not UNSET:
            field_dict["is_initialized"] = is_initialized
        if secrets_engines_count is not UNSET:
            field_dict["secrets_engines_count"] = secrets_engines_count
        if auth_methods_count is not UNSET:
            field_dict["auth_methods_count"] = auth_methods_count
        if policies_count is not UNSET:
            field_dict["policies_count"] = policies_count
        if vault_version is not UNSET:
            field_dict["vault_version"] = vault_version
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> None | SecretManagerDeletedByUserType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = SecretManagerDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SecretManagerDeletedByUserType0, data)
        ...
        def _parse_organization(data: object) -> None | SecretManagerOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = SecretManagerOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SecretManagerOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> None | SecretManagerWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = SecretManagerWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SecretManagerWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = SecretManagerCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> None | SecretManagerLastActionRunType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = SecretManagerLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SecretManagerLastActionRunType0, data)
        ...
        kind: SecretManagerKindEnum | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_secret_manager_kind_enum(_kind)
        ...
        def _parse_vault_mode(data: object) -> BlankEnum | None | Unset | VaultModeEnum:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                vault_mode_type_0 = check_vault_mode_enum(data)

                return vault_mode_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            try:
                if not isinstance(data, str):
                    raise TypeError()
                vault_mode_type_1 = check_blank_enum(data)

                return vault_mode_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BlankEnum | None | Unset | VaultModeEnum, data)

        vault_mode = _parse_vault_mode(d.pop("vault_mode", UNSET))

        is_sealed = d.pop("is_sealed", UNSET)

        is_initialized = d.pop("is_initialized", UNSET)

        secrets_engines_count = d.pop("secrets_engines_count", UNSET)

        auth_methods_count = d.pop("auth_methods_count", UNSET)

        policies_count = d.pop("policies_count", UNSET)

        def _parse_vault_version(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        vault_version = _parse_vault_version(d.pop("vault_version", UNSET))
        ...
        secret_manager = cls(
            ...
            secrets_engines_count=secrets_engines_count,
            auth_methods_count=auth_methods_count,
        ...
        secret_manager.additional_properties = d
