...
T = TypeVar("T", bound="PatchedConditionCatalogDetailRequest")


@_attrs_define
class PatchedConditionCatalogDetailRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.is_system, Unset):
            files.append(("is_system", (None, str(self.is_system).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_condition_catalog_detail_request = cls(
            name=name,
        ...
        patched_condition_catalog_detail_request.additional_properties = d
        return patched_condition_catalog_detail_request
