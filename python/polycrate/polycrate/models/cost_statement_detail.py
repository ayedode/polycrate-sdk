...
T = TypeVar("T", bound="CostStatementDetail")


@_attrs_define
class CostStatementDetail:
    ...
    Usage:
        ...
        Attributes:
            ...
            deleted_by_user (CostStatementDetailDeletedByUserType0 | None):
            ...
            organization (CostStatementDetailOrganizationType0 | None):
            workspace (CostStatementDetailWorkspaceType0 | None):
            created (CostStatementDetailCreated):
            ...
            last_action_run (CostStatementDetailLastActionRunType0 | None):
            period_start (datetime.datetime):
            period_end (datetime.datetime):
            line_items (list[CostStatementLineItem]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, CostStatementDetailDeletedByUserType0):
        ...
        if isinstance(self.organization, CostStatementDetailOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, CostStatementDetailWorkspaceType0):
        ...
        if isinstance(self.last_action_run, CostStatementDetailLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> CostStatementDetailDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = CostStatementDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CostStatementDetailDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> CostStatementDetailOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = CostStatementDetailOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CostStatementDetailOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> CostStatementDetailWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = CostStatementDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CostStatementDetailWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = CostStatementDetailCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> CostStatementDetailLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = CostStatementDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CostStatementDetailLastActionRunType0 | None, data)
        ...
        for line_items_item_data in _line_items:
            line_items_item = CostStatementLineItem.from_dict(line_items_item_data)
        ...
        cost_statement_detail.additional_properties = d
        return cost_statement_detail
