...
T = TypeVar("T", bound="PricingCalculatorStateDetail")


@_attrs_define
class PricingCalculatorStateDetail:
    ...
    Usage:
        ...
        Attributes:
            ...
            deleted_by_user (None | PricingCalculatorStateDetailDeletedByUserType0):
            ...
            organization (None | PricingCalculatorStateDetailOrganizationType0):
            workspace (None | PricingCalculatorStateDetailWorkspaceType0):
            created (PricingCalculatorStateDetailCreated):
            ...
            last_action_run (None | PricingCalculatorStateDetailLastActionRunType0):
            quote (PricingQuoteSimple):
            ...
            configuration_json (Any | Unset):
            total_price (None | str | Unset):
            last_access (datetime.datetime | None | Unset):
            access_count (int | Unset):
            booking_id (str | Unset):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, PricingCalculatorStateDetailDeletedByUserType0):
        ...
        if isinstance(self.organization, PricingCalculatorStateDetailOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, PricingCalculatorStateDetailWorkspaceType0):
        ...
        if isinstance(self.last_action_run, PricingCalculatorStateDetailLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> None | PricingCalculatorStateDetailDeletedByUserType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = PricingCalculatorStateDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingCalculatorStateDetailDeletedByUserType0, data)
        ...
        def _parse_organization(data: object) -> None | PricingCalculatorStateDetailOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = PricingCalculatorStateDetailOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingCalculatorStateDetailOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> None | PricingCalculatorStateDetailWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = PricingCalculatorStateDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingCalculatorStateDetailWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = PricingCalculatorStateDetailCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> None | PricingCalculatorStateDetailLastActionRunType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = PricingCalculatorStateDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingCalculatorStateDetailLastActionRunType0, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        quote = PricingQuoteSimple.from_dict(d.pop("quote"))
        ...
        configuration_json = d.pop("configuration_json", UNSET)
        ...
        last_access = _parse_last_access(d.pop("last_access", UNSET))

        access_count = d.pop("access_count", UNSET)

        booking_id = d.pop("booking_id", UNSET)

        pricing_calculator_state_detail = cls(
            id=id,
            created_at=created_at,
            updated_at=updated_at,
            deleted_at=deleted_at,
        ...
        pricing_calculator_state_detail.additional_properties = d
        return pricing_calculator_state_detail
