...
T = TypeVar("T", bound="BlockRolloutConfigRequest")


@_attrs_define
class BlockRolloutConfigRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        block_rollout_config_request = cls(
            name=name,
        ...
        block_rollout_config_request.additional_properties = d
        return block_rollout_config_request
