...
T = TypeVar("T", bound="PaginatedBlockListList")


@_attrs_define
class PaginatedBlockListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[BlockList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.block_list import BlockList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = BlockList.from_dict(results_item_data)
        ...
        paginated_block_list_list.additional_properties = d
        return paginated_block_list_list
