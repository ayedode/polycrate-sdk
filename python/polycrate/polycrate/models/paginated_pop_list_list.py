...
if TYPE_CHECKING:
    from ..models.pop_list import PopList


T = TypeVar("T", bound="PaginatedPopListList")


@_attrs_define
class PaginatedPopListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[PopList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.pop_list import PopList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = PopList.from_dict(results_item_data)
        ...
        paginated_pop_list_list.additional_properties = d
        return paginated_pop_list_list
