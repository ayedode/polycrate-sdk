...
@_attrs_define
class BackupList:
    """List serializer for Backup - V2 Dynamic Tables.
    ...
    Attributes:
        ...
        active_condition_instances (list[BackupListActiveConditionInstancesItem]):
        organization (BackupListOrganizationType0 | None):
        organization_priority (bool): True when the object's organization has priority=True.
        workspace (BackupListWorkspaceType0 | None):
        created (BackupListCreated):
        ...
        status (str):
        k8s_cluster (BackupListK8SCluster):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, BackupListOrganizationType0):
        ...
        if isinstance(self.workspace, BackupListWorkspaceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = BackupListActiveConditionInstancesItem.from_dict(
                active_condition_instances_item_data
            )

            active_condition_instances.append(active_condition_instances_item)

        def _parse_organization(data: object) -> BackupListOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = BackupListOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BackupListOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        organization_priority = d.pop("organization_priority")

        def _parse_workspace(data: object) -> BackupListWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = BackupListWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BackupListWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = BackupListCreated.from_dict(d.pop("created"))
        ...
        k8s_cluster = BackupListK8SCluster.from_dict(d.pop("k8s_cluster"))
        ...
        backup_list.additional_properties = d
        return backup_list
