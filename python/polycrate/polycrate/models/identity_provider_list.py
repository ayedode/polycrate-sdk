...
T = TypeVar("T", bound="IdentityProviderList")


@_attrs_define
class IdentityProviderList:
    """List serializer for IdentityProvider - V2 Dynamic Tables.
    ...
    Attributes:
        ...
        active_condition_instances (list[IdentityProviderListActiveConditionInstancesItem]):
        organization (IdentityProviderListOrganizationType0 | None):
        organization_priority (bool): True when the object's organization has priority=True.
        workspace (IdentityProviderListWorkspaceType0 | None):
        created (IdentityProviderListCreated):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, IdentityProviderListOrganizationType0):
        ...
        if isinstance(self.workspace, IdentityProviderListWorkspaceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = IdentityProviderListActiveConditionInstancesItem.from_dict(
                active_condition_instances_item_data
            )

            active_condition_instances.append(active_condition_instances_item)

        def _parse_organization(data: object) -> IdentityProviderListOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = IdentityProviderListOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(IdentityProviderListOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        organization_priority = d.pop("organization_priority")

        def _parse_workspace(data: object) -> IdentityProviderListWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = IdentityProviderListWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(IdentityProviderListWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = IdentityProviderListCreated.from_dict(d.pop("created"))
        ...
        identity_provider_list.additional_properties = d
