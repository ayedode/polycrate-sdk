...
T = TypeVar("T", bound="ArtifactRepositoryList")


@_attrs_define
class ArtifactRepositoryList:
    """List serializer for ArtifactRepository - V2 Dynamic Tables.

    ArtifactRepository ist ein systemweites Objekt ohne organization/workspace.
        ...
        Attributes:
            ...
            active_condition_instances (list[ArtifactRepositoryListActiveConditionInstancesItem]):
            organization (None | str):
            organization_priority (bool): True when the object's organization has priority=True.
            workspace (None | str):
            created (ArtifactRepositoryListCreated):
            ...
            repository_url (str):
            mirror (bool):
            package_count (int): Count actual ArtifactPackages linked to this repository.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = ArtifactRepositoryListActiveConditionInstancesItem.from_dict(
        ...
        created = ArtifactRepositoryListCreated.from_dict(d.pop("created"))
        ...
        artifact_repository_list.additional_properties = d
        return artifact_repository_list
