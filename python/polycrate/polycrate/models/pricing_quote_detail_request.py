...
T = TypeVar("T", bound="PricingQuoteDetailRequest")


@_attrs_define
class PricingQuoteDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pricing_quote_detail_request = cls(
            name=name,
        ...
        pricing_quote_detail_request.additional_properties = d
        return pricing_quote_detail_request
