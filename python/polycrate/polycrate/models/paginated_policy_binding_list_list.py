...
T = TypeVar("T", bound="PaginatedPolicyBindingListList")


@_attrs_define
class PaginatedPolicyBindingListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[PolicyBindingList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = PolicyBindingList.from_dict(results_item_data)
        ...
        paginated_policy_binding_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_policy_binding_list_list.additional_properties = d
        return paginated_policy_binding_list_list
