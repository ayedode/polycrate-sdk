...
T = TypeVar("T", bound="PatchedArtifactPackageRequest")


@_attrs_define
class PatchedArtifactPackageRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.raw_data, Unset):
            files.append(("raw_data", (None, str(self.raw_data).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_artifact_package_request = cls(
            name=name,
        ...
        patched_artifact_package_request.additional_properties = d
        return patched_artifact_package_request
