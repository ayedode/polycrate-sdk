...
T = TypeVar("T", bound="PaginatedDomainRegistrarListList")


@_attrs_define
class PaginatedDomainRegistrarListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[DomainRegistrarList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DomainRegistrarList.from_dict(results_item_data)
        ...
        paginated_domain_registrar_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_domain_registrar_list_list.additional_properties = d
        return paginated_domain_registrar_list_list
