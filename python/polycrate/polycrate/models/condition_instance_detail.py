...
if TYPE_CHECKING:
    from ..models.condition_instance_detail_created import ConditionInstanceDetailCreated
    from ..models.condition_instance_detail_deleted_by_user_type_0 import ConditionInstanceDetailDeletedByUserType0
    from ..models.condition_instance_detail_last_action_run_type_0 import ConditionInstanceDetailLastActionRunType0
    from ..models.condition_instance_detail_organization_type_0 import ConditionInstanceDetailOrganizationType0
    from ..models.condition_instance_detail_workspace_type_0 import ConditionInstanceDetailWorkspaceType0


T = TypeVar("T", bound="ConditionInstanceDetail")


@_attrs_define
class ConditionInstanceDetail:
    """Detail serializer for ConditionInstance.
    ...
    Attributes:
        ...
        deleted_by_user (ConditionInstanceDetailDeletedByUserType0 | None):
        ...
        organization (ConditionInstanceDetailOrganizationType0 | None):
        workspace (ConditionInstanceDetailWorkspaceType0 | None):
        created (ConditionInstanceDetailCreated):
        ...
        last_action_run (ConditionInstanceDetailLastActionRunType0 | None):
        condition (UUID):
        condition_name (str):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.condition_instance_detail_deleted_by_user_type_0 import (
            ConditionInstanceDetailDeletedByUserType0,  # noqa: PLC0415
        )
        from ..models.condition_instance_detail_last_action_run_type_0 import (
            ConditionInstanceDetailLastActionRunType0,  # noqa: PLC0415
        )
        from ..models.condition_instance_detail_organization_type_0 import (
            ConditionInstanceDetailOrganizationType0,  # noqa: PLC0415
        )
        from ..models.condition_instance_detail_workspace_type_0 import (
            ConditionInstanceDetailWorkspaceType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.deleted_by_user, ConditionInstanceDetailDeletedByUserType0):
        ...
        if isinstance(self.organization, ConditionInstanceDetailOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, ConditionInstanceDetailWorkspaceType0):
        ...
        if isinstance(self.last_action_run, ConditionInstanceDetailLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.condition_instance_detail_created import ConditionInstanceDetailCreated  # noqa: PLC0415
        from ..models.condition_instance_detail_deleted_by_user_type_0 import (
            ConditionInstanceDetailDeletedByUserType0,  # noqa: PLC0415
        )
        from ..models.condition_instance_detail_last_action_run_type_0 import (
        ...
        def _parse_deleted_by_user(data: object) -> ConditionInstanceDetailDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = ConditionInstanceDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ConditionInstanceDetailDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> ConditionInstanceDetailOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = ConditionInstanceDetailOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ConditionInstanceDetailOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> ConditionInstanceDetailWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = ConditionInstanceDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ConditionInstanceDetailWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = ConditionInstanceDetailCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> ConditionInstanceDetailLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = ConditionInstanceDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ConditionInstanceDetailLastActionRunType0 | None, data)
        ...
        condition_instance_detail.additional_properties = d
        return condition_instance_detail
