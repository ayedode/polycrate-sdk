...
T = TypeVar("T", bound="PaginatedMcpAuditEventList")


@_attrs_define
class PaginatedMcpAuditEventList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[McpAuditEvent]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.mcp_audit_event import McpAuditEvent  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = McpAuditEvent.from_dict(results_item_data)
        ...
        paginated_mcp_audit_event_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_mcp_audit_event_list.additional_properties = d
        return paginated_mcp_audit_event_list
