...
if TYPE_CHECKING:
    from ..models.k8s_cluster_list import K8SClusterList


T = TypeVar("T", bound="PaginatedK8SClusterListList")


@_attrs_define
class PaginatedK8SClusterListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[K8SClusterList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.k8s_cluster_list import K8SClusterList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = K8SClusterList.from_dict(results_item_data)
        ...
        paginated_k8s_cluster_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_k8s_cluster_list_list.additional_properties = d
        return paginated_k8s_cluster_list_list
