...
T = TypeVar("T", bound="DomainRegistrarDetailRequest")


@_attrs_define
class DomainRegistrarDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domain_registrar_detail_request = cls(
            name=name,
        ...
        domain_registrar_detail_request.additional_properties = d
        return domain_registrar_detail_request
