...
T = TypeVar("T", bound="AssistantSessionRequest")
...
class AssistantSessionRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assistant_session_request.additional_properties = d
        return assistant_session_request
