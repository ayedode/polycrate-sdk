...
T = TypeVar("T", bound="RegionS3Config")


@_attrs_define
class RegionS3Config:
    """
    Attributes:
        ...
        cluster_config (RegionS3ConfigClusterConfig | Unset):
    ...
    cluster_config: RegionS3ConfigClusterConfig | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cluster_config, Unset):
            ...
            cluster_config = RegionS3ConfigClusterConfig.from_dict(_cluster_config)
        ...
        region_s3_config.additional_properties = d
        return region_s3_config
