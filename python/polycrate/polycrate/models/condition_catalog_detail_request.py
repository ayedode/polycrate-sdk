...
T = TypeVar("T", bound="ConditionCatalogDetailRequest")


@_attrs_define
class ConditionCatalogDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        condition_catalog_detail_request = cls(
            name=name,
        ...
        condition_catalog_detail_request.additional_properties = d
        return condition_catalog_detail_request
