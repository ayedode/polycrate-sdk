...
T = TypeVar("T", bound="PaginatedIncidentListList")


@_attrs_define
class PaginatedIncidentListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[IncidentList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.incident_list import IncidentList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = IncidentList.from_dict(results_item_data)
        ...
        paginated_incident_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_incident_list_list.additional_properties = d
        return paginated_incident_list_list
