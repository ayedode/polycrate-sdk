...
if TYPE_CHECKING:
    from ..models.certificate_list import CertificateList


T = TypeVar("T", bound="PaginatedCertificateListList")


@_attrs_define
class PaginatedCertificateListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[CertificateList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.certificate_list import CertificateList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = CertificateList.from_dict(results_item_data)
        ...
        paginated_certificate_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_certificate_list_list.additional_properties = d
        return paginated_certificate_list_list
