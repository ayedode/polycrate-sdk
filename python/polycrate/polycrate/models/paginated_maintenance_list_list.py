...
if TYPE_CHECKING:
    from ..models.maintenance_list import MaintenanceList


T = TypeVar("T", bound="PaginatedMaintenanceListList")


@_attrs_define
class PaginatedMaintenanceListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MaintenanceList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.maintenance_list import MaintenanceList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = MaintenanceList.from_dict(results_item_data)
        ...
        paginated_maintenance_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_maintenance_list_list.additional_properties = d
        return paginated_maintenance_list_list
