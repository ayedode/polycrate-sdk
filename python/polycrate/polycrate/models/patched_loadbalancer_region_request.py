...
T = TypeVar("T", bound="PatchedLoadbalancerRegionRequest")


@_attrs_define
class PatchedLoadbalancerRegionRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.region_name, Unset):
            files.append(("region_name", (None, str(self.region_name).encode(), "text/plain")))
        ...
        if not isinstance(self.region_config, Unset):
            files.append(("region_config", (None, str(self.region_config).encode(), "text/plain")))

        if not isinstance(self.external_traffic_policy, Unset):
            files.append(("external_traffic_policy", (None, str(self.external_traffic_policy).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_loadbalancer_region_request = cls(
            name=name,
        ...
        patched_loadbalancer_region_request.additional_properties = d
        return patched_loadbalancer_region_request
