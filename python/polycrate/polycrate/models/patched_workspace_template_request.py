...
T = TypeVar("T", bound="PatchedWorkspaceTemplateRequest")


@_attrs_define
class PatchedWorkspaceTemplateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_workspace_template_request = cls(
            name=name,
        ...
        patched_workspace_template_request.additional_properties = d
        return patched_workspace_template_request
