...
T = TypeVar("T", bound="PatchedConversationUpdateRequest")


@_attrs_define
class PatchedConversationUpdateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_conversation_update_request = cls(
            status=status,
        ...
        patched_conversation_update_request.additional_properties = d
        return patched_conversation_update_request
