...
T = TypeVar("T", bound="PopList")


@_attrs_define
class PopList:
    """Lightweight serializer for Pop list views.
    ...
    Pop is admin-only and not scoped to org/workspace.
        ...
        Attributes:
            ...
            active_condition_instances (list[PopListActiveConditionInstancesItem]):
            organization (None | PopListOrganizationType0):
            organization_priority (bool): True when the object's organization has priority=True.
            workspace (None | PopListWorkspaceType0):
            created (PopListCreated):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, PopListOrganizationType0):
        ...
        if isinstance(self.workspace, PopListWorkspaceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = PopListActiveConditionInstancesItem.from_dict(
                active_condition_instances_item_data
            )

            active_condition_instances.append(active_condition_instances_item)

        def _parse_organization(data: object) -> None | PopListOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = PopListOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PopListOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        organization_priority = d.pop("organization_priority")

        def _parse_workspace(data: object) -> None | PopListWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = PopListWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PopListWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = PopListCreated.from_dict(d.pop("created"))
        ...
        pop_list.additional_properties = d
        return pop_list
