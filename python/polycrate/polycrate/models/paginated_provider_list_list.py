...
T = TypeVar("T", bound="PaginatedProviderListList")


@_attrs_define
class PaginatedProviderListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ProviderList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.provider_list import ProviderList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = ProviderList.from_dict(results_item_data)
        ...
        paginated_provider_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_provider_list_list.additional_properties = d
        return paginated_provider_list_list
