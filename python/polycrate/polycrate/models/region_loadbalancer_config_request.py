...
if TYPE_CHECKING:
    from ..models.region_loadbalancer_config_request_region_config import RegionLoadbalancerConfigRequestRegionConfig


T = TypeVar("T", bound="RegionLoadbalancerConfigRequest")


@_attrs_define
class RegionLoadbalancerConfigRequest:
    """
    Attributes:
        ...
        region_config (RegionLoadbalancerConfigRequestRegionConfig | Unset):
    ...
    region_config: RegionLoadbalancerConfigRequestRegionConfig | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_region_config, Unset):
            ...
            region_config = RegionLoadbalancerConfigRequestRegionConfig.from_dict(_region_config)

        active = d.pop("active", UNSET)

        region_loadbalancer_config_request = cls(
            kind=kind,
        ...
        region_loadbalancer_config_request.additional_properties = d
        return region_loadbalancer_config_request
