...
if TYPE_CHECKING:
    from ..models.apm_stack_list import APMStackList


T = TypeVar("T", bound="PaginatedAPMStackListList")


@_attrs_define
class PaginatedAPMStackListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[APMStackList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.apm_stack_list import APMStackList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = APMStackList.from_dict(results_item_data)
        ...
        paginated_apm_stack_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_apm_stack_list_list.additional_properties = d
        return paginated_apm_stack_list_list
