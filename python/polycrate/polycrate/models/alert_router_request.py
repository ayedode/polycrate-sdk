...
T = TypeVar("T", bound="AlertRouterRequest")


@_attrs_define
class AlertRouterRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alert_router_request.additional_properties = d
        return alert_router_request
