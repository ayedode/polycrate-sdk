...
T = TypeVar("T", bound="AlertCategory")
...
class AlertCategory:
    ...
    Usage:
        ...
        Attributes:
            ...
            deleted_by_user (AlertCategoryDeletedByUserType0 | None):
            ...
            organization (AlertCategoryOrganizationType0 | None):
            workspace (AlertCategoryWorkspaceType0 | None):
            created (AlertCategoryCreated):
            ...
            last_action_run (AlertCategoryLastActionRunType0 | None):
            ...
            active (bool | Unset): Inactive categories are skipped when resolving new mappings.
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, AlertCategoryDeletedByUserType0):
        ...
        if isinstance(self.organization, AlertCategoryOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, AlertCategoryWorkspaceType0):
        ...
        if isinstance(self.last_action_run, AlertCategoryLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> AlertCategoryDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = AlertCategoryDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AlertCategoryDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> AlertCategoryOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = AlertCategoryOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AlertCategoryOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> AlertCategoryWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = AlertCategoryWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AlertCategoryWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = AlertCategoryCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> AlertCategoryLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = AlertCategoryLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AlertCategoryLastActionRunType0 | None, data)
        ...
        alert_category.additional_properties = d
