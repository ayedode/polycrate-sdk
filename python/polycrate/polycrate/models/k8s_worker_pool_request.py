...
T = TypeVar("T", bound="K8SWorkerPoolRequest")


@_attrs_define
class K8SWorkerPoolRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        controlplane_id = UUID(d.pop("controlplane_id"))

        provider_account_id = UUID(d.pop("provider_account_id"))

        product_id = UUID(d.pop("product_id"))

        image = d.pop("image")

        ssh_key_credential_id = UUID(d.pop("ssh_key_credential_id"))
        ...
        k8s_worker_pool_request.additional_properties = d
        return k8s_worker_pool_request
