...
T = TypeVar("T", bound="PaginatedArtifactListList")


@_attrs_define
class PaginatedArtifactListList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.artifact_list import ArtifactList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = ArtifactList.from_dict(results_item_data)
        ...
        paginated_artifact_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_artifact_list_list.additional_properties = d
        return paginated_artifact_list_list
