...
T = TypeVar("T", bound="EndpointDNSSpecRequest")


@_attrs_define
class EndpointDNSSpecRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        endpoint_dns_spec_request.additional_properties = d
        return endpoint_dns_spec_request
