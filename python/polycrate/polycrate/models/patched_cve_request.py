...
T = TypeVar("T", bound="PatchedCVERequest")


@_attrs_define
class PatchedCVERequest:
    ...
    Attributes:
        ...
        cve_id (str | Unset): Canonical CVE identifier, e.g. CVE-2024-12345
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.cve_id, Unset):
            files.append(("cve_id", (None, str(self.cve_id).encode(), "text/plain")))
        ...
        if not isinstance(self.modified_at, Unset):
            if isinstance(self.modified_at, datetime.datetime):
                files.append(("modified_at", (None, self.modified_at.isoformat().encode(), "text/plain")))
            else:
                files.append(("modified_at", (None, str(self.modified_at).encode(), "text/plain")))

        if not isinstance(self.cvss_score, Unset):
            if isinstance(self.cvss_score, str):
                files.append(("cvss_score", (None, str(self.cvss_score).encode(), "text/plain")))
            else:
                files.append(("cvss_score", (None, str(self.cvss_score).encode(), "text/plain")))

        if not isinstance(self.cvss_vector, Unset):
            if isinstance(self.cvss_vector, str):
                files.append(("cvss_vector", (None, str(self.cvss_vector).encode(), "text/plain")))
            else:
                files.append(("cvss_vector", (None, str(self.cvss_vector).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_cve_request.additional_properties = d
        return patched_cve_request
