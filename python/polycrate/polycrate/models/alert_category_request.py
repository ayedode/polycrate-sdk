...
T = TypeVar("T", bound="AlertCategoryRequest")


@_attrs_define
class AlertCategoryRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alert_category_request.additional_properties = d
        return alert_category_request
