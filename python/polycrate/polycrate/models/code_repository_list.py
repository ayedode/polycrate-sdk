...
T = TypeVar("T", bound="CodeRepositoryList")


@_attrs_define
class CodeRepositoryList:
    """List serializer for CodeRepository - V2 Dynamic Tables.
    ...
    Attributes:
        ...
        active_condition_instances (list[CodeRepositoryListActiveConditionInstancesItem]):
        organization (CodeRepositoryListOrganizationType0 | None):
        organization_priority (bool): True when the object's organization has priority=True.
        workspace (CodeRepositoryListWorkspaceType0 | None):
        created (CodeRepositoryListCreated):
        ...
        projects_count (int):
        users_count (int):
        k8s_cluster (CodeRepositoryListK8SCluster):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, CodeRepositoryListOrganizationType0):
        ...
        if isinstance(self.workspace, CodeRepositoryListWorkspaceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = CodeRepositoryListActiveConditionInstancesItem.from_dict(
                active_condition_instances_item_data
            )

            active_condition_instances.append(active_condition_instances_item)

        def _parse_organization(data: object) -> CodeRepositoryListOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = CodeRepositoryListOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CodeRepositoryListOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        organization_priority = d.pop("organization_priority")

        def _parse_workspace(data: object) -> CodeRepositoryListWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = CodeRepositoryListWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CodeRepositoryListWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = CodeRepositoryListCreated.from_dict(d.pop("created"))
        ...
        k8s_cluster = CodeRepositoryListK8SCluster.from_dict(d.pop("k8s_cluster"))

        code_repository_list = cls(
            id=id,
            name=name,
            state=state,
            labels=labels,
        ...
        code_repository_list.additional_properties = d
        return code_repository_list
