...
if TYPE_CHECKING:
    ...
    from ..models.pricing_calculator_state_list_organization_type_0 import PricingCalculatorStateListOrganizationType0
    from ..models.pricing_calculator_state_list_workspace_type_0 import PricingCalculatorStateListWorkspaceType0


T = TypeVar("T", bound="PricingCalculatorStateList")


@_attrs_define
class PricingCalculatorStateList:
    ...
    Usage:
        ...
        Attributes:
            ...
            active_condition_instances (list[PricingCalculatorStateListActiveConditionInstancesItem]):
            organization (None | PricingCalculatorStateListOrganizationType0):
            organization_priority (bool): True when the object's organization has priority=True.
            workspace (None | PricingCalculatorStateListWorkspaceType0):
            created (PricingCalculatorStateListCreated):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, PricingCalculatorStateListOrganizationType0):
        ...
        if isinstance(self.workspace, PricingCalculatorStateListWorkspaceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = PricingCalculatorStateListActiveConditionInstancesItem.from_dict(
                active_condition_instances_item_data
            )

            active_condition_instances.append(active_condition_instances_item)

        def _parse_organization(data: object) -> None | PricingCalculatorStateListOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = PricingCalculatorStateListOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingCalculatorStateListOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        organization_priority = d.pop("organization_priority")

        def _parse_workspace(data: object) -> None | PricingCalculatorStateListWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = PricingCalculatorStateListWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingCalculatorStateListWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = PricingCalculatorStateListCreated.from_dict(d.pop("created"))
        ...
        pricing_calculator_state_list = cls(
            id=id,
            name=name,
            state=state,
            labels=labels,
        ...
        pricing_calculator_state_list.additional_properties = d
        return pricing_calculator_state_list
