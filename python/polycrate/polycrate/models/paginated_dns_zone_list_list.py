...
if TYPE_CHECKING:
    from ..models.dns_zone_list import DNSZoneList


T = TypeVar("T", bound="PaginatedDNSZoneListList")


@_attrs_define
class PaginatedDNSZoneListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[DNSZoneList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.dns_zone_list import DNSZoneList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = DNSZoneList.from_dict(results_item_data)
        ...
        paginated_dns_zone_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_dns_zone_list_list.additional_properties = d
        return paginated_dns_zone_list_list
