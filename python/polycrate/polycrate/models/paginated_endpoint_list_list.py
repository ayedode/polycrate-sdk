...
if TYPE_CHECKING:
    from ..models.endpoint_list import EndpointList


T = TypeVar("T", bound="PaginatedEndpointListList")


@_attrs_define
class PaginatedEndpointListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[EndpointList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.endpoint_list import EndpointList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = EndpointList.from_dict(results_item_data)
        ...
        paginated_endpoint_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_endpoint_list_list.additional_properties = d
        return paginated_endpoint_list_list
