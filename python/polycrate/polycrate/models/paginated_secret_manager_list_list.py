...
T = TypeVar("T", bound="PaginatedSecretManagerListList")


@_attrs_define
class PaginatedSecretManagerListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[SecretManagerList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = SecretManagerList.from_dict(results_item_data)
        ...
        paginated_secret_manager_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_secret_manager_list_list.additional_properties = d
        return paginated_secret_manager_list_list
