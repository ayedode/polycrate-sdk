...
class ProjectDetail:
    ...
    Attributes:
        ...
        deleted_by_user (None | ProjectDetailDeletedByUserType0):
        ...
        workspace (None | ProjectDetailWorkspaceType0):
        created (ProjectDetailCreated):
        ...
        last_action_run (None | ProjectDetailLastActionRunType0):
        kind_display (str):
        product (None | ProjectDetailProductType0):
        embedded_note (NoteSimple): Simple serializer for embedding Note in other serializers.
        computed_cost (None | str):
        current_price (None | str):
        budget_used_hours (None | str):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, ProjectDetailDeletedByUserType0):
        ...
        if isinstance(self.workspace, ProjectDetailWorkspaceType0):
        ...
        if isinstance(self.last_action_run, ProjectDetailLastActionRunType0):
        ...
        if isinstance(self.product, ProjectDetailProductType0):
        ...
        field_dict.update(
            {
                ...
                "budget_used_hours": budget_used_hours,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> None | ProjectDetailDeletedByUserType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = ProjectDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProjectDetailDeletedByUserType0, data)
        ...
        def _parse_workspace(data: object) -> None | ProjectDetailWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = ProjectDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProjectDetailWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = ProjectDetailCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> None | ProjectDetailLastActionRunType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = ProjectDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProjectDetailLastActionRunType0, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        kind_display = d.pop("kind_display")

        def _parse_product(data: object) -> None | ProjectDetailProductType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                product_type_0 = ProjectDetailProductType0.from_dict(data)

                return product_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProjectDetailProductType0, data)
        ...
        def _parse_current_price(data: object) -> None | str:
            if data is None:
                return data
            return cast(None | str, data)
        ...
        def _parse_budget_used_hours(data: object) -> None | str:
            if data is None:
                return data
            return cast(None | str, data)

        budget_used_hours = _parse_budget_used_hours(d.pop("budget_used_hours"))

        def _parse_efficiency(data: object) -> float | None:
            if data is None:
                return data
            return cast(float | None, data)
