...
if TYPE_CHECKING:
    from ..models.prefix_list import PrefixList


T = TypeVar("T", bound="PaginatedPrefixListList")


@_attrs_define
class PaginatedPrefixListList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.prefix_list import PrefixList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = PrefixList.from_dict(results_item_data)
        ...
        paginated_prefix_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_prefix_list_list.additional_properties = d
        return paginated_prefix_list_list
