...
T = TypeVar("T", bound="PaginatedK8SClusterAddonSubscriptionListList")


@_attrs_define
class PaginatedK8SClusterAddonSubscriptionListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[K8SClusterAddonSubscriptionList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = K8SClusterAddonSubscriptionList.from_dict(results_item_data)
        ...
        paginated_k8s_cluster_addon_subscription_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_k8s_cluster_addon_subscription_list_list.additional_properties = d
        return paginated_k8s_cluster_addon_subscription_list_list
