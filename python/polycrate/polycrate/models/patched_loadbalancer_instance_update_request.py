...
T = TypeVar("T", bound="PatchedLoadbalancerInstanceUpdateRequest")


@_attrs_define
class PatchedLoadbalancerInstanceUpdateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return patched_loadbalancer_instance_update_request
