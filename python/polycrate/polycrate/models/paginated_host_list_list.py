...
T = TypeVar("T", bound="PaginatedHostListList")


@_attrs_define
class PaginatedHostListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[HostList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.host_list import HostList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = HostList.from_dict(results_item_data)
        ...
        paginated_host_list_list.additional_properties = d
        return paginated_host_list_list
