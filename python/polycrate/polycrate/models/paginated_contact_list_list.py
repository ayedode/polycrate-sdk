...
T = TypeVar("T", bound="PaginatedContactListList")


@_attrs_define
class PaginatedContactListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ContactList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ContactList.from_dict(results_item_data)
        ...
        paginated_contact_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_contact_list_list.additional_properties = d
        return paginated_contact_list_list
