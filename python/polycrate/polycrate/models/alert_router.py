...
from ..models.alert_router_kind_enum import AlertRouterKindEnum, check_alert_router_kind_enum
...
if TYPE_CHECKING:
    from ..models.alert_router_created import AlertRouterCreated
    from ..models.alert_router_deleted_by_user_type_0 import AlertRouterDeletedByUserType0
    from ..models.alert_router_last_action_run_type_0 import AlertRouterLastActionRunType0
    from ..models.alert_router_organization_type_0 import AlertRouterOrganizationType0
    from ..models.alert_router_workspace_type_0 import AlertRouterWorkspaceType0


T = TypeVar("T", bound="AlertRouter")


@_attrs_define
class AlertRouter:
    """Detail serializer for AlertRouter.
    ...
    organization and workspace are provided as serialize_managed_object_simple dicts by the base class.
        ...
        Attributes:
            ...
            deleted_by_user (AlertRouterDeletedByUserType0 | None):
            ...
            organization (AlertRouterOrganizationType0 | None):
            workspace (AlertRouterWorkspaceType0 | None):
            created (AlertRouterCreated):
            ...
            last_action_run (AlertRouterLastActionRunType0 | None):
            kind_display (str):
            state_display (str):
            has_conditions (bool):
            has_degrading_conditions (bool):
            alert_count (int):
            urn (str): Generate Unique Resource Name (URN) for this object.

                Format: {object_type}:{organization}[:{workspace}]:{name}
            ...
            kind (AlertRouterKindEnum | Unset): * `generic` - Generic Alert Router
                * `dummy` - Dummy Alert Router
            ...
            label_workspace (str | Unset): Grafana label name used to identify the workspace
            label_organization (str | Unset): Grafana label name used to identify the organization (slug or name)
            label_cluster (str | Unset): Grafana label name used to identify the K8s cluster
            label_pod (str | Unset): Grafana label name used to identify the pod (optional)
            label_namespace (str | Unset): Grafana label name used to identify the namespace (optional)
            label_criticality (str | Unset): Grafana label name used to identify the criticality (high/medium/low)
    """
    ...
    kind: AlertRouterKindEnum | Unset = UNSET
    ...
    label_workspace: str | Unset = UNSET
    label_organization: str | Unset = UNSET
    label_cluster: str | Unset = UNSET
    label_pod: str | Unset = UNSET
    label_namespace: str | Unset = UNSET
    label_criticality: str | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.alert_router_deleted_by_user_type_0 import AlertRouterDeletedByUserType0  # noqa: PLC0415
        from ..models.alert_router_last_action_run_type_0 import AlertRouterLastActionRunType0  # noqa: PLC0415
        from ..models.alert_router_organization_type_0 import AlertRouterOrganizationType0  # noqa: PLC0415
        from ..models.alert_router_workspace_type_0 import AlertRouterWorkspaceType0  # noqa: PLC0415
        ...
        if isinstance(self.deleted_by_user, AlertRouterDeletedByUserType0):
        ...
        if isinstance(self.organization, AlertRouterOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, AlertRouterWorkspaceType0):
        ...
        if isinstance(self.last_action_run, AlertRouterLastActionRunType0):
        ...
        label_workspace = self.label_workspace

        label_organization = self.label_organization

        label_cluster = self.label_cluster

        label_pod = self.label_pod

        label_namespace = self.label_namespace

        label_criticality = self.label_criticality
        ...
        if label_workspace is not UNSET:
            field_dict["label_workspace"] = label_workspace
        if label_organization is not UNSET:
            field_dict["label_organization"] = label_organization
        if label_cluster is not UNSET:
            field_dict["label_cluster"] = label_cluster
        if label_pod is not UNSET:
            field_dict["label_pod"] = label_pod
        if label_namespace is not UNSET:
            field_dict["label_namespace"] = label_namespace
        if label_criticality is not UNSET:
            field_dict["label_criticality"] = label_criticality

        return field_dict

    @classmethod
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.alert_router_created import AlertRouterCreated  # noqa: PLC0415
        from ..models.alert_router_deleted_by_user_type_0 import AlertRouterDeletedByUserType0  # noqa: PLC0415
        from ..models.alert_router_last_action_run_type_0 import AlertRouterLastActionRunType0  # noqa: PLC0415
        from ..models.alert_router_organization_type_0 import AlertRouterOrganizationType0  # noqa: PLC0415
        from ..models.alert_router_workspace_type_0 import AlertRouterWorkspaceType0  # noqa: PLC0415
        ...
        def _parse_deleted_by_user(data: object) -> AlertRouterDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = AlertRouterDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AlertRouterDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> AlertRouterOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = AlertRouterOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AlertRouterOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> AlertRouterWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = AlertRouterWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AlertRouterWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = AlertRouterCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> AlertRouterLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = AlertRouterLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AlertRouterLastActionRunType0 | None, data)
        ...
        kind: AlertRouterKindEnum | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_alert_router_kind_enum(_kind)
        ...
        label_workspace = d.pop("label_workspace", UNSET)

        label_organization = d.pop("label_organization", UNSET)

        label_cluster = d.pop("label_cluster", UNSET)

        label_pod = d.pop("label_pod", UNSET)

        label_namespace = d.pop("label_namespace", UNSET)

        label_criticality = d.pop("label_criticality", UNSET)
        ...
        alert_router = cls(
            ...
            label_criticality=label_criticality,
        )

        alert_router.additional_properties = d
        return alert_router
