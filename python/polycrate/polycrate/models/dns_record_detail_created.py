...
if TYPE_CHECKING:
    from ..models.dns_record_detail_created_created_by_type_0 import DNSRecordDetailCreatedCreatedByType0


T = TypeVar("T", bound="DNSRecordDetailCreated")


@_attrs_define
class DNSRecordDetailCreated:
    """
    Attributes:
        created_at (datetime.datetime | None | Unset):
        created_at_humanized (None | str | Unset):
        created_at_display (None | str | Unset):
        created_by (DNSRecordDetailCreatedCreatedByType0 | None | Unset):
    """

    created_at: datetime.datetime | None | Unset = UNSET
    created_at_humanized: None | str | Unset = UNSET
    created_at_display: None | str | Unset = UNSET
    created_by: DNSRecordDetailCreatedCreatedByType0 | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.dns_record_detail_created_created_by_type_0 import (
            DNSRecordDetailCreatedCreatedByType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.created_by, Unset):
            created_by = UNSET
        elif isinstance(self.created_by, DNSRecordDetailCreatedCreatedByType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_created_by(data: object) -> DNSRecordDetailCreatedCreatedByType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                created_by_type_0 = DNSRecordDetailCreatedCreatedByType0.from_dict(data)

                return created_by_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DNSRecordDetailCreatedCreatedByType0 | None | Unset, data)

        created_by = _parse_created_by(d.pop("created_by", UNSET))

        dns_record_detail_created = cls(
        ...
        dns_record_detail_created.additional_properties = d
        return dns_record_detail_created
