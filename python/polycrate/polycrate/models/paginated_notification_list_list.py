...
T = TypeVar("T", bound="PaginatedNotificationListList")
...
class PaginatedNotificationListList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.notification_list import NotificationList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = NotificationList.from_dict(results_item_data)
        ...
        paginated_notification_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_notification_list_list.additional_properties = d
        return paginated_notification_list_list
