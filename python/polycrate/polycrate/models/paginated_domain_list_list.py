...
T = TypeVar("T", bound="PaginatedDomainListList")


@_attrs_define
class PaginatedDomainListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[DomainList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.domain_list import DomainList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = DomainList.from_dict(results_item_data)
        ...
        paginated_domain_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_domain_list_list.additional_properties = d
        return paginated_domain_list_list
