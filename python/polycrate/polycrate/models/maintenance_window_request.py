...
T = TypeVar("T", bound="MaintenanceWindowRequest")
...
class MaintenanceWindowRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        maintenance_window_request = cls(
            name=name,
        ...
        maintenance_window_request.additional_properties = d
        return maintenance_window_request
