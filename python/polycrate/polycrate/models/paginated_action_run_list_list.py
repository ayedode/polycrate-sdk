...
if TYPE_CHECKING:
    from ..models.action_run_list import ActionRunList


T = TypeVar("T", bound="PaginatedActionRunListList")


@_attrs_define
class PaginatedActionRunListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ActionRunList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.action_run_list import ActionRunList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = ActionRunList.from_dict(results_item_data)
        ...
        paginated_action_run_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_action_run_list_list.additional_properties = d
        return paginated_action_run_list_list
