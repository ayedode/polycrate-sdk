...
T = TypeVar("T", bound="PaginatedArtifactPackageListList")


@_attrs_define
class PaginatedArtifactPackageListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ArtifactPackageList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ArtifactPackageList.from_dict(results_item_data)
        ...
        paginated_artifact_package_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_artifact_package_list_list.additional_properties = d
        return paginated_artifact_package_list_list
