...
T = TypeVar("T", bound="PricingQuoteAppDetail")


@_attrs_define
class PricingQuoteAppDetail:
    ...
    Usage:
        ...
        Attributes:
            ...
            deleted_by_user (None | PricingQuoteAppDetailDeletedByUserType0):
            ...
            organization (None | PricingQuoteAppDetailOrganizationType0):
            workspace (None | PricingQuoteAppDetailWorkspaceType0):
            created (PricingQuoteAppDetailCreated):
            ...
            last_action_run (None | PricingQuoteAppDetailLastActionRunType0):
            quote_workspace (UUID):
    ...
    quoted_price: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, PricingQuoteAppDetailDeletedByUserType0):
        ...
        if isinstance(self.organization, PricingQuoteAppDetailOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, PricingQuoteAppDetailWorkspaceType0):
        ...
        if isinstance(self.last_action_run, PricingQuoteAppDetailLastActionRunType0):
            last_action_run = self.last_action_run.to_dict()
        else:
            last_action_run = self.last_action_run

        quote_workspace = str(self.quote_workspace)
        ...
        quoted_price: None | str | Unset
        if isinstance(self.quoted_price, Unset):
            quoted_price = UNSET
        else:
        ...
        if quoted_price is not UNSET:
            field_dict["quoted_price"] = quoted_price
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> None | PricingQuoteAppDetailDeletedByUserType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = PricingQuoteAppDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteAppDetailDeletedByUserType0, data)
        ...
        def _parse_organization(data: object) -> None | PricingQuoteAppDetailOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = PricingQuoteAppDetailOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteAppDetailOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> None | PricingQuoteAppDetailWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = PricingQuoteAppDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteAppDetailWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = PricingQuoteAppDetailCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> None | PricingQuoteAppDetailLastActionRunType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = PricingQuoteAppDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteAppDetailLastActionRunType0, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        quote_workspace = UUID(d.pop("quote_workspace"))
        ...
        def _parse_quoted_price(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        quoted_price = _parse_quoted_price(d.pop("quoted_price", UNSET))

        pricing_quote_app_detail = cls(
            id=id,
            created_at=created_at,
            updated_at=updated_at,
            deleted_at=deleted_at,
        ...
        pricing_quote_app_detail.additional_properties = d
        return pricing_quote_app_detail
