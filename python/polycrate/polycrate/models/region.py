...
class Region:
    ...
    Read-only: workspace, legacy_s3_cluster, legacy_loadbalancer_region (auto-managed)
        ...
        Attributes:
            ...
            deleted_by_user (None | RegionDeletedByUserType0):
            ...
            organization (None | RegionOrganizationType0):
            ...
            last_action_run (None | RegionLastActionRunType0):
            legacy_s3_cluster (None | UUID):
            legacy_loadbalancer_region (None | UUID):
    ...
    config: RegionConfig | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, RegionDeletedByUserType0):
        ...
        if isinstance(self.organization, RegionOrganizationType0):
        ...
        if isinstance(self.last_action_run, RegionLastActionRunType0):
            last_action_run = self.last_action_run.to_dict()
        else:
            last_action_run = self.last_action_run

        legacy_s3_cluster: None | str
        if isinstance(self.legacy_s3_cluster, UUID):
            legacy_s3_cluster = str(self.legacy_s3_cluster)
        else:
            legacy_s3_cluster = self.legacy_s3_cluster

        legacy_loadbalancer_region: None | str
        if isinstance(self.legacy_loadbalancer_region, UUID):
            legacy_loadbalancer_region = str(self.legacy_loadbalancer_region)
        else:
            legacy_loadbalancer_region = self.legacy_loadbalancer_region
        ...
        field_dict.update(
            {
                ...
                "legacy_s3_cluster": legacy_s3_cluster,
                "legacy_loadbalancer_region": legacy_loadbalancer_region,
            }
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> None | RegionDeletedByUserType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = RegionDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | RegionDeletedByUserType0, data)
        ...
        def _parse_organization(data: object) -> None | RegionOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = RegionOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | RegionOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        workspace = WorkspaceSimple.from_dict(d.pop("workspace"))

        created = RegionCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> None | RegionLastActionRunType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = RegionLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | RegionLastActionRunType0, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        def _parse_legacy_s3_cluster(data: object) -> None | UUID:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                legacy_s3_cluster_type_0 = UUID(data)

                return legacy_s3_cluster_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | UUID, data)

        legacy_s3_cluster = _parse_legacy_s3_cluster(d.pop("legacy_s3_cluster"))

        def _parse_legacy_loadbalancer_region(data: object) -> None | UUID:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                legacy_loadbalancer_region_type_0 = UUID(data)

                return legacy_loadbalancer_region_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | UUID, data)

        legacy_loadbalancer_region = _parse_legacy_loadbalancer_region(d.pop("legacy_loadbalancer_region"))
        ...
        if isinstance(_config, Unset):
            ...
            config = RegionConfig.from_dict(_config)
