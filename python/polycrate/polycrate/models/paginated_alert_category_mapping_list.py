...
T = TypeVar("T", bound="PaginatedAlertCategoryMappingList")


@_attrs_define
class PaginatedAlertCategoryMappingList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[AlertCategoryMapping]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = AlertCategoryMapping.from_dict(results_item_data)
        ...
        paginated_alert_category_mapping_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_alert_category_mapping_list.additional_properties = d
        return paginated_alert_category_mapping_list
