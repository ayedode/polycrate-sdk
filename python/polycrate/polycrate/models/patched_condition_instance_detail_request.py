...
T = TypeVar("T", bound="PatchedConditionInstanceDetailRequest")


@_attrs_define
class PatchedConditionInstanceDetailRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.condition, Unset):
            files.append(("condition", (None, str(self.condition), "text/plain")))
        ...
        if not isinstance(self.context, Unset):
            files.append(("context", (None, str(self.context).encode(), "text/plain")))

        if not isinstance(self.immediate, Unset):
            files.append(("immediate", (None, str(self.immediate).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_condition_instance_detail_request = cls(
            name=name,
        ...
        patched_condition_instance_detail_request.additional_properties = d
        return patched_condition_instance_detail_request
