...
T = TypeVar("T", bound="PatchedDomainDetailRequest")


@_attrs_define
class PatchedDomainDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_domain_detail_request = cls(
            name=name,
        ...
        patched_domain_detail_request.additional_properties = d
        return patched_domain_detail_request
