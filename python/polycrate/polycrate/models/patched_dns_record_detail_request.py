...
T = TypeVar("T", bound="PatchedDNSRecordDetailRequest")


@_attrs_define
class PatchedDNSRecordDetailRequest:
    ...
    Usage:
        ...
        Attributes:
            ...
            content (str | Unset): Record content: IP address, hostname, TXT string, …
            ttl (int | Unset):
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.ttl, Unset):
            files.append(("ttl", (None, str(self.ttl).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _dns_zone_id = d.pop("dns_zone_id", UNSET)
        dns_zone_id: UUID | Unset
        if isinstance(_dns_zone_id, Unset):
            dns_zone_id = UNSET
        else:
            dns_zone_id = UUID(_dns_zone_id)
        ...
        patched_dns_record_detail_request = cls(
            name=name,
        ...
        patched_dns_record_detail_request.additional_properties = d
        return patched_dns_record_detail_request
