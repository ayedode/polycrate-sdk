...
@_attrs_define
class IncidentList:
    """List serializer for Incident - V2 Dynamic Tables.

    organization may be null (system-wide) — rendered as "System-wide".
        ...
        Attributes:
            ...
            active_condition_instances (list[IncidentListActiveConditionInstancesItem]):
            organization (str):
            organization_priority (bool): True when the object's organization has priority=True.
            workspace (IncidentListWorkspaceType0 | None):
            created (IncidentListCreated):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.workspace, IncidentListWorkspaceType0):
        ...
        downtimes_count = self.downtimes_count
        ...
        field_dict.update(
            {
                ...
                "downtimes_count": downtimes_count,
            }
        )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = IncidentListActiveConditionInstancesItem.from_dict(
        ...
        def _parse_workspace(data: object) -> IncidentListWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = IncidentListWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(IncidentListWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = IncidentListCreated.from_dict(d.pop("created"))
        ...
        downtimes_count = d.pop("downtimes_count")
