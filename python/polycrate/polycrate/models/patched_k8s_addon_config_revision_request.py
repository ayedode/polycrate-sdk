...
T = TypeVar("T", bound="PatchedK8SAddonConfigRevisionRequest")


@_attrs_define
class PatchedK8SAddonConfigRevisionRequest:
    ...
    Usage:
        ...
        Attributes:
            ...
            addon (UUID | Unset):
            version (str | Unset): Exact template-block version this config applies to.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_k8s_addon_config_revision_request = cls(
            name=name,
        ...
        patched_k8s_addon_config_revision_request.additional_properties = d
        return patched_k8s_addon_config_revision_request
