...
from ..models.assistant_session_status_enum import AssistantSessionStatusEnum, check_assistant_session_status_enum
...
from ..models.turn_status_enum import TurnStatusEnum, check_turn_status_enum
...
T = TypeVar("T", bound="AssistantSession")


@_attrs_define
class AssistantSession:
    """Detail/create/partial serializer. Spec: polycrate spec inspect 738
    ...
    Attributes:
        ...
        deleted_by_user (AssistantSessionDeletedByUserType0 | None):
        ...
        organization (AssistantSessionOrganizationType0 | None):
        workspace (str):
        created (AssistantSessionCreated):
        ...
        last_action_run (AssistantSessionLastActionRunType0 | None):
        turn_status (TurnStatusEnum): * `idle` - Idle
            * `running` - Running
            * `queued` - Queued
        product (str):
        provider_account (str):
        model_snapshot (Any): Model/endpoint snapshot without API keys.
        tokens_input (int):
        tokens_output (int):
        tokens_cached (int):
        computed_cost (None | str):
        participants (list[AssistantSessionParticipantsItem]):
        ...
        status (AssistantSessionStatusEnum | Unset): * `open` - Open
            * `closed` - Closed
    """
    ...
    status: AssistantSessionStatusEnum | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, AssistantSessionDeletedByUserType0):
        ...
        if isinstance(self.organization, AssistantSessionOrganizationType0):
        ...
        if isinstance(self.last_action_run, AssistantSessionLastActionRunType0):
            last_action_run = self.last_action_run.to_dict()
        else:
            last_action_run = self.last_action_run

        turn_status: str = self.turn_status
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> AssistantSessionDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = AssistantSessionDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AssistantSessionDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> AssistantSessionOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = AssistantSessionOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AssistantSessionOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        workspace = d.pop("workspace")

        created = AssistantSessionCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> AssistantSessionLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = AssistantSessionLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AssistantSessionLastActionRunType0 | None, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        turn_status = check_turn_status_enum(d.pop("turn_status"))

        product = d.pop("product")

        provider_account = d.pop("provider_account")

        model_snapshot = d.pop("model_snapshot")

        tokens_input = d.pop("tokens_input")

        tokens_output = d.pop("tokens_output")

        tokens_cached = d.pop("tokens_cached")
        ...
        for participants_item_data in _participants:
            participants_item = AssistantSessionParticipantsItem.from_dict(participants_item_data)
        ...
        status: AssistantSessionStatusEnum | Unset
        if isinstance(_status, Unset):
            status = UNSET
        else:
            status = check_assistant_session_status_enum(_status)

        assistant_session = cls(
            id=id,
            created_at=created_at,
            updated_at=updated_at,
            deleted_at=deleted_at,
        ...
        assistant_session.additional_properties = d
