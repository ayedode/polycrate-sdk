...
from ..models.enforcement_enum import EnforcementEnum, check_enforcement_enum
...
T = TypeVar("T", bound="K8SAddon")


@_attrs_define
class K8SAddon:
    """Detail serializer for K8sAddon catalog entries.
    catalogue_app is a writable FK (UUID). Spec: polycrate spec inspect 695
        ...
        Attributes:
            ...
            deleted_by_user (K8SAddonDeletedByUserType0 | None):
            ...
            organization (K8SAddonOrganizationType0 | None):
            workspace (K8SAddonWorkspaceType0 | None):
            created (K8SAddonCreated):
            ...
            last_action_run (K8SAddonLastActionRunType0 | None):
            catalogue_app (UUID): Non-draft CatalogueApp that maps this addon to a block registry_url.
            block_name (str): Workspace Block name created for subscriptions of this addon.
            ...
            is_default (bool | Unset): Auto-subscribe matching clusters unless opted out.
            allow_multiple (bool | Unset): When true, a cluster may subscribe this addon more than once (one workspace block
                per subscription).
            order (int | Unset): BRI creation order (ascending).
            enforcement (EnforcementEnum | Unset): * `optional` - Optional
    ...
    default_version: str | Unset = UNSET
    default_block_config_template: str | Unset = UNSET
    template_block: str | Unset = UNSET
    scope_expressions: Any | Unset = UNSET
    is_default: bool | Unset = UNSET
    allow_multiple: bool | Unset = UNSET
    order: int | Unset = UNSET
    enforcement: EnforcementEnum | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, K8SAddonDeletedByUserType0):
        ...
        if isinstance(self.organization, K8SAddonOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, K8SAddonWorkspaceType0):
        ...
        if isinstance(self.last_action_run, K8SAddonLastActionRunType0):
        ...
        if default_block_config_template is not UNSET:
            field_dict["default_block_config_template"] = default_block_config_template
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> K8SAddonDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = K8SAddonDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SAddonDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> K8SAddonOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = K8SAddonOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SAddonOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> K8SAddonWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = K8SAddonWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SAddonWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = K8SAddonCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> K8SAddonLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = K8SAddonLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(K8SAddonLastActionRunType0 | None, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        catalogue_app = UUID(d.pop("catalogue_app"))
        ...
        default_version = d.pop("default_version", UNSET)

        default_block_config_template = d.pop("default_block_config_template", UNSET)

        template_block = d.pop("template_block", UNSET)
        ...
        enforcement: EnforcementEnum | Unset
        if isinstance(_enforcement, Unset):
            enforcement = UNSET
        else:
            enforcement = check_enforcement_enum(_enforcement)
        ...
        k8s_addon.additional_properties = d
        return k8s_addon
