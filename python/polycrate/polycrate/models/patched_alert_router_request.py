...
T = TypeVar("T", bound="PatchedAlertRouterRequest")


@_attrs_define
class PatchedAlertRouterRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.label_workspace, Unset):
            files.append(("label_workspace", (None, str(self.label_workspace).encode(), "text/plain")))

        if not isinstance(self.label_organization, Unset):
            files.append(("label_organization", (None, str(self.label_organization).encode(), "text/plain")))

        if not isinstance(self.label_cluster, Unset):
            files.append(("label_cluster", (None, str(self.label_cluster).encode(), "text/plain")))

        if not isinstance(self.label_pod, Unset):
            files.append(("label_pod", (None, str(self.label_pod).encode(), "text/plain")))

        if not isinstance(self.label_namespace, Unset):
            files.append(("label_namespace", (None, str(self.label_namespace).encode(), "text/plain")))

        if not isinstance(self.label_criticality, Unset):
            files.append(("label_criticality", (None, str(self.label_criticality).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_alert_router_request = cls(
            name=name,
        ...
        patched_alert_router_request.additional_properties = d
        return patched_alert_router_request
