...
T = TypeVar("T", bound="PaginatedBlockRolloutConfigListList")


@_attrs_define
class PaginatedBlockRolloutConfigListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[BlockRolloutConfigList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = BlockRolloutConfigList.from_dict(results_item_data)
        ...
        paginated_block_rollout_config_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_block_rollout_config_list_list.additional_properties = d
        return paginated_block_rollout_config_list_list
