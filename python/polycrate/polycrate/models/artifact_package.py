...
T = TypeVar("T", bound="ArtifactPackage")


@_attrs_define
class ArtifactPackage:
    """Full serializer for ArtifactPackage detail view.

    Includes artifact-derived fields (version, license, changelog, …) from
    the latest Artifact of this package (or a specifically requested one via
    ``_artifact_override`` in the serializer context).

    Per .specs/0.12.0/catalogue-app.md

        Attributes:
            id (UUID):
            created (ArtifactPackageCreated):
            organization (ArtifactPackageOrganizationType0 | None):
            workspace (ArtifactPackageWorkspaceType0 | None):
            ...
            last_action_run (ArtifactPackageLastActionRunType0 | None):
            deleted_by_user (ArtifactPackageDeletedByUserType0 | None):
            ...
            latest_source_urls (ArtifactPackageLatestSourceUrls):
            latest_readme_md (str):
            latest_changelog (str):
            latest_changelog_parsed (ArtifactPackageLatestChangelogParsed):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, ArtifactPackageOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, ArtifactPackageWorkspaceType0):
        ...
        if isinstance(self.last_action_run, ArtifactPackageLastActionRunType0):
            last_action_run = self.last_action_run.to_dict()
        else:
            last_action_run = self.last_action_run

        deleted_by_user: dict[str, Any] | None
        if isinstance(self.deleted_by_user, ArtifactPackageDeletedByUserType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created = ArtifactPackageCreated.from_dict(d.pop("created"))

        def _parse_organization(data: object) -> ArtifactPackageOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = ArtifactPackageOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ArtifactPackageOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> ArtifactPackageWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = ArtifactPackageWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ArtifactPackageWorkspaceType0 | None, data)
        ...
        def _parse_last_action_run(data: object) -> ArtifactPackageLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = ArtifactPackageLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ArtifactPackageLastActionRunType0 | None, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        def _parse_deleted_by_user(data: object) -> ArtifactPackageDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = ArtifactPackageDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ArtifactPackageDeletedByUserType0 | None, data)
        ...
        latest_source_urls = ArtifactPackageLatestSourceUrls.from_dict(d.pop("latest_source_urls"))

        latest_readme_md = d.pop("latest_readme_md")

        latest_changelog = d.pop("latest_changelog")

        latest_changelog_parsed = ArtifactPackageLatestChangelogParsed.from_dict(d.pop("latest_changelog_parsed"))
        ...
        artifact_package.additional_properties = d
