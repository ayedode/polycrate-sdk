...
if TYPE_CHECKING:
    from ..models.backup_created import BackupCreated
    from ..models.backup_deleted_by_user_type_0 import BackupDeletedByUserType0
    from ..models.backup_last_action_run_type_0 import BackupLastActionRunType0
    from ..models.backup_organization_type_0 import BackupOrganizationType0
    from ..models.backup_workspace_type_0 import BackupWorkspaceType0
...
class Backup:
    ...
    Siehe: .specs/0.11.16/backup-name-validation.md
        ...
        Attributes:
            id (UUID):
            name (str): Backup name (required, must match regex ^[a-z0-9]+(?:-[a-z0-9]+)*$)
            ...
            deleted_by_user (BackupDeletedByUserType0 | None):
            ...
            organization (BackupOrganizationType0 | None):
            workspace (BackupWorkspaceType0 | None):
            ...
            last_action_run (BackupLastActionRunType0 | None):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.backup_deleted_by_user_type_0 import BackupDeletedByUserType0  # noqa: PLC0415
        from ..models.backup_last_action_run_type_0 import BackupLastActionRunType0  # noqa: PLC0415
        from ..models.backup_organization_type_0 import BackupOrganizationType0  # noqa: PLC0415
        from ..models.backup_workspace_type_0 import BackupWorkspaceType0  # noqa: PLC0415
        ...
        if isinstance(self.deleted_by_user, BackupDeletedByUserType0):
        ...
        if isinstance(self.organization, BackupOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, BackupWorkspaceType0):
        ...
        if isinstance(self.last_action_run, BackupLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.backup_created import BackupCreated  # noqa: PLC0415
        from ..models.backup_deleted_by_user_type_0 import BackupDeletedByUserType0  # noqa: PLC0415
        from ..models.backup_last_action_run_type_0 import BackupLastActionRunType0  # noqa: PLC0415
        from ..models.backup_organization_type_0 import BackupOrganizationType0  # noqa: PLC0415
        from ..models.backup_workspace_type_0 import BackupWorkspaceType0  # noqa: PLC0415
        ...
        def _parse_deleted_by_user(data: object) -> BackupDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = BackupDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BackupDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> BackupOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = BackupOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BackupOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> BackupWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = BackupWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BackupWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = BackupCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> BackupLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = BackupLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BackupLastActionRunType0 | None, data)
