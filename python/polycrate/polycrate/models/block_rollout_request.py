...
T = TypeVar("T", bound="BlockRolloutRequest")


@_attrs_define
class BlockRolloutRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        block_rollout_request.additional_properties = d
        return block_rollout_request
