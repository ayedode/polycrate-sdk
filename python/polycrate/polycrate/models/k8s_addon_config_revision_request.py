...
T = TypeVar("T", bound="K8SAddonConfigRevisionRequest")


@_attrs_define
class K8SAddonConfigRevisionRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        k8s_addon_config_revision_request = cls(
            addon=addon,
            version=version,
            name=name,
        ...
        k8s_addon_config_revision_request.additional_properties = d
        return k8s_addon_config_revision_request
