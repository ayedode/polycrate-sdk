...
T = TypeVar("T", bound="K8SClusterAddonSubscriptionDetailRequest")


@_attrs_define
class K8SClusterAddonSubscriptionDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        k8s_cluster_addon_subscription_detail_request = cls(
            k8s_cluster=k8s_cluster,
            addon=addon,
            name=name,
        ...
        k8s_cluster_addon_subscription_detail_request.additional_properties = d
        return k8s_cluster_addon_subscription_detail_request
