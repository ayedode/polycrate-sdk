...
T = TypeVar("T", bound="PaginatedDeliveryControllerListList")


@_attrs_define
class PaginatedDeliveryControllerListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[DeliveryControllerList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DeliveryControllerList.from_dict(results_item_data)
        ...
        paginated_delivery_controller_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_delivery_controller_list_list.additional_properties = d
        return paginated_delivery_controller_list_list
