...
T = TypeVar("T", bound="PatchedAlertCategoryRequest")


@_attrs_define
class PatchedAlertCategoryRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.sort_order, Unset):
            files.append(("sort_order", (None, str(self.sort_order).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_alert_category_request = cls(
            name=name,
        ...
        patched_alert_category_request.additional_properties = d
        return patched_alert_category_request
