...
if TYPE_CHECKING:
    from ..models.grafana_dashboard_created import GrafanaDashboardCreated
    from ..models.grafana_dashboard_deleted_by_user_type_0 import GrafanaDashboardDeletedByUserType0
    from ..models.grafana_dashboard_last_action_run_type_0 import GrafanaDashboardLastActionRunType0
    from ..models.grafana_dashboard_organization_type_0 import GrafanaDashboardOrganizationType0
    from ..models.grafana_dashboard_revision import GrafanaDashboardRevision
    from ..models.grafana_dashboard_workspace_type_0 import GrafanaDashboardWorkspaceType0


T = TypeVar("T", bound="GrafanaDashboard")
...
class GrafanaDashboard:
    ...
    Usage:
        ...
        Attributes:
            ...
            deleted_by_user (GrafanaDashboardDeletedByUserType0 | None):
            ...
            organization (GrafanaDashboardOrganizationType0 | None):
            workspace (GrafanaDashboardWorkspaceType0 | None):
            created (GrafanaDashboardCreated):
            ...
            last_action_run (GrafanaDashboardLastActionRunType0 | None):
            source_uid (str): UID in Operations Grafana.
            operations_folder_uid (str): Optional folder UID from Operations Grafana (meta.folderUid).
            tags (Any): Dashboard tags as reported by Operations Grafana.
            last_imported_at (datetime.datetime | None): Timestamp of the last successful import from Operations Grafana.
            latest_revision (GrafanaDashboardRevision):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.grafana_dashboard_deleted_by_user_type_0 import (
            GrafanaDashboardDeletedByUserType0,  # noqa: PLC0415
        )
        from ..models.grafana_dashboard_last_action_run_type_0 import (
            GrafanaDashboardLastActionRunType0,  # noqa: PLC0415
        )
        from ..models.grafana_dashboard_organization_type_0 import GrafanaDashboardOrganizationType0  # noqa: PLC0415
        from ..models.grafana_dashboard_workspace_type_0 import GrafanaDashboardWorkspaceType0  # noqa: PLC0415
        ...
        if isinstance(self.deleted_by_user, GrafanaDashboardDeletedByUserType0):
        ...
        if isinstance(self.organization, GrafanaDashboardOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, GrafanaDashboardWorkspaceType0):
        ...
        if isinstance(self.last_action_run, GrafanaDashboardLastActionRunType0):
        ...
        operations_folder_uid = self.operations_folder_uid

        tags = self.tags

        last_imported_at: None | str
        if isinstance(self.last_imported_at, datetime.datetime):
        ...
        field_dict.update(
            {
                ...
                "operations_folder_uid": operations_folder_uid,
                "tags": tags,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.grafana_dashboard_created import GrafanaDashboardCreated  # noqa: PLC0415
        from ..models.grafana_dashboard_deleted_by_user_type_0 import (
            GrafanaDashboardDeletedByUserType0,  # noqa: PLC0415
        )
        from ..models.grafana_dashboard_last_action_run_type_0 import (
        ...
        from ..models.grafana_dashboard_organization_type_0 import GrafanaDashboardOrganizationType0  # noqa: PLC0415
        from ..models.grafana_dashboard_revision import GrafanaDashboardRevision  # noqa: PLC0415
        from ..models.grafana_dashboard_workspace_type_0 import GrafanaDashboardWorkspaceType0  # noqa: PLC0415
        ...
        def _parse_deleted_by_user(data: object) -> GrafanaDashboardDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = GrafanaDashboardDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GrafanaDashboardDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> GrafanaDashboardOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = GrafanaDashboardOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GrafanaDashboardOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> GrafanaDashboardWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = GrafanaDashboardWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GrafanaDashboardWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = GrafanaDashboardCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> GrafanaDashboardLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = GrafanaDashboardLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GrafanaDashboardLastActionRunType0 | None, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        source_uid = d.pop("source_uid")

        operations_folder_uid = d.pop("operations_folder_uid")

        tags = d.pop("tags")

        def _parse_last_imported_at(data: object) -> datetime.datetime | None:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
        ...
        last_imported_at = _parse_last_imported_at(d.pop("last_imported_at"))

        latest_revision = GrafanaDashboardRevision.from_dict(d.pop("latest_revision"))
        ...
        grafana_dashboard.additional_properties = d
