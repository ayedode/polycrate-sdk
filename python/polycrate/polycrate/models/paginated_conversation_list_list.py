...
T = TypeVar("T", bound="PaginatedConversationListList")
...
class PaginatedConversationListList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ConversationList.from_dict(results_item_data)
        ...
        paginated_conversation_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_conversation_list_list.additional_properties = d
        return paginated_conversation_list_list
