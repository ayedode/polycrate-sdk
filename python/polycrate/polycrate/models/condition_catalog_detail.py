...
T = TypeVar("T", bound="ConditionCatalogDetail")


@_attrs_define
class ConditionCatalogDetail:
    """Detail serializer for the Condition catalog model.
    ...
    Attributes:
        ...
        deleted_by_user (ConditionCatalogDetailDeletedByUserType0 | None):
        ...
        organization (ConditionCatalogDetailOrganizationType0 | None):
        workspace (ConditionCatalogDetailWorkspaceType0 | None):
        created (ConditionCatalogDetailCreated):
        ...
        last_action_run (ConditionCatalogDetailLastActionRunType0 | None):
        ...
        severity (ConditionSeverityEnum | Unset): * `info` - Info
            * `warning` - Warning
            * `critical` - Critical
        is_system (bool | Unset): System conditions are seeded automatically and cannot be modified or deleted.
    ...
    severity: ConditionSeverityEnum | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, ConditionCatalogDetailDeletedByUserType0):
        ...
        if isinstance(self.organization, ConditionCatalogDetailOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, ConditionCatalogDetailWorkspaceType0):
        ...
        if isinstance(self.last_action_run, ConditionCatalogDetailLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> ConditionCatalogDetailDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = ConditionCatalogDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ConditionCatalogDetailDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> ConditionCatalogDetailOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = ConditionCatalogDetailOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ConditionCatalogDetailOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> ConditionCatalogDetailWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = ConditionCatalogDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ConditionCatalogDetailWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = ConditionCatalogDetailCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> ConditionCatalogDetailLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = ConditionCatalogDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ConditionCatalogDetailLastActionRunType0 | None, data)
        ...
        severity: ConditionSeverityEnum | Unset
        if isinstance(_severity, Unset):
            severity = UNSET
        else:
            severity = check_condition_severity_enum(_severity)

        is_system = d.pop("is_system", UNSET)

        description = d.pop("description", UNSET)

        condition_catalog_detail = cls(
            id=id,
            created_at=created_at,
            updated_at=updated_at,
            deleted_at=deleted_at,
        ...
        condition_catalog_detail.additional_properties = d
        return condition_catalog_detail
