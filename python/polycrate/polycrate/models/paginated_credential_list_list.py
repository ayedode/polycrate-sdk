...
T = TypeVar("T", bound="PaginatedCredentialListList")


@_attrs_define
class PaginatedCredentialListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[CredentialList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = CredentialList.from_dict(results_item_data)
        ...
        paginated_credential_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_credential_list_list.additional_properties = d
        return paginated_credential_list_list
