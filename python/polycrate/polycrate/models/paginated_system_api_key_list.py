...
T = TypeVar("T", bound="PaginatedSystemAPIKeyList")


@_attrs_define
class PaginatedSystemAPIKeyList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[SystemAPIKey]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = SystemAPIKey.from_dict(results_item_data)
        ...
        paginated_system_api_key_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_system_api_key_list.additional_properties = d
        return paginated_system_api_key_list
