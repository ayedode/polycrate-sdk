...
from ..models.artifact_registry_kind_enum import ArtifactRegistryKindEnum, check_artifact_registry_kind_enum
...
if TYPE_CHECKING:
    from ..models.artifact_registry_created import ArtifactRegistryCreated
    from ..models.artifact_registry_deleted_by_user_type_0 import ArtifactRegistryDeletedByUserType0
    from ..models.artifact_registry_last_action_run_type_0 import ArtifactRegistryLastActionRunType0
    from ..models.artifact_registry_organization_type_0 import ArtifactRegistryOrganizationType0
    from ..models.artifact_registry_workspace_type_0 import ArtifactRegistryWorkspaceType0


T = TypeVar("T", bound="ArtifactRegistry")


@_attrs_define
class ArtifactRegistry:
    """Full serializer for ArtifactRegistry detail views.
    ...
    Attributes:
        ...
        deleted_by_user (ArtifactRegistryDeletedByUserType0 | None):
        ...
        organization (ArtifactRegistryOrganizationType0 | None):
        workspace (ArtifactRegistryWorkspaceType0 | None):
        created (ArtifactRegistryCreated):
        ...
        last_action_run (ArtifactRegistryLastActionRunType0 | None):
        k8s_cluster (UUID): Kubernetes cluster where this registry runs
        ...
        kind (ArtifactRegistryKindEnum | Unset): * `harbor` - Harbor
        ...
        hostname (None | str | Unset): Hostname/URL where this registry is accessible
        projects_count (int | Unset): Number of projects
        repositories_count (int | Unset): Number of repositories
        storage_used_bytes (int | Unset): Storage used in bytes
        registry_version (None | str | Unset): Registry application version
        k8s_app (None | Unset | UUID): K8s application that implements this artifact registry
    ...
    kind: ArtifactRegistryKindEnum | Unset = UNSET
    ...
    repositories_count: int | Unset = UNSET
    storage_used_bytes: int | Unset = UNSET
    registry_version: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.artifact_registry_deleted_by_user_type_0 import (
            ArtifactRegistryDeletedByUserType0,  # noqa: PLC0415
        )
        from ..models.artifact_registry_last_action_run_type_0 import (
            ArtifactRegistryLastActionRunType0,  # noqa: PLC0415
        )
        from ..models.artifact_registry_organization_type_0 import ArtifactRegistryOrganizationType0  # noqa: PLC0415
        from ..models.artifact_registry_workspace_type_0 import ArtifactRegistryWorkspaceType0  # noqa: PLC0415
        ...
        if isinstance(self.deleted_by_user, ArtifactRegistryDeletedByUserType0):
        ...
        if isinstance(self.organization, ArtifactRegistryOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, ArtifactRegistryWorkspaceType0):
        ...
        if isinstance(self.last_action_run, ArtifactRegistryLastActionRunType0):
        ...
        registry_version: None | str | Unset
        if isinstance(self.registry_version, Unset):
        ...
        if repositories_count is not UNSET:
            field_dict["repositories_count"] = repositories_count
        if storage_used_bytes is not UNSET:
            field_dict["storage_used_bytes"] = storage_used_bytes
        if registry_version is not UNSET:
            field_dict["registry_version"] = registry_version
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.artifact_registry_created import ArtifactRegistryCreated  # noqa: PLC0415
        from ..models.artifact_registry_deleted_by_user_type_0 import (
            ArtifactRegistryDeletedByUserType0,  # noqa: PLC0415
        )
        from ..models.artifact_registry_last_action_run_type_0 import (
        ...
        def _parse_deleted_by_user(data: object) -> ArtifactRegistryDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = ArtifactRegistryDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ArtifactRegistryDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> ArtifactRegistryOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = ArtifactRegistryOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ArtifactRegistryOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> ArtifactRegistryWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = ArtifactRegistryWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ArtifactRegistryWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = ArtifactRegistryCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> ArtifactRegistryLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = ArtifactRegistryLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ArtifactRegistryLastActionRunType0 | None, data)
        ...
        kind: ArtifactRegistryKindEnum | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_artifact_registry_kind_enum(_kind)
        ...
        repositories_count = d.pop("repositories_count", UNSET)

        storage_used_bytes = d.pop("storage_used_bytes", UNSET)

        def _parse_registry_version(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        registry_version = _parse_registry_version(d.pop("registry_version", UNSET))
        ...
        artifact_registry.additional_properties = d
