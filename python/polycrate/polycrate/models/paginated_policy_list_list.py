...
T = TypeVar("T", bound="PaginatedPolicyListList")


@_attrs_define
class PaginatedPolicyListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[PolicyList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.policy_list import PolicyList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = PolicyList.from_dict(results_item_data)
        ...
        paginated_policy_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_policy_list_list.additional_properties = d
        return paginated_policy_list_list
