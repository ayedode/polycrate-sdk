...
T = TypeVar("T", bound="PatchedPricingCalculatorStateDetailRequest")


@_attrs_define
class PatchedPricingCalculatorStateDetailRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.configuration_json, Unset):
            files.append(("configuration_json", (None, str(self.configuration_json).encode(), "text/plain")))
        ...
        if not isinstance(self.last_access, Unset):
            if isinstance(self.last_access, datetime.datetime):
                files.append(("last_access", (None, self.last_access.isoformat().encode(), "text/plain")))
            else:
                files.append(("last_access", (None, str(self.last_access).encode(), "text/plain")))

        if not isinstance(self.access_count, Unset):
            files.append(("access_count", (None, str(self.access_count).encode(), "text/plain")))

        if not isinstance(self.booking_id, Unset):
            files.append(("booking_id", (None, str(self.booking_id).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_pricing_calculator_state_detail_request = cls(
            name=name,
        ...
        patched_pricing_calculator_state_detail_request.additional_properties = d
        return patched_pricing_calculator_state_detail_request
