...
if TYPE_CHECKING:
    from ..models.notification_list_active_condition_instances_item import NotificationListActiveConditionInstancesItem
...
T = TypeVar("T", bound="NotificationList")


@_attrs_define
class NotificationList:
    """List serializer for Notification - V2 Dynamic Tables.
    ...
    Attributes:
        ...
        active_condition_instances (list[NotificationListActiveConditionInstancesItem]):
        organization (None | NotificationListOrganizationType0):
        organization_priority (bool): True when the object's organization has priority=True.
        workspace (None | NotificationListWorkspaceType0):
        created (NotificationListCreated):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, NotificationListOrganizationType0):
        ...
        if isinstance(self.workspace, NotificationListWorkspaceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = NotificationListActiveConditionInstancesItem.from_dict(
                active_condition_instances_item_data
            )

            active_condition_instances.append(active_condition_instances_item)

        def _parse_organization(data: object) -> None | NotificationListOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = NotificationListOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | NotificationListOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        organization_priority = d.pop("organization_priority")

        def _parse_workspace(data: object) -> None | NotificationListWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = NotificationListWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | NotificationListWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = NotificationListCreated.from_dict(d.pop("created"))
        ...
        notification_list.additional_properties = d
