...
if TYPE_CHECKING:
    from ..models.backup_list import BackupList


T = TypeVar("T", bound="PaginatedBackupListList")


@_attrs_define
class PaginatedBackupListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[BackupList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.backup_list import BackupList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = BackupList.from_dict(results_item_data)
        ...
        paginated_backup_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_backup_list_list.additional_properties = d
        return paginated_backup_list_list
