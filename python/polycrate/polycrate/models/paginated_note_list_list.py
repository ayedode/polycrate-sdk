...
T = TypeVar("T", bound="PaginatedNoteListList")


@_attrs_define
class PaginatedNoteListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[NoteList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.note_list import NoteList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = NoteList.from_dict(results_item_data)
        ...
        paginated_note_list_list.additional_properties = d
        return paginated_note_list_list
