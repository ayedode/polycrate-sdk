...
from ..models.identity_provider_kind_enum import IdentityProviderKindEnum, check_identity_provider_kind_enum
...
from ..models.sync_mode_enum import SyncModeEnum, check_sync_mode_enum
...
class IdentityProvider:
    """Full serializer for IdentityProvider detail views.
    ...
    Attributes:
        ...
        deleted_by_user (IdentityProviderDeletedByUserType0 | None):
        ...
        organization (IdentityProviderOrganizationType0 | None):
        workspace (IdentityProviderWorkspaceType0 | None):
        ...
        last_action_run (IdentityProviderLastActionRunType0 | None):
        ...
        kind (IdentityProviderKindEnum | Unset): * `generic` - Generic
            * `keycloak` - Keycloak
            * `authentik` - Authentik
        ...
        hostname (None | str | Unset): Hostname/URL where this identity provider is accessible
        sync_mode (SyncModeEnum | Unset): * `disabled` - Disabled
            * `push` - Push
            * `pull` - Pull
            * `full` - Full
    """
    ...
    kind: IdentityProviderKindEnum | Unset = UNSET
    ...
    sync_mode: SyncModeEnum | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, IdentityProviderDeletedByUserType0):
        ...
        if isinstance(self.organization, IdentityProviderOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, IdentityProviderWorkspaceType0):
        ...
        if isinstance(self.last_action_run, IdentityProviderLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> IdentityProviderDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = IdentityProviderDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(IdentityProviderDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> IdentityProviderOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = IdentityProviderOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(IdentityProviderOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> IdentityProviderWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = IdentityProviderWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(IdentityProviderWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = IdentityProviderCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> IdentityProviderLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = IdentityProviderLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(IdentityProviderLastActionRunType0 | None, data)
        ...
        kind: IdentityProviderKindEnum | Unset
        if isinstance(_kind, Unset):
            kind = UNSET
        else:
            kind = check_identity_provider_kind_enum(_kind)
        ...
        sync_mode: SyncModeEnum | Unset
        if isinstance(_sync_mode, Unset):
            sync_mode = UNSET
        else:
            sync_mode = check_sync_mode_enum(_sync_mode)
