...
T = TypeVar("T", bound="PatchedS3ClusterRequest")


@_attrs_define
class PatchedS3ClusterRequest:
    ...
    Attributes:
        ...
        endpoint (str | Unset): $HOSTNAME (without protocol://)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_s3_cluster_request = cls(
            name=name,
        ...
        patched_s3_cluster_request.additional_properties = d
        return patched_s3_cluster_request
