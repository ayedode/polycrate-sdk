...
T = TypeVar("T", bound="PatchedCodeRepositoryRequest")


@_attrs_define
class PatchedCodeRepositoryRequest:
    ...
    Attributes:
        ...
        k8s_cluster (UUID | Unset): Kubernetes cluster where this repository runs
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.users_count, Unset):
            files.append(("users_count", (None, str(self.users_count).encode(), "text/plain")))

        if not isinstance(self.groups_count, Unset):
            files.append(("groups_count", (None, str(self.groups_count).encode(), "text/plain")))

        if not isinstance(self.repository_version, Unset):
            if isinstance(self.repository_version, str):
                files.append(("repository_version", (None, str(self.repository_version).encode(), "text/plain")))
            else:
                files.append(("repository_version", (None, str(self.repository_version).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_code_repository_request = cls(
            name=name,
        ...
        patched_code_repository_request.additional_properties = d
        return patched_code_repository_request
