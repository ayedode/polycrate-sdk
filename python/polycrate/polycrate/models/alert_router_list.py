...
if TYPE_CHECKING:
    from ..models.alert_router_list_active_condition_instances_item import AlertRouterListActiveConditionInstancesItem
...
T = TypeVar("T", bound="AlertRouterList")


@_attrs_define
class AlertRouterList:
    """Lightweight serializer for AlertRouter list views.
    ...
    Attributes:
        ...
        active_condition_instances (list[AlertRouterListActiveConditionInstancesItem]):
        organization (AlertRouterListOrganizationType0 | None):
        organization_priority (bool): True when the object's organization has priority=True.
        workspace (AlertRouterListWorkspaceType0 | None):
        created (AlertRouterListCreated):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, AlertRouterListOrganizationType0):
        ...
        if isinstance(self.workspace, AlertRouterListWorkspaceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = AlertRouterListActiveConditionInstancesItem.from_dict(
                active_condition_instances_item_data
            )

            active_condition_instances.append(active_condition_instances_item)

        def _parse_organization(data: object) -> AlertRouterListOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = AlertRouterListOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AlertRouterListOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        organization_priority = d.pop("organization_priority")

        def _parse_workspace(data: object) -> AlertRouterListWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = AlertRouterListWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AlertRouterListWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = AlertRouterListCreated.from_dict(d.pop("created"))
        ...
        alert_router_list.additional_properties = d
        return alert_router_list
