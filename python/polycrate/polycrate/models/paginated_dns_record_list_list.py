...
if TYPE_CHECKING:
    from ..models.dns_record_list import DNSRecordList


T = TypeVar("T", bound="PaginatedDNSRecordListList")


@_attrs_define
class PaginatedDNSRecordListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[DNSRecordList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.dns_record_list import DNSRecordList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = DNSRecordList.from_dict(results_item_data)
        ...
        paginated_dns_record_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_dns_record_list_list.additional_properties = d
        return paginated_dns_record_list_list
