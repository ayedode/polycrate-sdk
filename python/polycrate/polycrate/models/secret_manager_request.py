...
T = TypeVar("T", bound="SecretManagerRequest")


@_attrs_define
class SecretManagerRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        secret_manager_request.additional_properties = d
        return secret_manager_request
