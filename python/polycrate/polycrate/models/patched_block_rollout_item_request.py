...
T = TypeVar("T", bound="PatchedBlockRolloutItemRequest")


@_attrs_define
class PatchedBlockRolloutItemRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.source_user, Unset):
            if isinstance(self.source_user, int):
                files.append(("source_user", (None, str(self.source_user).encode(), "text/plain")))
            else:
                files.append(("source_user", (None, str(self.source_user).encode(), "text/plain")))

        if not isinstance(self.rollout, Unset):
            if isinstance(self.rollout, UUID):
                files.append(("rollout", (None, str(self.rollout), "text/plain")))
            else:
                files.append(("rollout", (None, str(self.rollout).encode(), "text/plain")))

        if not isinstance(self.action_run, Unset):
            if isinstance(self.action_run, UUID):
                files.append(("action_run", (None, str(self.action_run), "text/plain")))
            else:
                files.append(("action_run", (None, str(self.action_run).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_block_rollout_item_request = cls(
            name=name,
        ...
        patched_block_rollout_item_request.additional_properties = d
        return patched_block_rollout_item_request
