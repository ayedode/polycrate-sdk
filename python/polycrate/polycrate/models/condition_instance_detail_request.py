...
T = TypeVar("T", bound="ConditionInstanceDetailRequest")


@_attrs_define
class ConditionInstanceDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        condition_instance_detail_request = cls(
            condition=condition,
            name=name,
        ...
        condition_instance_detail_request.additional_properties = d
        return condition_instance_detail_request
