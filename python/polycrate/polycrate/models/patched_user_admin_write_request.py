...
T = TypeVar("T", bound="PatchedUserAdminWriteRequest")


@_attrs_define
class PatchedUserAdminWriteRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_user_admin_write_request = cls(
            email=email,
        ...
        patched_user_admin_write_request.additional_properties = d
        return patched_user_admin_write_request
