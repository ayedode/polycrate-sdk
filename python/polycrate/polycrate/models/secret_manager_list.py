...
T = TypeVar("T", bound="SecretManagerList")


@_attrs_define
class SecretManagerList:
    """List serializer for SecretManager - V2 Dynamic Tables.
    ...
    Attributes:
        ...
        active_condition_instances (list[SecretManagerListActiveConditionInstancesItem]):
        organization (None | SecretManagerListOrganizationType0):
        organization_priority (bool): True when the object's organization has priority=True.
        workspace (None | SecretManagerListWorkspaceType0):
        created (SecretManagerListCreated):
        ...
        is_sealed (bool):
        is_initialized (bool):
        k8s_cluster (SecretManagerListK8SCluster):
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, SecretManagerListOrganizationType0):
        ...
        if isinstance(self.workspace, SecretManagerListWorkspaceType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = SecretManagerListActiveConditionInstancesItem.from_dict(
                active_condition_instances_item_data
            )

            active_condition_instances.append(active_condition_instances_item)

        def _parse_organization(data: object) -> None | SecretManagerListOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = SecretManagerListOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SecretManagerListOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        organization_priority = d.pop("organization_priority")

        def _parse_workspace(data: object) -> None | SecretManagerListWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = SecretManagerListWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SecretManagerListWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = SecretManagerListCreated.from_dict(d.pop("created"))
        ...
        vault_mode = d.pop("vault_mode")

        is_sealed = d.pop("is_sealed")

        is_initialized = d.pop("is_initialized")

        k8s_cluster = SecretManagerListK8SCluster.from_dict(d.pop("k8s_cluster"))

        secret_manager_list = cls(
            id=id,
            name=name,
            state=state,
            labels=labels,
        ...
        secret_manager_list.additional_properties = d
        return secret_manager_list
