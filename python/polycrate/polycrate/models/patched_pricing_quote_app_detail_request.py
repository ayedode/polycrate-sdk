...
T = TypeVar("T", bound="PatchedPricingQuoteAppDetailRequest")


@_attrs_define
class PatchedPricingQuoteAppDetailRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        quote_workspace: str | Unset = UNSET
        if not isinstance(self.quote_workspace, Unset):
        ...
        if quote_workspace is not UNSET:
            field_dict["quote_workspace"] = quote_workspace
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.quote_workspace, Unset):
            files.append(("quote_workspace", (None, str(self.quote_workspace), "text/plain")))
        ...
        if not isinstance(self.count, Unset):
            files.append(("count", (None, str(self.count).encode(), "text/plain")))

        if not isinstance(self.quoted_price, Unset):
            if isinstance(self.quoted_price, str):
                files.append(("quoted_price", (None, str(self.quoted_price).encode(), "text/plain")))
            else:
                files.append(("quoted_price", (None, str(self.quoted_price).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _quote_workspace = d.pop("quote_workspace", UNSET)
        quote_workspace: UUID | Unset
        if isinstance(_quote_workspace, Unset):
            quote_workspace = UNSET
        else:
            quote_workspace = UUID(_quote_workspace)
        ...
        patched_pricing_quote_app_detail_request = cls(
            name=name,
        ...
        patched_pricing_quote_app_detail_request.additional_properties = d
        return patched_pricing_quote_app_detail_request
