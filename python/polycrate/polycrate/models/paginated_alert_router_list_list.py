...
if TYPE_CHECKING:
    from ..models.alert_router_list import AlertRouterList


T = TypeVar("T", bound="PaginatedAlertRouterListList")


@_attrs_define
class PaginatedAlertRouterListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[AlertRouterList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.alert_router_list import AlertRouterList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = AlertRouterList.from_dict(results_item_data)
        ...
        paginated_alert_router_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_alert_router_list_list.additional_properties = d
        return paginated_alert_router_list_list
