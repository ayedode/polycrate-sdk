...
T = TypeVar("T", bound="PaginatedActivityListList")


@_attrs_define
class PaginatedActivityListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ActivityList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.activity_list import ActivityList  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = ActivityList.from_dict(results_item_data)
        ...
        paginated_activity_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_activity_list_list.additional_properties = d
        return paginated_activity_list_list
