...
T = TypeVar("T", bound="DNSRecordDetailRequest")


@_attrs_define
class DNSRecordDetailRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        dns_zone_id = UUID(d.pop("dns_zone_id"))
        ...
        dns_record_detail_request.additional_properties = d
        return dns_record_detail_request
