...
T = TypeVar("T", bound="PaginatedOrgAPIKeyList")


@_attrs_define
class PaginatedOrgAPIKeyList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[OrgAPIKey]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.org_api_key import OrgAPIKey  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = OrgAPIKey.from_dict(results_item_data)
        ...
        paginated_org_api_key_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_org_api_key_list.additional_properties = d
        return paginated_org_api_key_list
