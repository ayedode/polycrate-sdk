...
T = TypeVar("T", bound="PaginatedMcpSessionList")


@_attrs_define
class PaginatedMcpSessionList:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.mcp_session import McpSession  # noqa: PLC0415
        ...
        for results_item_data in _results:
            results_item = McpSession.from_dict(results_item_data)
        ...
        paginated_mcp_session_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_mcp_session_list.additional_properties = d
        return paginated_mcp_session_list
