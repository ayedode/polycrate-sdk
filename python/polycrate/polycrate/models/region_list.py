...
if TYPE_CHECKING:
    from ..models.region_list_active_condition_instances_item import RegionListActiveConditionInstancesItem
    from ..models.region_list_created import RegionListCreated
    from ..models.region_list_organization_type_0 import RegionListOrganizationType0
    from ..models.workspace_simple import WorkspaceSimple


T = TypeVar("T", bound="RegionList")


@_attrs_define
class RegionList:
    """Region List Serializer.
    Spec: polycrate spec inspect 309
        ...
        Attributes:
            ...
            active_condition_instances (list[RegionListActiveConditionInstancesItem]):
            organization (None | RegionListOrganizationType0):
            organization_priority (bool): True when the object's organization has priority=True.
            workspace (WorkspaceSimple):
            created (RegionListCreated):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.region_list_organization_type_0 import RegionListOrganizationType0  # noqa: PLC0415
        ...
        if isinstance(self.organization, RegionListOrganizationType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.region_list_active_condition_instances_item import (
            RegionListActiveConditionInstancesItem,  # noqa: PLC0415
        )
        from ..models.region_list_created import RegionListCreated  # noqa: PLC0415
        from ..models.region_list_organization_type_0 import RegionListOrganizationType0  # noqa: PLC0415
        ...
        for active_condition_instances_item_data in _active_condition_instances:
            active_condition_instances_item = RegionListActiveConditionInstancesItem.from_dict(
                active_condition_instances_item_data
            )

            active_condition_instances.append(active_condition_instances_item)

        def _parse_organization(data: object) -> None | RegionListOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = RegionListOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | RegionListOrganizationType0, data)
        ...
        created = RegionListCreated.from_dict(d.pop("created"))
        ...
        region_list.additional_properties = d
        return region_list
