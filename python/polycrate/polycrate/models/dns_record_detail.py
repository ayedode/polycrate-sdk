...
T = TypeVar("T", bound="DNSRecordDetail")


@_attrs_define
class DNSRecordDetail:
    ...
    Usage:
        ...
        Attributes:
            ...
            last_action_run (DNSRecordDetailLastActionRunType0 | None):
            deleted_by_user (DNSRecordDetailDeletedByUserType0 | None):
    ...
    type_: DNSRecordTypeEnum | Unset = "A"
    ttl: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, DNSRecordDetailOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, DNSRecordDetailWorkspaceType0):
        ...
        if isinstance(self.last_action_run, DNSRecordDetailLastActionRunType0):
            last_action_run = self.last_action_run.to_dict()
        else:
            last_action_run = self.last_action_run

        deleted_by_user: dict[str, Any] | None
        if isinstance(self.deleted_by_user, DNSRecordDetailDeletedByUserType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_organization(data: object) -> DNSRecordDetailOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = DNSRecordDetailOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DNSRecordDetailOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> DNSRecordDetailWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = DNSRecordDetailWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DNSRecordDetailWorkspaceType0 | None, data)
        ...
        def _parse_last_action_run(data: object) -> DNSRecordDetailLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = DNSRecordDetailLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DNSRecordDetailLastActionRunType0 | None, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        def _parse_deleted_by_user(data: object) -> DNSRecordDetailDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = DNSRecordDetailDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DNSRecordDetailDeletedByUserType0 | None, data)
        ...
        dns_record_detail.additional_properties = d
        return dns_record_detail
