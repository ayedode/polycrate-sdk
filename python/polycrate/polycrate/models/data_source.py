...
class DataSource:
    ...
    Attributes:
        ...
        deleted_by_user (DataSourceDeletedByUserType0 | None):
        ...
        organization (DataSourceOrganizationType0 | None):
        workspace (DataSourceWorkspaceType0 | None):
        created (DataSourceCreated):
        ...
        last_action_run (DataSourceLastActionRunType0 | None):
        note_organization (OrganizationSimple): Simple Organization serializer for nested representations.

            Includes `url` field for direct navigation.
        note_workspace (WorkspaceSimple):
        synced_item_ids (Any):
        failed_item_ids (Any):
        synced_count (int):
        failed_count (int):
        ...
        provider_entity (DataSourceProviderEntityType0 | None):
    ...
    effective_sla_target: float | None
    last_action_run: DataSourceLastActionRunType0 | None
    note_organization: OrganizationSimple
    note_workspace: WorkspaceSimple
    synced_item_ids: Any
    failed_item_ids: Any
    synced_count: int
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, DataSourceDeletedByUserType0):
        ...
        if isinstance(self.organization, DataSourceOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, DataSourceWorkspaceType0):
        ...
        if isinstance(self.last_action_run, DataSourceLastActionRunType0):
            last_action_run = self.last_action_run.to_dict()
        else:
            last_action_run = self.last_action_run

        note_organization = self.note_organization.to_dict()

        note_workspace = self.note_workspace.to_dict()

        synced_item_ids = self.synced_item_ids
        ...
        if isinstance(self.provider_entity, DataSourceProviderEntityType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> DataSourceDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = DataSourceDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DataSourceDeletedByUserType0 | None, data)
        ...
        def _parse_organization(data: object) -> DataSourceOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = DataSourceOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DataSourceOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> DataSourceWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = DataSourceWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DataSourceWorkspaceType0 | None, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = DataSourceCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> DataSourceLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = DataSourceLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DataSourceLastActionRunType0 | None, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        note_organization = OrganizationSimple.from_dict(d.pop("note_organization"))

        note_workspace = WorkspaceSimple.from_dict(d.pop("note_workspace"))

        synced_item_ids = d.pop("synced_item_ids")

        failed_item_ids = d.pop("failed_item_ids")

        synced_count = d.pop("synced_count")

        failed_count = d.pop("failed_count")

        next_sync = datetime.datetime.fromisoformat(d.pop("next_sync"))

        config = d.pop("config")

        credential = CredentialSimple.from_dict(d.pop("credential"))

        def _parse_provider_entity(data: object) -> DataSourceProviderEntityType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                provider_entity_type_0 = DataSourceProviderEntityType0.from_dict(data)

                return provider_entity_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DataSourceProviderEntityType0 | None, data)
