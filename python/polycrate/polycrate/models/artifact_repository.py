...
T = TypeVar("T", bound="ArtifactRepository")


@_attrs_define
class ArtifactRepository:
    """Full serializer for ArtifactRepository detail view.

    Attributes:
        id (UUID):
        created (ArtifactRepositoryCreated):
        organization (ArtifactRepositoryOrganizationType0 | None):
        workspace (ArtifactRepositoryWorkspaceType0 | None):
        ...
        last_action_run (ArtifactRepositoryLastActionRunType0 | None):
        deleted_by_user (ArtifactRepositoryDeletedByUserType0 | None):
        ...
        alternative_repository_url (None | str | Unset):
    ...
    alternative_repository_url: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.organization, ArtifactRepositoryOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, ArtifactRepositoryWorkspaceType0):
        ...
        if isinstance(self.last_action_run, ArtifactRepositoryLastActionRunType0):
            last_action_run = self.last_action_run.to_dict()
        else:
            last_action_run = self.last_action_run

        deleted_by_user: dict[str, Any] | None
        if isinstance(self.deleted_by_user, ArtifactRepositoryDeletedByUserType0):
        ...
        alternative_repository_url: None | str | Unset
        if isinstance(self.alternative_repository_url, Unset):
            alternative_repository_url = UNSET
        else:
            alternative_repository_url = self.alternative_repository_url
        ...
        if alternative_repository_url is not UNSET:
            field_dict["alternative_repository_url"] = alternative_repository_url
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        created = ArtifactRepositoryCreated.from_dict(d.pop("created"))

        def _parse_organization(data: object) -> ArtifactRepositoryOrganizationType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = ArtifactRepositoryOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ArtifactRepositoryOrganizationType0 | None, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> ArtifactRepositoryWorkspaceType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = ArtifactRepositoryWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ArtifactRepositoryWorkspaceType0 | None, data)
        ...
        def _parse_last_action_run(data: object) -> ArtifactRepositoryLastActionRunType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = ArtifactRepositoryLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ArtifactRepositoryLastActionRunType0 | None, data)

        last_action_run = _parse_last_action_run(d.pop("last_action_run"))

        def _parse_deleted_by_user(data: object) -> ArtifactRepositoryDeletedByUserType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = ArtifactRepositoryDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ArtifactRepositoryDeletedByUserType0 | None, data)
        ...
        def _parse_alternative_repository_url(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        alternative_repository_url = _parse_alternative_repository_url(d.pop("alternative_repository_url", UNSET))
        ...
        artifact_repository = cls(
            ...
            alternative_repository_url=alternative_repository_url,
        ...
        artifact_repository.additional_properties = d
