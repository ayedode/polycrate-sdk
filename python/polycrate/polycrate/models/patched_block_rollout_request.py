...
T = TypeVar("T", bound="PatchedBlockRolloutRequest")


@_attrs_define
class PatchedBlockRolloutRequest:
    ...
    batch_identifier: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if batch_identifier is not UNSET:
            field_dict["batch_identifier"] = batch_identifier
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.batch_identifier, Unset):
            files.append(("batch_identifier", (None, str(self.batch_identifier).encode(), "text/plain")))

        if not isinstance(self.status, Unset):
            files.append(("status", (None, str(self.status).encode(), "text/plain")))

        if not isinstance(self.total_items, Unset):
            files.append(("total_items", (None, str(self.total_items).encode(), "text/plain")))

        if not isinstance(self.dispatched_items, Unset):
            files.append(("dispatched_items", (None, str(self.dispatched_items).encode(), "text/plain")))

        if not isinstance(self.completed_items, Unset):
            files.append(("completed_items", (None, str(self.completed_items).encode(), "text/plain")))

        if not isinstance(self.failed_items, Unset):
            files.append(("failed_items", (None, str(self.failed_items).encode(), "text/plain")))

        if not isinstance(self.last_item_added_at, Unset):
            if isinstance(self.last_item_added_at, datetime.datetime):
                files.append(("last_item_added_at", (None, self.last_item_added_at.isoformat().encode(), "text/plain")))
            else:
                files.append(("last_item_added_at", (None, str(self.last_item_added_at).encode(), "text/plain")))

        if not isinstance(self.quiescence_seconds, Unset):
            files.append(("quiescence_seconds", (None, str(self.quiescence_seconds).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_identifier = d.pop("batch_identifier", UNSET)
        ...
        patched_block_rollout_request = cls(
            name=name,
        ...
        patched_block_rollout_request.additional_properties = d
        return patched_block_rollout_request
