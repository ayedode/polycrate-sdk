...
@_attrs_define
class Prefix:
    """Full serializer for Prefix detail views and CRUD operations.
    Inherits from ManagedObjectDetailSerializer for Managed Object Dashboard compatibility.
        ...
        Attributes:
            ...
            deleted_by_user (None | PrefixDeletedByUserType0):
            ...
            organization (None | PrefixOrganizationType0):
            workspace (None | PrefixWorkspaceType0):
            ...
            last_action_run (None | PrefixLastActionRunType0):
            region (RegionSimple):
            ...
            platform_service (bool | Unset): When True, this prefix may be used by organizations other than its owner
                (cross-org API/usage gate). Orthogonal to region scoping.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.deleted_by_user, PrefixDeletedByUserType0):
        ...
        if isinstance(self.organization, PrefixOrganizationType0):
            organization = self.organization.to_dict()
        else:
            organization = self.organization

        workspace: dict[str, Any] | None
        if isinstance(self.workspace, PrefixWorkspaceType0):
        ...
        if isinstance(self.last_action_run, PrefixLastActionRunType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_deleted_by_user(data: object) -> None | PrefixDeletedByUserType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                deleted_by_user_type_0 = PrefixDeletedByUserType0.from_dict(data)

                return deleted_by_user_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PrefixDeletedByUserType0, data)
        ...
        def _parse_organization(data: object) -> None | PrefixOrganizationType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                organization_type_0 = PrefixOrganizationType0.from_dict(data)

                return organization_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PrefixOrganizationType0, data)

        organization = _parse_organization(d.pop("organization"))

        def _parse_workspace(data: object) -> None | PrefixWorkspaceType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                workspace_type_0 = PrefixWorkspaceType0.from_dict(data)

                return workspace_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PrefixWorkspaceType0, data)

        workspace = _parse_workspace(d.pop("workspace"))

        created = PrefixCreated.from_dict(d.pop("created"))
        ...
        def _parse_last_action_run(data: object) -> None | PrefixLastActionRunType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                last_action_run_type_0 = PrefixLastActionRunType0.from_dict(data)

                return last_action_run_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PrefixLastActionRunType0, data)
