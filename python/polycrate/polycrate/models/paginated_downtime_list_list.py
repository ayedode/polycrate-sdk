...
T = TypeVar("T", bound="PaginatedDowntimeListList")


@_attrs_define
class PaginatedDowntimeListList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[DowntimeList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = DowntimeList.from_dict(results_item_data)
        ...
        paginated_downtime_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_downtime_list_list.additional_properties = d
        return paginated_downtime_list_list
