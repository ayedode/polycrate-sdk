...
if TYPE_CHECKING:
    from ..models.pricing_quote_app_detail_created_created_by_type_0 import PricingQuoteAppDetailCreatedCreatedByType0


T = TypeVar("T", bound="PricingQuoteAppDetailCreated")


@_attrs_define
class PricingQuoteAppDetailCreated:
    """
    Attributes:
        created_at (datetime.datetime | None | Unset):
        created_at_humanized (None | str | Unset):
        created_at_display (None | str | Unset):
        created_by (None | PricingQuoteAppDetailCreatedCreatedByType0 | Unset):
    """

    created_at: datetime.datetime | None | Unset = UNSET
    created_at_humanized: None | str | Unset = UNSET
    created_at_display: None | str | Unset = UNSET
    created_by: None | PricingQuoteAppDetailCreatedCreatedByType0 | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.pricing_quote_app_detail_created_created_by_type_0 import (
            PricingQuoteAppDetailCreatedCreatedByType0,  # noqa: PLC0415
        )
        ...
        if isinstance(self.created_by, Unset):
            created_by = UNSET
        elif isinstance(self.created_by, PricingQuoteAppDetailCreatedCreatedByType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_created_by(data: object) -> None | PricingQuoteAppDetailCreatedCreatedByType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                created_by_type_0 = PricingQuoteAppDetailCreatedCreatedByType0.from_dict(data)

                return created_by_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PricingQuoteAppDetailCreatedCreatedByType0 | Unset, data)

        created_by = _parse_created_by(d.pop("created_by", UNSET))

        pricing_quote_app_detail_created = cls(
        ...
        pricing_quote_app_detail_created.additional_properties = d
        return pricing_quote_app_detail_created
